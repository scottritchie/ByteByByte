 ...
 * <ul>
 *   <li>{@link com.viacron.utils.bbb.byteByByte.impl.SubTypeImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.viacron.utils.bbb.byteByByte.impl.SubTypeImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link com.viacron.utils.bbb.byteByByte.impl.SubTypeImpl#getEnums <em>Enums</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SubTypeImpl extends MinimalEObjectImpl.Container implements SubType
{
  ...
  {
    return ByteByBytePackage.Literals.SUB_TYPE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ByteByBytePackage.SUB_TYPE__NAME, oldName, name));
  }
  ...
  public EList<AbstractAttribute> getAttributes()
  {
    if (attributes == null)
    {
      attributes = new EObjectContainmentEList<AbstractAttribute>(AbstractAttribute.class, this, ByteByBytePackage.SUB_TYPE__ATTRIBUTES);
    }
    return attributes;
  }
  ...
  public EList<PEnumRef> getEnums()
  {
    if (enums == null)
    {
      enums = new EObjectContainmentEList<PEnumRef>(PEnumRef.class, this, ByteByBytePackage.SUB_TYPE__ENUMS);
    }
    return enums;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ByteByBytePackage.SUB_TYPE__ATTRIBUTES:
        return ((InternalEList<?>)getAttributes()).basicRemove(otherEnd, msgs);
      case ByteByBytePackage.SUB_TYPE__ENUMS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ByteByBytePackage.SUB_TYPE__NAME:
        return getName();
      case ByteByBytePackage.SUB_TYPE__ATTRIBUTES:
