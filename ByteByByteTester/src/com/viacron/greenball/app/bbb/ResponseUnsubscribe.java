...
public class ResponseUnsubscribe {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      ResponseUnsubscribeEnum.ORG_ID.setLength(this.getOrgId().length());
      ResponseUnsubscribeEnum.ORG_NAME.setLength(this.getOrgName().length());
      ResponseUnsubscribeEnum.USER_NAME.setLength(this.getUserName().length());
      ResponseUnsubscribeEnum.SESSION_ID.setLength(this.getSessionId().length());
