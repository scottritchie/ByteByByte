...
/**
 * The InitializeOrganizationRequest class initializes the element object with the OrganizationRequest object.
 *
 */
public class InitializeOrganizationRequest {
   private static Logger log4j = Logger.getLogger(InitializeOrganizationRequest.class);
    ...
    * The InitializeOrganizationRequest class initializes the element object with the OrganizationRequest object.
    *
    * @param organizationRequest The object which will be used to initialize the element object.
    */
   public InitializeOrganizationRequest(OrganizationRequest organizationRequest) {
      this.organizationRequest = organizationRequest;

      this.element = new Element("OrganizationRequest");
   }
   ...
   public Element initialize() throws MissingAttributeException {
      ...
      log4j.debug("element.getName(): OrganizationRequest");

      if (organizationRequest.getUser() != null) {
         AbstractAttribute abstractAttribute = initializeUser(organizationRequest.getUser());
      ...
      if (organizationRequest.getOrgId() != null) {
         AbstractAttribute abstractAttribute = initializeOrgId(organizationRequest.getOrgId());
         element.getAbstractAttributes().add(abstractAttribute);
      }
      else {
         // Missing required attribute, generate an error message and throw an exception
      ...
      if (organizationRequest.getOrgName() != null) {
         AbstractAttribute abstractAttribute = initializeOrgName(organizationRequest.getOrgName());
         element.getAbstractAttributes().add(abstractAttribute);
      }
      else {
         // Missing required attribute, generate an error message and throw an exception
      ...
      if (organizationRequest.getSessionId() != null) {
         AbstractAttribute abstractAttribute = initializeSessionId(organizationRequest.getSessionId());
         element.getAbstractAttributes().add(abstractAttribute);
      }
