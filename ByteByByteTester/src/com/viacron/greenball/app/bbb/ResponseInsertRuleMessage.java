...
public class ResponseInsertRuleMessage {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      ResponseInsertRuleMessageEnum.ORG_ID.setLength(this.getOrgId().length());
      ResponseInsertRuleMessageEnum.ORG_NAME.setLength(this.getOrgName().length());
      ResponseInsertRuleMessageEnum.MODEL_NAME.setLength(this.getModelName().length());
      ResponseInsertRuleMessageEnum.RULE.setLength(this.getRule().getRuleSize());
      ResponseInsertRuleMessageEnum.USER_NAME.setLength(this.getUserName().length());
      ResponseInsertRuleMessageEnum.SESSION_ID.setLength(this.getSessionId().length());
