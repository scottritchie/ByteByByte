...
/**
 * The InitializeInsertRulePhase2Message class initializes the element object with the InsertRulePhase2Message object.
 *
 */
public class InitializeInsertRulePhase2Message {
   private static Logger log4j = Logger.getLogger(InitializeInsertRulePhase2Message.class);
    ...
    * The InitializeInsertRulePhase2Message class initializes the element object with the InsertRulePhase2Message object.
    *
    * @param insertRulePhase2Message The object which will be used to initialize the element object.
    */
   public InitializeInsertRulePhase2Message(InsertRulePhase2Message insertRulePhase2Message) {
      this.insertRulePhase2Message = insertRulePhase2Message;

      this.element = new Element("InsertRulePhase2Message");
   }
   ...
   public Element initialize() throws MissingAttributeException {
      ...
      log4j.debug("element.getName(): InsertRulePhase2Message");

      if (insertRulePhase2Message.getOrgId() != null) {
         AbstractAttribute abstractAttribute = initializeOrgId(insertRulePhase2Message.getOrgId());
      ...
      if (insertRulePhase2Message.getOrgName() != null) {
         AbstractAttribute abstractAttribute = initializeOrgName(insertRulePhase2Message.getOrgName());
         element.getAbstractAttributes().add(abstractAttribute);
      }
      else {
         // Missing required attribute, generate an error message and throw an exception
      ...
      if (insertRulePhase2Message.getModelName() != null) {
         AbstractAttribute abstractAttribute = initializeModelName(insertRulePhase2Message.getModelName());
         element.getAbstractAttributes().add(abstractAttribute);
      }
      else {
         // Missing required attribute, generate an error message and throw an exception
      ...
      if (insertRulePhase2Message.getRule() != null) {
         AbstractAttribute abstractAttribute = initializeRule(insertRulePhase2Message.getRule());
         element.getAbstractAttributes().add(abstractAttribute);
      }
      else {
         // Missing required attribute, generate an error message and throw an exception
      ...
      if (insertRulePhase2Message.getUserName() != null) {
         AbstractAttribute abstractAttribute = initializeUserName(insertRulePhase2Message.getUserName());
         element.getAbstractAttributes().add(abstractAttribute);
      }
      else {
         // Missing required attribute, generate an error message and throw an exception
      ...
      if (insertRulePhase2Message.getSessionId() != null) {
         AbstractAttribute abstractAttribute = initializeSessionId(insertRulePhase2Message.getSessionId());
         element.getAbstractAttributes().add(abstractAttribute);
      }
