...
/**
 * The InitializeHeartbeat class initializes the element object with the Heartbeat object.
 *
 */
public class InitializeHeartbeat {
   private static Logger log4j = Logger.getLogger(InitializeHeartbeat.class);
    ...
    * The InitializeHeartbeat class initializes the element object with the Heartbeat object.
    *
    * @param heartbeat The object which will be used to initialize the element object.
    */
   public InitializeHeartbeat(Heartbeat heartbeat) {
      this.heartbeat = heartbeat;

      this.element = new Element("Heartbeat");
   }
   ...
   public Element initialize() throws MissingAttributeException {
      ...
      log4j.debug("element.getName(): Heartbeat");

      if (heartbeat.getSessionId() != null) {
         AbstractAttribute abstractAttribute = initializeSessionId(heartbeat.getSessionId());
