...
public class RequestModel {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      RequestModelEnum.USER.setLength(this.getUser().length());
      RequestModelEnum.ORG_ID.setLength(this.getOrgId().length());
      RequestModelEnum.ORG_NAME.setLength(this.getOrgName().length());
      RequestModelEnum.SESSION_ID.setLength(this.getSessionId().length());
