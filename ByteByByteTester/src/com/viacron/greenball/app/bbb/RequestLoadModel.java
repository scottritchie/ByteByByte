...
public class RequestLoadModel {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      RequestLoadModelEnum.ORG_ID.setLength(this.getOrgId().length());
      RequestLoadModelEnum.ORG_NAME.setLength(this.getOrgName().length());
      RequestLoadModelEnum.SESSION_ID.setLength(this.getSessionId().length());
