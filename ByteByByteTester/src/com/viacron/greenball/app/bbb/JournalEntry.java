...
public class JournalEntry {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      JournalEntryEnum.USER.setLength(this.getUser().length());
      JournalEntryEnum.META_MODEL_ID.setLength(this.getMetaModelId().length());
      JournalEntryEnum.ACTION.setLength(this.getAction().length());
      JournalEntryEnum.DESCRIPTION.setLength(this.getDescription().length());
