...
public class Login {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      LoginEnum.USER.setLength(this.getUser().length());
      LoginEnum.PASSWORD.setLength(this.getPassword().length());
      LoginEnum.SESSION_ID.setLength(this.getSessionId().length());
