...
/**
 * The InitializeMetaModelLoadRequest class initializes the element object with the MetaModelLoadRequest object.
 *
 */
public class InitializeMetaModelLoadRequest {
   private static Logger log4j = Logger.getLogger(InitializeMetaModelLoadRequest.class);
    ...
    * The InitializeMetaModelLoadRequest class initializes the element object with the MetaModelLoadRequest object.
    *
    * @param metaModelLoadRequest The object which will be used to initialize the element object.
    */
   public InitializeMetaModelLoadRequest(MetaModelLoadRequest metaModelLoadRequest) {
      this.metaModelLoadRequest = metaModelLoadRequest;

      this.element = new Element("MetaModelLoadRequest");
   }
   ...
   public Element initialize() throws MissingAttributeException {
      ...
      log4j.debug("element.getName(): MetaModelLoadRequest");

      if (metaModelLoadRequest.getOrgId() != null) {
         AbstractAttribute abstractAttribute = initializeOrgId(metaModelLoadRequest.getOrgId());
      ...
      if (metaModelLoadRequest.getOrgName() != null) {
         AbstractAttribute abstractAttribute = initializeOrgName(metaModelLoadRequest.getOrgName());
         element.getAbstractAttributes().add(abstractAttribute);
      }
      else {
         // Missing required attribute, generate an error message and throw an exception
      ...
      if (metaModelLoadRequest.getSessionId() != null) {
         AbstractAttribute abstractAttribute = initializeSessionId(metaModelLoadRequest.getSessionId());
         element.getAbstractAttributes().add(abstractAttribute);
      }
