...
public class MetaModelLoadRequest {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      MetaModelLoadRequestEnum.ORG_ID.setLength(this.getOrgId().length());
      MetaModelLoadRequestEnum.ORG_NAME.setLength(this.getOrgName().length());
      MetaModelLoadRequestEnum.SESSION_ID.setLength(this.getSessionId().length());
