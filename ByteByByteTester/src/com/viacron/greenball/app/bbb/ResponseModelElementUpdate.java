...
public class ResponseModelElementUpdate {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      ResponseModelElementUpdateEnum.ORG_ID.setLength(this.getOrgId().length());
      ResponseModelElementUpdateEnum.ORG_NAME.setLength(this.getOrgName().length());
      ResponseModelElementUpdateEnum.ID.setLength(this.getId().length());
      ResponseModelElementUpdateEnum.PATH.setLength(this.getPath().length());
      ResponseModelElementUpdateEnum.VALUE.setLength(this.getValue().length());
      ResponseModelElementUpdateEnum.SESSION_ID.setLength(this.getSessionId().length());
