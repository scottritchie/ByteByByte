...
public class DeleteSubscriptionRequest {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      DeleteSubscriptionRequestEnum.ORG_ID.setLength(this.getOrgId().length());
      DeleteSubscriptionRequestEnum.ORG_NAME.setLength(this.getOrgName().length());
      DeleteSubscriptionRequestEnum.USER_NAME.setLength(this.getUserName().length());
      DeleteSubscriptionRequestEnum.MESSAGE.setLength(this.getMessage().length());
      DeleteSubscriptionRequestEnum.SESSION_ID.setLength(this.getSessionId().length());
