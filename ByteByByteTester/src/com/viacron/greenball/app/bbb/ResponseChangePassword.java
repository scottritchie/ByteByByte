...
public class ResponseChangePassword {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      ResponseChangePasswordEnum.USER.setLength(this.getUser().length());
      ResponseChangePasswordEnum.NEW_PASSWORD.setLength(this.getNewPassword().length());
      ResponseChangePasswordEnum.SESSION_ID.setLength(this.getSessionId().length());
