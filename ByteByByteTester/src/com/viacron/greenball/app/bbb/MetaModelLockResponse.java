...
public class MetaModelLockResponse {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      MetaModelLockResponseEnum.USER.setLength(this.getUser().length());
      MetaModelLockResponseEnum.META_MODEL_ID.setLength(this.getMetaModelId().length());
      MetaModelLockResponseEnum.SESSION_ID.setLength(this.getSessionId().length());
