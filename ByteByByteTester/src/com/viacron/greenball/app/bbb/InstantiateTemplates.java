...
public class InstantiateTemplates {
   private static Logger log4j = Logger.getLogger(InstantiateTemplates.class);
   ...
   /**
    * The InstantiateTemplates class instantiates the Templates object.
    *
    * @param element The root element returned by the parser after parsing the string
    *                representing the Templates.
    */
   public InstantiateTemplates(Element element) {
      this.element = element;   
      this.templates = new Templates();
   }

   /**
    * This method instantiates the Templates.
    *
    * @return The Templates.
    */
   public Templates instantiate() {
      final String METHOD = "instantiate()";
      log4j.debug("Entered " + METHOD);

      log4j.debug("Templates: " + element.getName());
      log4j.debug("# of attributes: " + element.getAbstractAttributes().size());

      instantiateTemplatesAttributes(element);
      ...
      instantiateTemplatesSubTypeRefs(e);
      }
      }
      ...
      /*
       * This method instantiates the Templates attributes.
       * 
       * @param Element element
       */
      private void instantiateTemplatesAttributes(Element element) {
      final String METHOD = "instantiateTemplatesAttributes()";
      log4j.debug("Entered " + METHOD);
      ...
      for (AbstractAttribute attr : element.getAbstractAttributes()) {
         for (KeyValuePair kvp : attr.getKeyValuePairs()) {
            ...
            if (kvp.getKey().startsWith("templates[")) {
               if(templates.getTemplates() == null) {
               templates.setTemplates(new ArrayList<String>());
               }
               templates.getTemplates().add(kvp.getValue());
            }
            ...
            if (kvp.getKey().equals("sessionId")) {
               ...
               templates.setSessionId(kvp.getValue());
            }
   ...
   /*
    * This method instantiates the Templates SubType references.
    * 
    * @param Element element
    */
   private void instantiateTemplatesSubTypeRefs(Element element) {
      final String METHOD = "instantiateTemplatesSubTypeRefs()";
      log4j.debug("Entered " + METHOD);
