...
/**
 * The InitializeLogin class initializes the element object with the Login object.
 *
 */
public class InitializeLogin {
   private static Logger log4j = Logger.getLogger(InitializeLogin.class);
    ...
    * The InitializeLogin class initializes the element object with the Login object.
    *
    * @param login The object which will be used to initialize the element object.
    */
   public InitializeLogin(Login login) {
      this.login = login;

      this.element = new Element("Login");
   }
   ...
   public Element initialize() throws MissingAttributeException {
      ...
      log4j.debug("element.getName(): Login");

      if (login.getUser() != null) {
         AbstractAttribute abstractAttribute = initializeUser(login.getUser());
      ...
      if (login.getPassword() != null) {
         AbstractAttribute abstractAttribute = initializePassword(login.getPassword());
         element.getAbstractAttributes().add(abstractAttribute);
      }
      else {
         // Missing required attribute, generate an error message and throw an exception
      ...
      if (login.getSessionId() != null) {
         AbstractAttribute abstractAttribute = initializeSessionId(login.getSessionId());
         element.getAbstractAttributes().add(abstractAttribute);
      }
