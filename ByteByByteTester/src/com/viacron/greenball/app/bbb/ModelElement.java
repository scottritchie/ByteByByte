...
public class ModelElement {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      ModelElementEnum.ORG_ID.setLength(this.getOrgId().length());
      ModelElementEnum.ORG_NAME.setLength(this.getOrgName().length());
      ModelElementEnum.ID.setLength(this.getId().length());
      ModelElementEnum.PATH.setLength(this.getPath().length());
      ModelElementEnum.VALUE.setLength(this.getValue().length());
      ModelElementEnum.SESSION_ID.setLength(this.getSessionId().length());
   ...
   public ModelElement unpack(byte[] ba) {
      ...
      modelElement.setAction(ModelElementAction.toEnum(GreenballMessagesUtility.getInteger(ba, ModelElementEnum.ACTION.getOffsetInBits())));
