...
public class FileTransfer {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      FileTransferEnum.FILE_NAME.setLength(this.getFileName().length());
      FileTransferEnum.UUID.setLength(this.getUuid().length());
      FileTransferEnum.ORG_ID.setLength(this.getOrgId().length());
      FileTransferEnum.ORG_NAME.setLength(this.getOrgName().length());
      FileTransferEnum.USER_NAME.setLength(this.getUserName().length());
      FileTransferEnum.CHUNK.setLength(this.getChunk().size());
