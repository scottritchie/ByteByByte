...
public class DeleteRuleMessage {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      DeleteRuleMessageEnum.ORG_ID.setLength(this.getOrgId().length());
      DeleteRuleMessageEnum.ORG_NAME.setLength(this.getOrgName().length());
      DeleteRuleMessageEnum.MODEL_NAME.setLength(this.getModelName().length());
      DeleteRuleMessageEnum.RULE.setLength(this.getRule().getRuleSize());
      DeleteRuleMessageEnum.USER_NAME.setLength(this.getUserName().length());
      DeleteRuleMessageEnum.SESSION_ID.setLength(this.getSessionId().length());
