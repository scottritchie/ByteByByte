...
private static Logger log4j = Logger.getLogger(InstantiateTemplate.class);
...
/**
 * This method constructs a InstantiateTemplate object based on an Element
 * object.
 * 
 * @param element
 *            The Element.
 */
public InstantiateTemplate(Element element) {
this.element = element;
this.template = new Template();
}

/**
 * The instantiate method instantiates a Template object.
 * 
 * @return The Template.
 */
protected Template instantiate() {
...
for (AbstractAttribute abstractAttribute : element.getAbstractAttributes()) {
   ...
   template.setDescription(kvp.getValue());
   }
