...
public class SignUpResponse {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      SignUpResponseEnum.EMAIL_ADDRESS.setLength(this.getEmailAddress().length());
      SignUpResponseEnum.PASSWORD.setLength(this.getPassword().length());
      SignUpResponseEnum.SESSION_ID.setLength(this.getSessionId().length());
