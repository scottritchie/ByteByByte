...
public class RequestSaveGrammar {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      RequestSaveGrammarEnum.ORG_ID.setLength(this.getOrgId().length());
      RequestSaveGrammarEnum.ORG_NAME.setLength(this.getOrgName().length());
      RequestSaveGrammarEnum.USER_NAME.setLength(this.getUserName().length());
      RequestSaveGrammarEnum.BUFFER.setLength(this.getBuffer().length());
      RequestSaveGrammarEnum.SESSION_ID.setLength(this.getSessionId().length());
