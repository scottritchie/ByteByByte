...
public class RequestUnsubscribe {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      RequestUnsubscribeEnum.ORG_ID.setLength(this.getOrgId().length());
      RequestUnsubscribeEnum.ORG_NAME.setLength(this.getOrgName().length());
      RequestUnsubscribeEnum.USER_NAME.setLength(this.getUserName().length());
      RequestUnsubscribeEnum.SESSION_ID.setLength(this.getSessionId().length());
