...
public class InstantiateSignUp {
   private static Logger log4j = Logger.getLogger(InstantiateSignUp.class);
   ...
   /**
    * The InstantiateSignUp class instantiates the SignUp object.
    *
    * @param element The root element returned by the parser after parsing the string
    *                representing the SignUp.
    */
   public InstantiateSignUp(Element element) {
      this.element = element;   
      this.signUp = new SignUp();
   }

   /**
    * This method instantiates the SignUp.
    *
    * @return The SignUp.
    */
   public SignUp instantiate() {
      final String METHOD = "instantiate()";
      log4j.debug("Entered " + METHOD);

      log4j.debug("SignUp: " + element.getName());
      log4j.debug("# of attributes: " + element.getAbstractAttributes().size());

      instantiateSignUpAttributes(element);
      ...
      instantiateSignUpSubTypeRefs(e);
      }
      }
      ...
      /*
       * This method instantiates the SignUp attributes.
       * 
       * @param Element element
       */
      private void instantiateSignUpAttributes(Element element) {
      final String METHOD = "instantiateSignUpAttributes()";
      log4j.debug("Entered " + METHOD);
   ...
   /*
    * This method instantiates the SignUp SubType references.
    * 
    * @param Element element
    */
   private void instantiateSignUpSubTypeRefs(Element element) {
      final String METHOD = "instantiateSignUpSubTypeRefs()";
      log4j.debug("Entered " + METHOD);
