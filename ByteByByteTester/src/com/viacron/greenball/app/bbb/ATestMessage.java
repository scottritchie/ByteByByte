...
public class ATestMessage {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      offset += 1;
      bb = GreenballMessagesUtility.insertBitfield(bb, offset * 8, 3, getAppState().ordinal());
      // bb = GreenballMessagesUtility.insertInteger(bb, offset, this.getAppState().getId());
      offset += 1;
      bb = GreenballMessagesUtility.insertBitfield(bb, offset * 8, 4, getATenBitEnum().ordinal());
      // bb = GreenballMessagesUtility.insertInteger(bb, offset, this.getATenBitEnum().getId());
      offset += 1;
      bb = GreenballMessagesUtility.insertBitfield(bb, offset * 8, 4, getUserStatus().ordinal());
      // bb = GreenballMessagesUtility.insertInteger(bb, offset, this.getUserStatus().getId());
      offset += 1;
      bb = GreenballMessagesUtility.insertBitfield(bb, offset * 8, 8, getZBigOne().ordinal());
      // bb = GreenballMessagesUtility.insertInteger(bb, offset, this.getZBigOne().getId());
      offset += 2;

      ATestMessageEnum.A_FLOAT.setLength(4);
      ATestMessageEnum.A_STRING.setLength(this.getAString().length());
      ATestMessageEnum.SOME_BOOLEANS.setLength(this.getSomeBooleans().size());
      ATestMessageEnum.SOME_BYTES.setLength(this.getSomeBytes().size());
      ATestMessageEnum.SOME_CHARS.setLength(this.getSomeChars().size());
      ATestMessageEnum.SOME_CALENDARS.setLength(this.getSomeCalendars().size());
      ATestMessageEnum.SOME_DOUBLES.setLength(this.getSomeDoubles().size());
      ATestMessageEnum.SOME_FLOATS.setLength(this.getSomeFloats().size());
      ATestMessageEnum.SOME_INTS.setLength(this.getSomeInts().size());
      ATestMessageEnum.SOME_LONGS.setLength(this.getSomeLongs().size());
      ATestMessageEnum.SOME_SHORTS.setLength(this.getSomeShorts().size());
      ATestMessageEnum.SOME_STRINGS.setLength(this.getSomeStrings().size());
   ...
   public ATestMessage unpack(byte[] ba) {
      ...
      aTestMessage.setAction(ChatAction.toEnum(GreenballMessagesUtility.getInteger(ba, ATestMessageEnum.ACTION.getOffsetInBits())));
      aTestMessage.setAppState(AppState.toEnum(GreenballMessagesUtility.getInteger(ba, ATestMessageEnum.APP_STATE.getOffsetInBits())));
      aTestMessage.setATenBitEnum(TenBitEnum.toEnum(GreenballMessagesUtility.getInteger(ba, ATestMessageEnum.A_TEN_BIT_ENUM.getOffsetInBits())));
      aTestMessage.setUserStatus(UserStatusEnum.toEnum(GreenballMessagesUtility.getInteger(ba, ATestMessageEnum.USER_STATUS.getOffsetInBits())));
      aTestMessage.setZBigOne(ZbigOne.toEnum(GreenballMessagesUtility.getInteger(ba, ATestMessageEnum.Z_BIG_ONE.getOffsetInBits())));
