...
public class EditRuleMessage {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      EditRuleMessageEnum.ORG_ID.setLength(this.getOrgId().length());
      EditRuleMessageEnum.ORG_NAME.setLength(this.getOrgName().length());
      EditRuleMessageEnum.MODEL_NAME.setLength(this.getModelName().length());
      EditRuleMessageEnum.USER_NAME.setLength(this.getUserName().length());
      ...
      EditRuleMessageEnum.SESSION_ID.setLength(this.getSessionId().length());
