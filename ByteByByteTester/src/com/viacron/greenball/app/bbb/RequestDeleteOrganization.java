...
public class RequestDeleteOrganization {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      RequestDeleteOrganizationEnum.ORG_ID.setLength(this.getOrgId().length());
      RequestDeleteOrganizationEnum.ORG_NAME.setLength(this.getOrgName().length());
      RequestDeleteOrganizationEnum.USER_NAME.setLength(this.getUserName().length());
      RequestDeleteOrganizationEnum.MESSAGE.setLength(this.getMessage().length());
      RequestDeleteOrganizationEnum.SESSION_ID.setLength(this.getSessionId().length());
