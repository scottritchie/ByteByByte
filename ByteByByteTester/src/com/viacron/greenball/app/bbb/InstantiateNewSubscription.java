...
public class InstantiateNewSubscription {
   private static Logger log4j = Logger.getLogger(InstantiateNewSubscription.class);
   ...
   /**
    * The InstantiateNewSubscription class instantiates the NewSubscription object.
    *
    * @param element The root element returned by the parser after parsing the string
    *                representing the NewSubscription.
    */
   public InstantiateNewSubscription(Element element) {
      this.element = element;   
      this.newSubscription = new NewSubscription();
   }

   /**
    * This method instantiates the NewSubscription.
    *
    * @return The NewSubscription.
    */
   public NewSubscription instantiate() {
      final String METHOD = "instantiate()";
      log4j.debug("Entered " + METHOD);

      log4j.debug("NewSubscription: " + element.getName());
      log4j.debug("# of attributes: " + element.getAbstractAttributes().size());

      instantiateNewSubscriptionAttributes(element);
      ...
      instantiateNewSubscriptionSubTypeRefs(e);
      }
      }
      ...
      /*
       * This method instantiates the NewSubscription attributes.
       * 
       * @param Element element
       */
      private void instantiateNewSubscriptionAttributes(Element element) {
      final String METHOD = "instantiateNewSubscriptionAttributes()";
      log4j.debug("Entered " + METHOD);
      ...
      for (AbstractAttribute attr : element.getAbstractAttributes()) {
         for (KeyValuePair kvp : attr.getKeyValuePairs()) {
            ...
            if (kvp.getKey().equals("sessionId")) {
               ...
               newSubscription.setSessionId(kvp.getValue());
            }
   ...
   /*
    * This method instantiates the NewSubscription SubType references.
    * 
    * @param Element element
    */
   private void instantiateNewSubscriptionSubTypeRefs(Element element) {
      final String METHOD = "instantiateNewSubscriptionSubTypeRefs()";
      log4j.debug("Entered " + METHOD);
...
private void instantiateOrganization(Element element) {
   ...
   newSubscription.setOrganization(instantiateOrganizationSubType.instantiate());
