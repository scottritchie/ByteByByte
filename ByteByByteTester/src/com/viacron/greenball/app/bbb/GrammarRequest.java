...
/**
 * The GrammarRequest class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a GrammarRequest object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a GrammarRequest object.
 */
public class GrammarRequest {
   private static final int ID = GreenballMessagesEnum.GRAMMAR_REQUEST.getId();

   /**
    * The number of bits required to represent the GrammarRequestEnum IDs.
    * # of attributes: 4
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(GrammarRequest.class);

   // Entered buildClassEnum()
   private enum GrammarRequestEnum {
      ...
      GrammarRequestEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The GrammarRequest no-arg constructor.
    */
   public GrammarRequest() {}

   /**
    * The GrammarRequest constructor.
    ...
    */
   public GrammarRequest(String orgId,
                         String orgName,
                         String userName,
                         String sessionId) {
   ...
   /**
    * This method packs a GrammarRequest object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a GrammarRequest message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getGrammarRequestSize();
      ...
      GrammarRequestEnum.ORG_ID.setLength(this.getOrgId().length());
      GrammarRequestEnum.ORG_NAME.setLength(this.getOrgName().length());
      GrammarRequestEnum.USER_NAME.setLength(this.getUserName().length());
      GrammarRequestEnum.SESSION_ID.setLength(this.getSessionId().length());

      int directorySize = getGrammarRequestDirectorySize();
      if (directorySize != 0) {
         ...
         for (GrammarRequestEnum grammarRequestEnum : GrammarRequestEnum.values()) {
            if (grammarRequestEnum.isDirectoryEntry == true) {
               int id = grammarRequestEnum.getId();
               int length = grammarRequestEnum.getLength();
               ...
               // Insert the data
               if (id == GrammarRequestEnum.ORG_ID.getId()) {
               ...
               else if (id == GrammarRequestEnum.ORG_NAME.getId()) {
               ...
               else if (id == GrammarRequestEnum.USER_NAME.getId()) {
               ...
               else if (id == GrammarRequestEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a GrammarRequest object.
    *
    * @return The byte array as a GrammarRequest message object.
    */
   public GrammarRequest unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == GrammarRequestEnum.ORG_ID.getId()) {
            grammarRequest.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == GrammarRequestEnum.ORG_NAME.getId()) {
            grammarRequest.setOrgName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == GrammarRequestEnum.USER_NAME.getId()) {
            grammarRequest.setUserName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == GrammarRequestEnum.SESSION_ID.getId()) {
            grammarRequest.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a GrammarRequest object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a GrammarRequest message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeGrammarRequest initializeGrammarRequest = new InitializeGrammarRequest(this);
      Element element = initializeGrammarRequest.initialize();
    ...
    */
   public GrammarRequest unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the GrammarRequest object.
       */
       InstantiateGrammarRequest instantiateGrammarRequest = new InstantiateGrammarRequest(element);
       GrammarRequest grammarRequest = instantiateGrammarRequest.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateGrammarRequest.validate();
      if (result != null) {
    ...
    */
   private int getGrammarRequestDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the GrammarRequest object.
    * @return The size in bytes.
    */
   public int getGrammarRequestSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      if (!grammarRequest.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (!grammarRequest.getOrgName().equals(this.getOrgName())) {
         return false;
      }

      if (!grammarRequest.getUserName().equals(this.getUserName())) {
         return false;
      }

      if (!grammarRequest.getSessionId().equals(this.getSessionId())) {
         return false;
      }
