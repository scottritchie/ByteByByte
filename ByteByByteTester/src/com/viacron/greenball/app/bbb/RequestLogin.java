...
public class RequestLogin {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      RequestLoginEnum.USER.setLength(this.getUser().length());
      RequestLoginEnum.PASSWORD.setLength(this.getPassword().length());
      RequestLoginEnum.SESSION_ID.setLength(this.getSessionId().length());
