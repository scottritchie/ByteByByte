...
public class InstantiateDeleteRulePhase2Message {
   private static Logger log4j = Logger.getLogger(InstantiateDeleteRulePhase2Message.class);
   ...
   private DeleteRulePhase2Message deleteRulePhase2Message;

   /**
    * The InstantiateDeleteRulePhase2Message class instantiates the DeleteRulePhase2Message object.
    *
    * @param element The root element returned by the parser after parsing the string
    *                representing the DeleteRulePhase2Message.
    */
   public InstantiateDeleteRulePhase2Message(Element element) {
      this.element = element;   
      this.deleteRulePhase2Message = new DeleteRulePhase2Message();
   }

   /**
    * This method instantiates the DeleteRulePhase2Message.
    *
    * @return The DeleteRulePhase2Message.
    */
   public DeleteRulePhase2Message instantiate() {
      final String METHOD = "instantiate()";
      log4j.debug("Entered " + METHOD);

      log4j.debug("DeleteRulePhase2Message: " + element.getName());
      log4j.debug("# of attributes: " + element.getAbstractAttributes().size());

      instantiateDeleteRulePhase2MessageAttributes(element);
      ...
      instantiateDeleteRulePhase2MessageSubTypeRefs(e);
      }
      }
      ...
      /*
       * This method instantiates the DeleteRulePhase2Message attributes.
       * 
       * @param Element element
       */
      private void instantiateDeleteRulePhase2MessageAttributes(Element element) {
      final String METHOD = "instantiateDeleteRulePhase2MessageAttributes()";
      log4j.debug("Entered " + METHOD);
      ...
      for (AbstractAttribute attr : element.getAbstractAttributes()) {
         for (KeyValuePair kvp : attr.getKeyValuePairs()) {
            ...
            if (kvp.getKey().equals("orgId")) {
               ...
               deleteRulePhase2Message.setOrgId(kvp.getValue());
            }
            ...
            if (kvp.getKey().equals("orgName")) {
               ...
               deleteRulePhase2Message.setOrgName(kvp.getValue());
            }
            // Leaving instantiateMsgAttribute()
            // Entered instantiateMsgAttribute()
            if (kvp.getKey().equals("modelName")) {
               ...
               deleteRulePhase2Message.setModelName(kvp.getValue());
            }
            // Leaving instantiateMsgAttribute()
            // Entered instantiateMsgAttribute()
            if (kvp.getKey().equals("userName")) {
               ...
               deleteRulePhase2Message.setUserName(kvp.getValue());
            }
            // Leaving instantiateMsgAttribute()
            // Entered instantiateMsgAttribute()
            if (kvp.getKey().equals("sessionId")) {
               log4j.debug("setting value of \"sessionId\" to: " + kvp.getValue());
               deleteRulePhase2Message.setSessionId(kvp.getValue());
            }
            // Leaving instantiateMsgAttribute()
         }
      }
   ...
   /*
    * This method instantiates the DeleteRulePhase2Message SubType references.
    * 
    * @param Element element
    */
   private void instantiateDeleteRulePhase2MessageSubTypeRefs(Element element) {
      final String METHOD = "instantiateDeleteRulePhase2MessageSubTypeRefs()";
      log4j.debug("Entered " + METHOD);
...
private void instantiateRule(Element element) {
   ...
   deleteRulePhase2Message.setRule(instantiateRule.instantiate());
