...
public class SaveGrammarPhase2 {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      SaveGrammarPhase2Enum.ORG_ID.setLength(this.getOrgId().length());
      SaveGrammarPhase2Enum.ORG_NAME.setLength(this.getOrgName().length());
      SaveGrammarPhase2Enum.USER_NAME.setLength(this.getUserName().length());
      SaveGrammarPhase2Enum.BUFFER.setLength(this.getBuffer().length());
      SaveGrammarPhase2Enum.SESSION_ID.setLength(this.getSessionId().length());
