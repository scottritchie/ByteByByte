...
public class InstantiateAbstractType {
private static Logger log4j = Logger.getLogger(InstantiateAbstractType.class);
...
/**
 * This method constructs a InstantiateAbstractType object based on an Element
 * object.
 * 
 * @param element
 *            The Element.
 */
public InstantiateAbstractType(Element element) {
this.element = element;
this.abstractType = new AbstractType();
}

/**
 * The instantiate method instantiates a AbstractType object.
 * 
 * @return The AbstractType.
 */
protected AbstractType instantiate() {
...
for (AbstractAttribute abstractAttribute : element.getAbstractAttributes()) {
   ...
   abstractType.setName(kvp.getValue());
   }
