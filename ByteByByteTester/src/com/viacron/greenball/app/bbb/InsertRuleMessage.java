...
public class InsertRuleMessage {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      InsertRuleMessageEnum.ORG_ID.setLength(this.getOrgId().length());
      InsertRuleMessageEnum.ORG_NAME.setLength(this.getOrgName().length());
      InsertRuleMessageEnum.MODEL_NAME.setLength(this.getModelName().length());
      InsertRuleMessageEnum.RULE.setLength(this.getRule().getRuleSize());
      InsertRuleMessageEnum.USER_NAME.setLength(this.getUserName().length());
      InsertRuleMessageEnum.SESSION_ID.setLength(this.getSessionId().length());
