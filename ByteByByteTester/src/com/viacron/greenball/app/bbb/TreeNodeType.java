...
public class TreeNodeType {
   ...
   private enum TreeNodeTypeEnum {
      ...
      // sizeInBits: 32
      USAGE_COUNTER(8, 5, 0, false),

      // sizeInBits: 32
      LEVEL(9, 37, 0, false),

      // sizeInBits: 32
      NODE_STATE(10, 69, 0, false),
      ...
      // sizeInBits: 8
      MULTI(15, 173, 0, false),

      // sizeInBits: 8
      LABELABLE(16, 181, 0, false),

      // sizeInBits: 8
      EXPANDED(17, 189, 0, false),
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      TreeNodeTypeEnum.PREFIX.setLength(this.getPrefix().length());
      TreeNodeTypeEnum.LABEL.setLength(this.getLabel().length());
      TreeNodeTypeEnum.FIELD_NAME.setLength(this.getFieldName().length());
      TreeNodeTypeEnum.CLASS_NAME.setLength(this.getClassName().length());
      TreeNodeTypeEnum.SOURCE.setLength(this.getSource().length());
      TreeNodeTypeEnum.CROSSLINK.setLength(this.getCrosslink().length());
      TreeNodeTypeEnum.RULE_IDS.setLength(this.getRuleIds().size());
      TreeNodeTypeEnum.CROSS_REFERENCE.setLength(this.getCrossReference().length());
      TreeNodeTypeEnum.ID.setLength(this.getId().length());
      TreeNodeTypeEnum.PARENT_ID.setLength(this.getParentId().length());
