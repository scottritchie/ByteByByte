...
public class DeleteRuleMessageResponse {
    ...
    */
   public DeleteRuleMessageResponse(String orgName,
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      DeleteRuleMessageResponseEnum.ORG_NAME.setLength(this.getOrgName().length());
      DeleteRuleMessageResponseEnum.MODEL_NAME.setLength(this.getModelName().length());
      DeleteRuleMessageResponseEnum.RULE.setLength(this.getRule().getRuleSize());
      DeleteRuleMessageResponseEnum.USER_NAME.setLength(this.getUserName().length());
      DeleteRuleMessageResponseEnum.SESSION_ID.setLength(this.getSessionId().length());
      ...
      if (directorySize != 0) {
         ...
         for (DeleteRuleMessageResponseEnum deleteRuleMessageResponseEnum : DeleteRuleMessageResponseEnum.values()) {
            if (deleteRuleMessageResponseEnum.isDirectoryEntry == true) {
               ...
               // Insert the data
               if (id == DeleteRuleMessageResponseEnum.ORG_NAME.getId()) {
               ...
               else if (id == DeleteRuleMessageResponseEnum.RULE.getId()) {
   ...
   public DeleteRuleMessageResponse unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == DeleteRuleMessageResponseEnum.ORG_NAME.getId()) {
            ...
            deleteRuleMessageResponse.setRule(new Rule().unpack(bytes));
         }
      }
