...
public class Model {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      ModelEnum.ORG_ID.setLength(this.getOrgId().length());
      ModelEnum.ORG_NAME.setLength(this.getOrgName().length());
      ModelEnum.NAME.setLength(this.getName().length());
      ModelEnum.RULES.setLength(this.getRules().size());
      ModelEnum.TREE_NODE.setLength(this.getTreeNode().getTreeNodeTypeSize());
      ModelEnum.ID.setLength(this.getId().length());
      ModelEnum.SESSION_ID.setLength(this.getSessionId().length());
