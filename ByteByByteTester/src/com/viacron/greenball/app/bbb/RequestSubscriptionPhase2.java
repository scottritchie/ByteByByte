...
public class RequestSubscriptionPhase2 {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      RequestSubscriptionPhase2Enum.REQUESTOR.setLength(this.getRequestor().length());
      RequestSubscriptionPhase2Enum.MESSAGE.setLength(this.getMessage().length());
      RequestSubscriptionPhase2Enum.ORG_ID.setLength(this.getOrgId().length());
      RequestSubscriptionPhase2Enum.ORG_NAME.setLength(this.getOrgName().length());
      RequestSubscriptionPhase2Enum.SESSION_ID.setLength(this.getSessionId().length());
