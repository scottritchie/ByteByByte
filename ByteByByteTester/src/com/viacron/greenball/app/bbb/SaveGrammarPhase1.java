...
public class SaveGrammarPhase1 {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      SaveGrammarPhase1Enum.ORG_ID.setLength(this.getOrgId().length());
      SaveGrammarPhase1Enum.ORG_NAME.setLength(this.getOrgName().length());
      SaveGrammarPhase1Enum.USER_NAME.setLength(this.getUserName().length());
      SaveGrammarPhase1Enum.BUFFER.setLength(this.getBuffer().length());
      SaveGrammarPhase1Enum.SESSION_ID.setLength(this.getSessionId().length());
