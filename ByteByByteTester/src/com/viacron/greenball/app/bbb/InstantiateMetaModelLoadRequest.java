...
public class InstantiateMetaModelLoadRequest {
   private static Logger log4j = Logger.getLogger(InstantiateMetaModelLoadRequest.class);
   ...
   private MetaModelLoadRequest metaModelLoadRequest;

   /**
    * The InstantiateMetaModelLoadRequest class instantiates the MetaModelLoadRequest object.
    *
    * @param element The root element returned by the parser after parsing the string
    *                representing the MetaModelLoadRequest.
    */
   public InstantiateMetaModelLoadRequest(Element element) {
      this.element = element;   
      this.metaModelLoadRequest = new MetaModelLoadRequest();
   }

   /**
    * This method instantiates the MetaModelLoadRequest.
    *
    * @return The MetaModelLoadRequest.
    */
   public MetaModelLoadRequest instantiate() {
      final String METHOD = "instantiate()";
      log4j.debug("Entered " + METHOD);

      log4j.debug("MetaModelLoadRequest: " + element.getName());
      log4j.debug("# of attributes: " + element.getAbstractAttributes().size());

      instantiateMetaModelLoadRequestAttributes(element);
      ...
      instantiateMetaModelLoadRequestSubTypeRefs(e);
      }
      }
      ...
      /*
       * This method instantiates the MetaModelLoadRequest attributes.
       * 
       * @param Element element
       */
      private void instantiateMetaModelLoadRequestAttributes(Element element) {
      final String METHOD = "instantiateMetaModelLoadRequestAttributes()";
      log4j.debug("Entered " + METHOD);
      ...
      for (AbstractAttribute attr : element.getAbstractAttributes()) {
         for (KeyValuePair kvp : attr.getKeyValuePairs()) {
            ...
            if (kvp.getKey().equals("orgId")) {
               ...
               metaModelLoadRequest.setOrgId(kvp.getValue());
            }
            ...
            if (kvp.getKey().equals("orgName")) {
               ...
               metaModelLoadRequest.setOrgName(kvp.getValue());
            }
            // Leaving instantiateMsgAttribute()
            // Entered instantiateMsgAttribute()
            if (kvp.getKey().equals("sessionId")) {
               log4j.debug("setting value of \"sessionId\" to: " + kvp.getValue());
               metaModelLoadRequest.setSessionId(kvp.getValue());
            }
            // Leaving instantiateMsgAttribute()
         }
      }
   ...
   /*
    * This method instantiates the MetaModelLoadRequest SubType references.
    * 
    * @param Element element
    */
   private void instantiateMetaModelLoadRequestSubTypeRefs(Element element) {
      final String METHOD = "instantiateMetaModelLoadRequestSubTypeRefs()";
      log4j.debug("Entered " + METHOD);
