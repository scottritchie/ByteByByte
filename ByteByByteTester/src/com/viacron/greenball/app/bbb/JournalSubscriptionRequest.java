...
public class JournalSubscriptionRequest {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      JournalSubscriptionRequestEnum.USER.setLength(this.getUser().length());
      JournalSubscriptionRequestEnum.ORG_ID.setLength(this.getOrgId().length());
      JournalSubscriptionRequestEnum.ORG_NAME.setLength(this.getOrgName().length());
