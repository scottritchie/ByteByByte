...
public class OrganizationSubType {
   ...
   private enum OrganizationSubTypeEnum {
      ...
      // sizeInBits: 8
      IS_PRIVATE(9, 68, 0, false),

      // sizeInBits: 8
      IS_TWO_FACTOR_AUTHENTICATION_REQUIRED(10, 76, 0, false),

      // sizeInBits: 8
      IS_LIST_IN_DIRECTORY(11, 84, 0, false),

      // sizeInBits: 8
      IS_LOCKED(12, 92, 0, false),
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      OrganizationSubTypeEnum.ID.setLength(this.getId().length());
      OrganizationSubTypeEnum.USER.setLength(this.getUser().length());
      OrganizationSubTypeEnum.PASSWORD.setLength(this.getPassword().length());
      OrganizationSubTypeEnum.ADDITIONAL_PASSWORD.setLength(this.getAdditional_password().length());
      OrganizationSubTypeEnum.DISPLAY_NAME.setLength(this.getDisplayName().length());
      OrganizationSubTypeEnum.DESCRIPTION.setLength(this.getDescription().length());
      OrganizationSubTypeEnum.OWNER.setLength(this.getOwner().length());
      OrganizationSubTypeEnum.SEND_SUBSCRIPTION_REQUESTS_TO.setLength(this.getSendSubscriptionRequestsTo().length());
      OrganizationSubTypeEnum.LOCKED_BY.setLength(this.getLockedBy().length());
      OrganizationSubTypeEnum.LOCK_TIMESTAMP.setLength(this.getLockTimestamp().length());
      OrganizationSubTypeEnum.TEMPLATE.setLength(this.getTemplate().length());
