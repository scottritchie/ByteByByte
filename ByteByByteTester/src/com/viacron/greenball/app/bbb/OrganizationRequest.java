...
public class OrganizationRequest {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      OrganizationRequestEnum.USER.setLength(this.getUser().length());
      OrganizationRequestEnum.ORG_ID.setLength(this.getOrgId().length());
      OrganizationRequestEnum.ORG_NAME.setLength(this.getOrgName().length());
      OrganizationRequestEnum.SESSION_ID.setLength(this.getSessionId().length());
