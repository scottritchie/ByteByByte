...
/**
 * The RuleSyncResponse class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a RuleSyncResponse object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a RuleSyncResponse object.
 */
public class RuleSyncResponse {
   private static final int ID = GreenballMessagesEnum.RULE_SYNC_RESPONSE.getId();

   /**
    * The number of bits required to represent the RuleSyncResponseEnum IDs.
    * # of attributes: 1
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(RuleSyncResponse.class);

   // Entered buildClassEnum()
   private enum RuleSyncResponseEnum {
      ...
      RuleSyncResponseEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The RuleSyncResponse no-arg constructor.
    */
   public RuleSyncResponse() {}

   /**
    * The RuleSyncResponse constructor.
    * See buildParameterAnnotations() in JBitByBitGenerator.java.
    *
    * @param rules The rules message attribute.
    */
   public RuleSyncResponse(List<Rule> rules) {
   ...
   /**
    * This method packs a RuleSyncResponse object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a RuleSyncResponse message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getRuleSyncResponseSize();
      ...
      RuleSyncResponseEnum.RULES.setLength(this.getRules().size());

      int directorySize = getRuleSyncResponseDirectorySize();
      if (directorySize != 0) {
         ...
         for (RuleSyncResponseEnum ruleSyncResponseEnum : RuleSyncResponseEnum.values()) {
            if (ruleSyncResponseEnum.isDirectoryEntry == true) {
               int id = ruleSyncResponseEnum.getId();
               int length = ruleSyncResponseEnum.getLength();
               ...
               // Insert the data
               if (id == RuleSyncResponseEnum.RULES.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a RuleSyncResponse object.
    *
    * @return The byte array as a RuleSyncResponse message object.
    */
   public RuleSyncResponse unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == RuleSyncResponseEnum.RULES.getId()) {
            ...
            ruleSyncResponse.getRules().add(new Rule().unpack(bytes));
         }
      }
   ...
   /**
    * This method packs a RuleSyncResponse object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a RuleSyncResponse message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeRuleSyncResponse initializeRuleSyncResponse = new InitializeRuleSyncResponse(this);
      Element element = initializeRuleSyncResponse.initialize();
    ...
    */
   public RuleSyncResponse unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the RuleSyncResponse object.
       */
       InstantiateRuleSyncResponse instantiateRuleSyncResponse = new InstantiateRuleSyncResponse(element);
       RuleSyncResponse ruleSyncResponse = instantiateRuleSyncResponse.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateRuleSyncResponse.validate();
      if (result != null) {
    ...
    */
   private int getRuleSyncResponseDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the RuleSyncResponse object.
    * @return The size in bytes.
    */
   public int getRuleSyncResponseSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      RuleSyncResponse ruleSyncResponse = (RuleSyncResponse) obj;
      return true;
   }
}
