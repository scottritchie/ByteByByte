...
/**
 * The InitializeRequestUnsubscribe class initializes the element object with the RequestUnsubscribe object.
 *
 */
public class InitializeRequestUnsubscribe {
   private static Logger log4j = Logger.getLogger(InitializeRequestUnsubscribe.class);
    ...
    * The InitializeRequestUnsubscribe class initializes the element object with the RequestUnsubscribe object.
    *
    * @param requestUnsubscribe The object which will be used to initialize the element object.
    */
   public InitializeRequestUnsubscribe(RequestUnsubscribe requestUnsubscribe) {
      this.requestUnsubscribe = requestUnsubscribe;

      this.element = new Element("RequestUnsubscribe");
   }
   ...
   public Element initialize() throws MissingAttributeException {
      ...
      log4j.debug("element.getName(): RequestUnsubscribe");

      if (requestUnsubscribe.getOrgId() != null) {
         AbstractAttribute abstractAttribute = initializeOrgId(requestUnsubscribe.getOrgId());
      ...
      if (requestUnsubscribe.getOrgName() != null) {
         AbstractAttribute abstractAttribute = initializeOrgName(requestUnsubscribe.getOrgName());
         element.getAbstractAttributes().add(abstractAttribute);
      }
      else {
         // Missing required attribute, generate an error message and throw an exception
      ...
      if (requestUnsubscribe.getUserName() != null) {
         AbstractAttribute abstractAttribute = initializeUserName(requestUnsubscribe.getUserName());
         element.getAbstractAttributes().add(abstractAttribute);
      }
      else {
         // Missing required attribute, generate an error message and throw an exception
      ...
      if (requestUnsubscribe.getSessionId() != null) {
         AbstractAttribute abstractAttribute = initializeSessionId(requestUnsubscribe.getSessionId());
         element.getAbstractAttributes().add(abstractAttribute);
      }
