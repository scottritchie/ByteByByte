...
public class InsertRulePhase2Message {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      InsertRulePhase2MessageEnum.ORG_ID.setLength(this.getOrgId().length());
      InsertRulePhase2MessageEnum.ORG_NAME.setLength(this.getOrgName().length());
      InsertRulePhase2MessageEnum.MODEL_NAME.setLength(this.getModelName().length());
      InsertRulePhase2MessageEnum.RULE.setLength(this.getRule().getRuleSize());
      InsertRulePhase2MessageEnum.USER_NAME.setLength(this.getUserName().length());
      InsertRulePhase2MessageEnum.SESSION_ID.setLength(this.getSessionId().length());
