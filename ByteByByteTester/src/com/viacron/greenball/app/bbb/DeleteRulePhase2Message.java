...
public class DeleteRulePhase2Message {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      DeleteRulePhase2MessageEnum.ORG_ID.setLength(this.getOrgId().length());
      DeleteRulePhase2MessageEnum.ORG_NAME.setLength(this.getOrgName().length());
      DeleteRulePhase2MessageEnum.MODEL_NAME.setLength(this.getModelName().length());
      DeleteRulePhase2MessageEnum.RULE.setLength(this.getRule().getRuleSize());
      DeleteRulePhase2MessageEnum.USER_NAME.setLength(this.getUserName().length());
      DeleteRulePhase2MessageEnum.SESSION_ID.setLength(this.getSessionId().length());
