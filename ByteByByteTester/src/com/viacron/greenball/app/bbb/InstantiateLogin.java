...
public class InstantiateLogin {
   private static Logger log4j = Logger.getLogger(InstantiateLogin.class);
   ...
   /**
    * The InstantiateLogin class instantiates the Login object.
    *
    * @param element The root element returned by the parser after parsing the string
    *                representing the Login.
    */
   public InstantiateLogin(Element element) {
      this.element = element;   
      this.login = new Login();
   }

   /**
    * This method instantiates the Login.
    *
    * @return The Login.
    */
   public Login instantiate() {
      final String METHOD = "instantiate()";
      log4j.debug("Entered " + METHOD);

      log4j.debug("Login: " + element.getName());
      log4j.debug("# of attributes: " + element.getAbstractAttributes().size());

      instantiateLoginAttributes(element);
      ...
      /*
       * This method instantiates the Login attributes.
       * 
       * @param Element element
       */
      private void instantiateLoginAttributes(Element element) {
      final String METHOD = "instantiateLoginAttributes()";
      log4j.debug("Entered " + METHOD);
   ...
   /*
    * This method instantiates the Login SubType references.
    * 
    * @param Element element
    */
   private void instantiateLoginSubTypeRefs(Element element) {
      final String METHOD = "instantiateLoginSubTypeRefs()";
      log4j.debug("Entered " + METHOD);
