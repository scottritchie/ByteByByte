...
/**
 * The ResponseModelElementUpdate class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a ResponseModelElementUpdate object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a ResponseModelElementUpdate object.
 */
public class ResponseModelElementUpdate {
   private static final int ID = GreenballMessagesEnum.RESPONSE_MODEL_ELEMENT_UPDATE.getId();

   /**
    * The number of bits required to represent the ResponseModelElementUpdateEnum IDs.
    * # of attributes: 6
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(ResponseModelElementUpdate.class);

   // Entered buildClassEnum()
   private enum ResponseModelElementUpdateEnum {
      ...
      ResponseModelElementUpdateEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The ResponseModelElementUpdate no-arg constructor.
    */
   public ResponseModelElementUpdate() {}

   /**
    * The ResponseModelElementUpdate constructor.
   ...
   /**
    * This method packs a ResponseModelElementUpdate object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a ResponseModelElementUpdate message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getResponseModelElementUpdateSize();
      ...
      ResponseModelElementUpdateEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      ResponseModelElementUpdateEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      ResponseModelElementUpdateEnum.ID.setLength(this.getId() != null ? this.getId().length() : 0);
      ResponseModelElementUpdateEnum.PATH.setLength(this.getPath() != null ? this.getPath().length() : 0);
      ResponseModelElementUpdateEnum.VALUE.setLength(this.getValue() != null ? this.getValue().length() : 0);
      ResponseModelElementUpdateEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getResponseModelElementUpdateDirectorySize();
      if (directorySize != 0) {
         ...
         for (ResponseModelElementUpdateEnum responseModelElementUpdateEnum : ResponseModelElementUpdateEnum.values()) {
            if (responseModelElementUpdateEnum.isDirectoryEntry == true) {
               int id = responseModelElementUpdateEnum.getId();
               int length = responseModelElementUpdateEnum.getLength();
               ...
               // Insert the data
               if (id == ResponseModelElementUpdateEnum.ORG_ID.getId()) {
               ...
               else if (id == ResponseModelElementUpdateEnum.ORG_NAME.getId()) {
               ...
               else if (id == ResponseModelElementUpdateEnum.ID.getId()) {
               ...
               else if (id == ResponseModelElementUpdateEnum.PATH.getId()) {
                  log4j.debug(String.format("inserting %s at offset %d", "path", offset));
                  if (getPath() != null) {
                     bb = GreenballMessagesUtility.insertString(bb, offset, getPath());
                     offset += length * 1;
                  }
               }
               else if (id == ResponseModelElementUpdateEnum.VALUE.getId()) {
               ...
               else if (id == ResponseModelElementUpdateEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a ResponseModelElementUpdate object.
    *
    * @return The byte array as a ResponseModelElementUpdate message object.
    */
   public ResponseModelElementUpdate unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == ResponseModelElementUpdateEnum.ORG_ID.getId()) {
            responseModelElementUpdate.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ResponseModelElementUpdateEnum.ORG_NAME.getId()) {
            responseModelElementUpdate.setOrgName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ResponseModelElementUpdateEnum.ID.getId()) {
            responseModelElementUpdate.setId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ResponseModelElementUpdateEnum.PATH.getId()) {
            responseModelElementUpdate.setPath(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ResponseModelElementUpdateEnum.VALUE.getId()) {
            responseModelElementUpdate.setValue(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ResponseModelElementUpdateEnum.SESSION_ID.getId()) {
            responseModelElementUpdate.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a ResponseModelElementUpdate object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a ResponseModelElementUpdate message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeResponseModelElementUpdate initializeResponseModelElementUpdate = new InitializeResponseModelElementUpdate(this);
      Element element = initializeResponseModelElementUpdate.initialize();
    ...
    */
   public ResponseModelElementUpdate unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the ResponseModelElementUpdate object.
       */
       InstantiateResponseModelElementUpdate instantiateResponseModelElementUpdate = new InstantiateResponseModelElementUpdate(element);
       ResponseModelElementUpdate responseModelElementUpdate = instantiateResponseModelElementUpdate.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateResponseModelElementUpdate.validate();
      if (result != null) {
   ...
   /**
    * This method sets the path attribute. Setting of this value is required.
   ...
   /**
    * This method gets the path attribute. The path attribute is a required attribute.
    */
    ...
    */
   private int getResponseModelElementUpdateDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the ResponseModelElementUpdate object.
    * @return The size in bytes.
    */
   public int getResponseModelElementUpdateSize() {
      int size = 0;
      ...
      // Add size of path
      size += (getPath() != null ? getPath().length() : 0);
      // Add size of value
   ...
   public boolean equals(Object obj) {
      ...
      ResponseModelElementUpdate responseModelElementUpdate = (ResponseModelElementUpdate) obj;
      if (!responseModelElementUpdate.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (!responseModelElementUpdate.getOrgName().equals(this.getOrgName())) {
         return false;
      }

      if (!responseModelElementUpdate.getId().equals(this.getId())) {
         return false;
      }

      if (!responseModelElementUpdate.getPath().equals(this.getPath())) {
         return false;
      }

      if (!responseModelElementUpdate.getValue().equals(this.getValue())) {
         return false;
      }

      if (!responseModelElementUpdate.getSessionId().equals(this.getSessionId())) {
         return false;
      }
