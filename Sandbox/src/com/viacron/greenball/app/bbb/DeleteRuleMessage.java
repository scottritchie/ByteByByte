...
/**
 * The DeleteRuleMessage class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a DeleteRuleMessage object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a DeleteRuleMessage object.
 */
public class DeleteRuleMessage {
   private static final int ID = GreenballMessagesEnum.DELETE_RULE_MESSAGE.getId();

   /**
    * The number of bits required to represent the DeleteRuleMessageEnum IDs.
    * # of attributes: 6
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(DeleteRuleMessage.class);

   // Entered buildClassEnum()
   private enum DeleteRuleMessageEnum {
      ...
      DeleteRuleMessageEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The DeleteRuleMessage no-arg constructor.
    */
   public DeleteRuleMessage() {}

   /**
    * The DeleteRuleMessage constructor.
    ...
    */
   public DeleteRuleMessage(String orgId,
                            String orgName,
   ...
   /**
    * This method packs a DeleteRuleMessage object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a DeleteRuleMessage message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getDeleteRuleMessageSize();
      ...
      DeleteRuleMessageEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      DeleteRuleMessageEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      DeleteRuleMessageEnum.MODEL_NAME.setLength(this.getModelName() != null ? this.getModelName().length() : 0);
      DeleteRuleMessageEnum.RULE.setLength(this.getRule().getRuleSize());
      DeleteRuleMessageEnum.USER_NAME.setLength(this.getUserName() != null ? this.getUserName().length() : 0);
      DeleteRuleMessageEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getDeleteRuleMessageDirectorySize();
      if (directorySize != 0) {
         ...
         for (DeleteRuleMessageEnum deleteRuleMessageEnum : DeleteRuleMessageEnum.values()) {
            if (deleteRuleMessageEnum.isDirectoryEntry == true) {
               int id = deleteRuleMessageEnum.getId();
               int length = deleteRuleMessageEnum.getLength();
               ...
               // Insert the data
               if (id == DeleteRuleMessageEnum.ORG_ID.getId()) {
               ...
               else if (id == DeleteRuleMessageEnum.ORG_NAME.getId()) {
               ...
               else if (id == DeleteRuleMessageEnum.MODEL_NAME.getId()) {
               ...
               else if (id == DeleteRuleMessageEnum.RULE.getId()) {
               ...
               else if (id == DeleteRuleMessageEnum.USER_NAME.getId()) {
               ...
               else if (id == DeleteRuleMessageEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a DeleteRuleMessage object.
    *
    * @return The byte array as a DeleteRuleMessage message object.
    */
   public DeleteRuleMessage unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == DeleteRuleMessageEnum.ORG_ID.getId()) {
            deleteRuleMessage.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == DeleteRuleMessageEnum.ORG_NAME.getId()) {
            deleteRuleMessage.setOrgName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == DeleteRuleMessageEnum.MODEL_NAME.getId()) {
            deleteRuleMessage.setModelName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == DeleteRuleMessageEnum.USER_NAME.getId()) {
            deleteRuleMessage.setUserName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == DeleteRuleMessageEnum.SESSION_ID.getId()) {
            deleteRuleMessage.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == DeleteRuleMessageEnum.RULE.getId()) {
            ...
            deleteRuleMessage.setRule(new Rule().unpack(bytes));
         }
      }
   ...
   /**
    * This method packs a DeleteRuleMessage object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a DeleteRuleMessage message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeDeleteRuleMessage initializeDeleteRuleMessage = new InitializeDeleteRuleMessage(this);
      Element element = initializeDeleteRuleMessage.initialize();
    ...
    */
   public DeleteRuleMessage unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the DeleteRuleMessage object.
       */
       InstantiateDeleteRuleMessage instantiateDeleteRuleMessage = new InstantiateDeleteRuleMessage(element);
       DeleteRuleMessage deleteRuleMessage = instantiateDeleteRuleMessage.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateDeleteRuleMessage.validate();
      if (result != null) {
    ...
    */
   private int getDeleteRuleMessageDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the DeleteRuleMessage object.
    * @return The size in bytes.
    */
   public int getDeleteRuleMessageSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      DeleteRuleMessage deleteRuleMessage = (DeleteRuleMessage) obj;
      if (!deleteRuleMessage.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (!deleteRuleMessage.getOrgName().equals(this.getOrgName())) {
         return false;
      }

      if (!deleteRuleMessage.getModelName().equals(this.getModelName())) {
         return false;
      }

      if (!deleteRuleMessage.getUserName().equals(this.getUserName())) {
         return false;
      }

      if (deleteRuleMessage.getSessionId() == null && this.getSessionId() != null) {
         return false;
      }
      else if (deleteRuleMessage.getSessionId() != null && this.getSessionId() == null) {
         return false;
      }
      else if (deleteRuleMessage.getSessionId() != null && 
      !deleteRuleMessage.getSessionId().equals(this.getSessionId())) {
         return false;
      }
