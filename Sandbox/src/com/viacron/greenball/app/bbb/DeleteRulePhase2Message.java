...
/**
 * The DeleteRulePhase2Message class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a DeleteRulePhase2Message object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a DeleteRulePhase2Message object.
 */
public class DeleteRulePhase2Message {
   private static final int ID = GreenballMessagesEnum.DELETE_RULE_PHASE2_MESSAGE.getId();

   /**
    * The number of bits required to represent the DeleteRulePhase2MessageEnum IDs.
    * # of attributes: 6
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(DeleteRulePhase2Message.class);

   // Entered buildClassEnum()
   private enum DeleteRulePhase2MessageEnum {
      ...
      DeleteRulePhase2MessageEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The DeleteRulePhase2Message no-arg constructor.
    */
   public DeleteRulePhase2Message() {}

   /**
    * The DeleteRulePhase2Message constructor.
    ...
    */
   public DeleteRulePhase2Message(String orgId,
                                  String orgName,
   ...
   /**
    * This method packs a DeleteRulePhase2Message object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a DeleteRulePhase2Message message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getDeleteRulePhase2MessageSize();
      ...
      DeleteRulePhase2MessageEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      DeleteRulePhase2MessageEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      DeleteRulePhase2MessageEnum.MODEL_NAME.setLength(this.getModelName() != null ? this.getModelName().length() : 0);
      DeleteRulePhase2MessageEnum.RULE.setLength(this.getRule().getRuleSize());
      DeleteRulePhase2MessageEnum.USER_NAME.setLength(this.getUserName() != null ? this.getUserName().length() : 0);
      DeleteRulePhase2MessageEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getDeleteRulePhase2MessageDirectorySize();
      if (directorySize != 0) {
         ...
         for (DeleteRulePhase2MessageEnum deleteRulePhase2MessageEnum : DeleteRulePhase2MessageEnum.values()) {
            if (deleteRulePhase2MessageEnum.isDirectoryEntry == true) {
               int id = deleteRulePhase2MessageEnum.getId();
               int length = deleteRulePhase2MessageEnum.getLength();
               ...
               // Insert the data
               if (id == DeleteRulePhase2MessageEnum.ORG_ID.getId()) {
               ...
               else if (id == DeleteRulePhase2MessageEnum.ORG_NAME.getId()) {
               ...
               else if (id == DeleteRulePhase2MessageEnum.MODEL_NAME.getId()) {
               ...
               else if (id == DeleteRulePhase2MessageEnum.RULE.getId()) {
               ...
               else if (id == DeleteRulePhase2MessageEnum.USER_NAME.getId()) {
               ...
               else if (id == DeleteRulePhase2MessageEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a DeleteRulePhase2Message object.
    *
    * @return The byte array as a DeleteRulePhase2Message message object.
    */
   public DeleteRulePhase2Message unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == DeleteRulePhase2MessageEnum.ORG_ID.getId()) {
            deleteRulePhase2Message.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == DeleteRulePhase2MessageEnum.ORG_NAME.getId()) {
            deleteRulePhase2Message.setOrgName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == DeleteRulePhase2MessageEnum.MODEL_NAME.getId()) {
            deleteRulePhase2Message.setModelName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == DeleteRulePhase2MessageEnum.USER_NAME.getId()) {
            deleteRulePhase2Message.setUserName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == DeleteRulePhase2MessageEnum.SESSION_ID.getId()) {
            deleteRulePhase2Message.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == DeleteRulePhase2MessageEnum.RULE.getId()) {
            ...
            deleteRulePhase2Message.setRule(new Rule().unpack(bytes));
         }
      }

      log4j.debug("Leaving " + METHOD);
      return deleteRulePhase2Message;
   }
   // Leaving buildUnpackMethod()

   // Entered buildPackStrMethod()
   /**
    * This method packs a DeleteRulePhase2Message object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a DeleteRulePhase2Message message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeDeleteRulePhase2Message initializeDeleteRulePhase2Message = new InitializeDeleteRulePhase2Message(this);
      Element element = initializeDeleteRulePhase2Message.initialize();
    ...
    */
   public DeleteRulePhase2Message unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the DeleteRulePhase2Message object.
       */
       InstantiateDeleteRulePhase2Message instantiateDeleteRulePhase2Message = new InstantiateDeleteRulePhase2Message(element);
       DeleteRulePhase2Message deleteRulePhase2Message = instantiateDeleteRulePhase2Message.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateDeleteRulePhase2Message.validate();
      if (result != null) {
    ...
    */
   private int getDeleteRulePhase2MessageDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the DeleteRulePhase2Message object.
    * @return The size in bytes.
    */
   public int getDeleteRulePhase2MessageSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      DeleteRulePhase2Message deleteRulePhase2Message = (DeleteRulePhase2Message) obj;
      if (!deleteRulePhase2Message.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (!deleteRulePhase2Message.getOrgName().equals(this.getOrgName())) {
         return false;
      }

      if (!deleteRulePhase2Message.getModelName().equals(this.getModelName())) {
         return false;
      }

      if (!deleteRulePhase2Message.getUserName().equals(this.getUserName())) {
         return false;
      }

      if (deleteRulePhase2Message.getSessionId() == null && this.getSessionId() != null) {
         return false;
      }
      else if (deleteRulePhase2Message.getSessionId() != null && this.getSessionId() == null) {
         return false;
      }
      else if (deleteRulePhase2Message.getSessionId() != null && 
      !deleteRulePhase2Message.getSessionId().equals(this.getSessionId())) {
         return false;
      }
