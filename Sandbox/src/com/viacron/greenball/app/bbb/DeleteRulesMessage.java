...
public class DeleteRulesMessage {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      DeleteRulesMessageEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      DeleteRulesMessageEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      DeleteRulesMessageEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);
      ...
      if (directorySize != 0) {
         ...
         for (DeleteRulesMessageEnum deleteRulesMessageEnum : DeleteRulesMessageEnum.values()) {
            if (deleteRulesMessageEnum.isDirectoryEntry == true) {
               ...
               else if (id == DeleteRulesMessageEnum.SESSION_ID.getId()) {
   ...
   public DeleteRulesMessage unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == DeleteRulesMessageEnum.ORG_ID.getId()) {
            ...
            deleteRulesMessage.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   public boolean equals(Object obj) {
      ...
      if (deleteRulesMessage.getSessionId() == null && this.getSessionId() != null) {
         return false;
      }
      else if (deleteRulesMessage.getSessionId() != null && this.getSessionId() == null) {
         return false;
      }
      else if (deleteRulesMessage.getSessionId() != null && 
      !deleteRulesMessage.getSessionId().equals(this.getSessionId())) {
         return false;
      }
