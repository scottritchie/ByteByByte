...
public class UpdateRuleDeadline {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      if (this.getNewDeadlineMsec() != null) {
         log4j.debug(String.format("inserting %s at offset %d", "newDeadlineMsec", offset));
      ...
      if (this.getOldDeadlineMsec() != null) {
         log4j.debug(String.format("inserting %s at offset %d", "oldDeadlineMsec", offset));
      ...
      UpdateRuleDeadlineEnum.RULE_ID.setLength(this.getRuleId() != null ? this.getRuleId().length() : 0);
      UpdateRuleDeadlineEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);
