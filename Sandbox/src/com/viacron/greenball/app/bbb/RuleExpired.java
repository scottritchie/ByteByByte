...
/**
 * The RuleExpired class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a RuleExpired object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a RuleExpired object.
 */
public class RuleExpired {
   private static final int ID = GreenballMessagesEnum.RULE_EXPIRED.getId();

   /**
    * The number of bits required to represent the RuleExpiredEnum IDs.
    * # of attributes: 1
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(RuleExpired.class);

   // Entered buildClassEnum()
   private enum RuleExpiredEnum {
      ...
      RuleExpiredEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * This method packs a RuleExpired object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a RuleExpired message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getRuleExpiredSize();
      ...
      RuleExpiredEnum.RULE.setLength(this.getRule().getRuleSize());

      int directorySize = getRuleExpiredDirectorySize();
      if (directorySize != 0) {
         ...
         for (RuleExpiredEnum ruleExpiredEnum : RuleExpiredEnum.values()) {
            if (ruleExpiredEnum.isDirectoryEntry == true) {
               int id = ruleExpiredEnum.getId();
               int length = ruleExpiredEnum.getLength();
               ...
               // Insert the data
               if (id == RuleExpiredEnum.RULE.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a RuleExpired object.
    *
    * @return The byte array as a RuleExpired message object.
    */
   public RuleExpired unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == RuleExpiredEnum.RULE.getId()) {
            ...
            ruleExpired.setRule(new Rule().unpack(bytes));
         }
      }
   ...
   /**
    * This method packs a RuleExpired object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a RuleExpired message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeRuleExpired initializeRuleExpired = new InitializeRuleExpired(this);
      Element element = initializeRuleExpired.initialize();
    ...
    */
   public RuleExpired unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the RuleExpired object.
       */
       InstantiateRuleExpired instantiateRuleExpired = new InstantiateRuleExpired(element);
       RuleExpired ruleExpired = instantiateRuleExpired.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateRuleExpired.validate();
      if (result != null) {
    ...
    */
   private int getRuleExpiredDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the RuleExpired object.
    * @return The size in bytes.
    */
   public int getRuleExpiredSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      RuleExpired ruleExpired = (RuleExpired) obj;
      return true;
   }
}
