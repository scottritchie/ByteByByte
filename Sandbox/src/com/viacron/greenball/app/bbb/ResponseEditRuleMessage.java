...
public class ResponseEditRuleMessage {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      ResponseEditRuleMessageEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      ResponseEditRuleMessageEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      ResponseEditRuleMessageEnum.MODEL_NAME.setLength(this.getModelName() != null ? this.getModelName().length() : 0);
      ...
      ResponseEditRuleMessageEnum.USER_NAME.setLength(this.getUserName() != null ? this.getUserName().length() : 0);
      ResponseEditRuleMessageEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);
