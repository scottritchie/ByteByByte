...
public class InstantiateInsertRuleMessage {
   private static Logger log4j = Logger.getLogger(InstantiateInsertRuleMessage.class);
   ...
   /**
    * The InstantiateInsertRuleMessage class instantiates the InsertRuleMessage object.
    *
    * @param element The root element returned by the parser after parsing the string
    *                representing the InsertRuleMessage.
    */
   public InstantiateInsertRuleMessage(Element element) {
      this.element = element;   
      this.insertRuleMessage = new InsertRuleMessage();
   }

   /**
    * This method instantiates the InsertRuleMessage.
    *
    * @return The InsertRuleMessage.
    */
   public InsertRuleMessage instantiate() {
      final String METHOD = "instantiate()";
      log4j.debug("Entered " + METHOD);

      log4j.debug("InsertRuleMessage: " + element.getName());
      log4j.debug("# of attributes: " + element.getAbstractAttributes().size());

      instantiateInsertRuleMessageAttributes(element);
      ...
      instantiateInsertRuleMessageSubTypeRefs(e);
      }
      }
      ...
      /*
       * This method instantiates the InsertRuleMessage attributes.
       * 
       * @param Element element
       */
      private void instantiateInsertRuleMessageAttributes(Element element) {
      final String METHOD = "instantiateInsertRuleMessageAttributes()";
      log4j.debug("Entered " + METHOD);
      ...
      for (AbstractAttribute attr : element.getAbstractAttributes()) {
         for (KeyValuePair kvp : attr.getKeyValuePairs()) {
            ...
            if (kvp.getKey().equals("orgId")) {
               ...
               insertRuleMessage.setOrgId(kvp.getValue());
            }
            ...
            if (kvp.getKey().equals("orgName")) {
               ...
               insertRuleMessage.setOrgName(kvp.getValue());
            }
            // Leaving instantiateMsgAttribute()
            // Entered instantiateMsgAttribute()
            if (kvp.getKey().equals("modelName")) {
               ...
               insertRuleMessage.setModelName(kvp.getValue());
            }
            // Leaving instantiateMsgAttribute()
            // Entered instantiateMsgAttribute()
            if (kvp.getKey().equals("userName")) {
               ...
               insertRuleMessage.setUserName(kvp.getValue());
            }
            // Leaving instantiateMsgAttribute()
            // Entered instantiateMsgAttribute()
            if (kvp.getKey().equals("sessionId")) {
               log4j.debug("setting value of \"sessionId\" to: " + kvp.getValue());
               insertRuleMessage.setSessionId(kvp.getValue());
            }
            // Leaving instantiateMsgAttribute()
         }
      }
   ...
   /*
    * This method instantiates the InsertRuleMessage SubType references.
    * 
    * @param Element element
    */
   private void instantiateInsertRuleMessageSubTypeRefs(Element element) {
      final String METHOD = "instantiateInsertRuleMessageSubTypeRefs()";
      log4j.debug("Entered " + METHOD);
...
private void instantiateRule(Element element) {
   ...
   insertRuleMessage.setRule(instantiateRule.instantiate());
