...
public class InstantiateSubscriptions {
   private static Logger log4j = Logger.getLogger(InstantiateSubscriptions.class);
   ...
   /**
    * The InstantiateSubscriptions class instantiates the Subscriptions object.
    *
    * @param element The root element returned by the parser after parsing the string
    *                representing the Subscriptions.
    */
   public InstantiateSubscriptions(Element element) {
      this.element = element;   
      this.subscriptions = new Subscriptions();
   }

   /**
    * This method instantiates the Subscriptions.
    *
    * @return The Subscriptions.
    */
   public Subscriptions instantiate() {
      final String METHOD = "instantiate()";
      log4j.debug("Entered " + METHOD);

      log4j.debug("Subscriptions: " + element.getName());
      log4j.debug("# of attributes: " + element.getAbstractAttributes().size());

      instantiateSubscriptionsAttributes(element);
      ...
      instantiateSubscriptionsSubTypeRefs(e);
      }
      }
      ...
      /*
       * This method instantiates the Subscriptions attributes.
       * 
       * @param Element element
       */
      private void instantiateSubscriptionsAttributes(Element element) {
      final String METHOD = "instantiateSubscriptionsAttributes()";
      log4j.debug("Entered " + METHOD);
      ...
      for (AbstractAttribute attr : element.getAbstractAttributes()) {
         for (KeyValuePair kvp : attr.getKeyValuePairs()) {
            ...
            if (kvp.getKey().equals("userName")) {
               ...
               subscriptions.setUserName(kvp.getValue());
            }
            ...
            if (kvp.getKey().equals("sessionId")) {
               ...
               subscriptions.setSessionId(kvp.getValue());
            }
            // Leaving instantiateMsgAttribute()
         }
      }
   ...
   /*
    * This method instantiates the Subscriptions SubType references.
    * 
    * @param Element element
    */
   private void instantiateSubscriptionsSubTypeRefs(Element element) {
      final String METHOD = "instantiateSubscriptionsSubTypeRefs()";
      log4j.debug("Entered " + METHOD);
