...
/**
 * The RuleMessage class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a RuleMessage object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a RuleMessage object.
 */
public class RuleMessage {
   private static final int ID = GreenballMessagesEnum.RULE_MESSAGE.getId();

   /**
    * The number of bits required to represent the RuleMessageEnum IDs.
    * # of attributes: 1
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(RuleMessage.class);

   // Entered buildClassEnum()
   private enum RuleMessageEnum {
      ...
      RuleMessageEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The RuleMessage no-arg constructor.
    */
   public RuleMessage() {}

   /**
    * The RuleMessage constructor.
   ...
   /**
    * This method packs a RuleMessage object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a RuleMessage message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getRuleMessageSize();
      ...
      RuleMessageEnum.RULE.setLength(this.getRule().getRuleSize());

      int directorySize = getRuleMessageDirectorySize();
      if (directorySize != 0) {
         ...
         for (RuleMessageEnum ruleMessageEnum : RuleMessageEnum.values()) {
            if (ruleMessageEnum.isDirectoryEntry == true) {
               int id = ruleMessageEnum.getId();
               int length = ruleMessageEnum.getLength();
               ...
               // Insert the data
               if (id == RuleMessageEnum.RULE.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a RuleMessage object.
    *
    * @return The byte array as a RuleMessage message object.
    */
   public RuleMessage unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == RuleMessageEnum.RULE.getId()) {
            ...
            ruleMessage.setRule(new Rule().unpack(bytes));
         }
      }
   ...
   /**
    * This method packs a RuleMessage object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a RuleMessage message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeRuleMessage initializeRuleMessage = new InitializeRuleMessage(this);
      Element element = initializeRuleMessage.initialize();
    ...
    */
   public RuleMessage unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the RuleMessage object.
       */
       InstantiateRuleMessage instantiateRuleMessage = new InstantiateRuleMessage(element);
       RuleMessage ruleMessage = instantiateRuleMessage.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateRuleMessage.validate();
      if (result != null) {
    ...
    */
   private int getRuleMessageDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the RuleMessage object.
    * @return The size in bytes.
    */
   public int getRuleMessageSize() {
      int size = 0;
