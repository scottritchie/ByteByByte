...
/**
 * The RequestLogin class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a RequestLogin object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a RequestLogin object.
 */
public class RequestLogin {
   private static final int ID = GreenballMessagesEnum.REQUEST_LOGIN.getId();

   /**
    * The number of bits required to represent the RequestLoginEnum IDs.
    * # of attributes: 3
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(RequestLogin.class);

   // Entered buildClassEnum()
   private enum RequestLoginEnum {
      ...
      RequestLoginEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The RequestLogin no-arg constructor.
    */
   public RequestLogin() {}

   /**
    * The RequestLogin constructor.
    ...
    */
   public RequestLogin(String user,
                       String password,
                       String sessionId) {
   ...
   /**
    * This method packs a RequestLogin object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a RequestLogin message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getRequestLoginSize();
      ...
      RequestLoginEnum.USER.setLength(this.getUser() != null ? this.getUser().length() : 0);
      RequestLoginEnum.PASSWORD.setLength(this.getPassword() != null ? this.getPassword().length() : 0);
      RequestLoginEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getRequestLoginDirectorySize();
      if (directorySize != 0) {
         ...
         for (RequestLoginEnum requestLoginEnum : RequestLoginEnum.values()) {
            if (requestLoginEnum.isDirectoryEntry == true) {
               int id = requestLoginEnum.getId();
               int length = requestLoginEnum.getLength();
               ...
               // Insert the data
               if (id == RequestLoginEnum.USER.getId()) {
               ...
               else if (id == RequestLoginEnum.PASSWORD.getId()) {
               ...
               else if (id == RequestLoginEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a RequestLogin object.
    *
    * @return The byte array as a RequestLogin message object.
    */
   public RequestLogin unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == RequestLoginEnum.USER.getId()) {
            requestLogin.setUser(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestLoginEnum.PASSWORD.getId()) {
            requestLogin.setPassword(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestLoginEnum.SESSION_ID.getId()) {
            requestLogin.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a RequestLogin object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a RequestLogin message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeRequestLogin initializeRequestLogin = new InitializeRequestLogin(this);
      Element element = initializeRequestLogin.initialize();
    ...
    */
   public RequestLogin unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the RequestLogin object.
       */
       InstantiateRequestLogin instantiateRequestLogin = new InstantiateRequestLogin(element);
       RequestLogin requestLogin = instantiateRequestLogin.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateRequestLogin.validate();
      if (result != null) {
    ...
    */
   private int getRequestLoginDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the RequestLogin object.
    * @return The size in bytes.
    */
   public int getRequestLoginSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      if (!requestLogin.getUser().equals(this.getUser())) {
         return false;
      }

      if (!requestLogin.getPassword().equals(this.getPassword())) {
         return false;
      }

      if (requestLogin.getSessionId() == null && this.getSessionId() != null) {
         return false;
      }
      else if (requestLogin.getSessionId() != null && this.getSessionId() == null) {
         return false;
      }
      else if (requestLogin.getSessionId() != null && 
      !requestLogin.getSessionId().equals(this.getSessionId())) {
         return false;
      }
