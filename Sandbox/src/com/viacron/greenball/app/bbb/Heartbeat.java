...
/**
 * The Heartbeat class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a Heartbeat object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a Heartbeat object.
 */
public class Heartbeat {
   private static final int ID = GreenballMessagesEnum.HEARTBEAT.getId();

   /**
    * The number of bits required to represent the HeartbeatEnum IDs.
    * # of attributes: 1
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(Heartbeat.class);
   ...
   private enum HeartbeatEnum {
      ...
      HeartbeatEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The Heartbeat no-arg constructor.
    */
   public Heartbeat() {}

   /**
    * The Heartbeat constructor.
   ...
   /**
    * This method packs a Heartbeat object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a Heartbeat message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getHeartbeatSize();
      ...
      HeartbeatEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getHeartbeatDirectorySize();
      if (directorySize != 0) {
         ...
         for (HeartbeatEnum heartbeatEnum : HeartbeatEnum.values()) {
            if (heartbeatEnum.isDirectoryEntry == true) {
               int id = heartbeatEnum.getId();
               int length = heartbeatEnum.getLength();
               ...
               // Insert the data
               if (id == HeartbeatEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a Heartbeat object.
    *
    * @return The byte array as a Heartbeat message object.
    */
   public Heartbeat unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == HeartbeatEnum.SESSION_ID.getId()) {
            heartbeat.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a Heartbeat object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a Heartbeat message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeHeartbeat initializeHeartbeat = new InitializeHeartbeat(this);
      Element element = initializeHeartbeat.initialize();
    ...
    */
   public Heartbeat unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
       ...
       */
       InstantiateHeartbeat instantiateHeartbeat = new InstantiateHeartbeat(element);
       Heartbeat heartbeat = instantiateHeartbeat.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateHeartbeat.validate();
      if (result != null) {
    ...
    */
   private int getHeartbeatDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the Heartbeat object.
   ...
   public boolean equals(Object obj) {
      ...
      if (!heartbeat.getSessionId().equals(this.getSessionId())) {
         return false;
      }
