...
public class InstantiateDirectory {
   private static Logger log4j = Logger.getLogger(InstantiateDirectory.class);
   ...
   /**
    * The InstantiateDirectory class instantiates the Directory object.
    *
    * @param element The root element returned by the parser after parsing the string
    *                representing the Directory.
    */
   public InstantiateDirectory(Element element) {
      this.element = element;   
      this.directory = new Directory();
   }

   /**
    * This method instantiates the Directory.
    *
    * @return The Directory.
    */
   public Directory instantiate() {
      final String METHOD = "instantiate()";
      log4j.debug("Entered " + METHOD);

      log4j.debug("Directory: " + element.getName());
      log4j.debug("# of attributes: " + element.getAbstractAttributes().size());

      instantiateDirectoryAttributes(element);
      ...
      instantiateDirectorySubTypeRefs(e);
      }
      }
      ...
      /*
       * This method instantiates the Directory attributes.
       * 
       * @param Element element
       */
      private void instantiateDirectoryAttributes(Element element) {
      final String METHOD = "instantiateDirectoryAttributes()";
      log4j.debug("Entered " + METHOD);
      ...
      for (AbstractAttribute attr : element.getAbstractAttributes()) {
         for (KeyValuePair kvp : attr.getKeyValuePairs()) {
            ...
            if (kvp.getKey().equals("userName")) {
               ...
               directory.setUserName(kvp.getValue());
            }
            ...
            if (kvp.getKey().equals("sessionId")) {
               ...
               directory.setSessionId(kvp.getValue());
            }
            // Leaving instantiateMsgAttribute()
         }
      }
   ...
   /*
    * This method instantiates the Directory SubType references.
    * 
    * @param Element element
    */
   private void instantiateDirectorySubTypeRefs(Element element) {
      final String METHOD = "instantiateDirectorySubTypeRefs()";
      log4j.debug("Entered " + METHOD);
