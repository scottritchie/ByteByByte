...
/**
 * The ResponseInsertRuleMessage class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a ResponseInsertRuleMessage object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a ResponseInsertRuleMessage object.
 */
public class ResponseInsertRuleMessage {
   private static final int ID = GreenballMessagesEnum.RESPONSE_INSERT_RULE_MESSAGE.getId();

   /**
    * The number of bits required to represent the ResponseInsertRuleMessageEnum IDs.
    * # of attributes: 6
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(ResponseInsertRuleMessage.class);

   // Entered buildClassEnum()
   private enum ResponseInsertRuleMessageEnum {
      ...
      ResponseInsertRuleMessageEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The ResponseInsertRuleMessage no-arg constructor.
    */
   public ResponseInsertRuleMessage() {}

   /**
    * The ResponseInsertRuleMessage constructor.
    ...
    */
   public ResponseInsertRuleMessage(String orgId,
                                    String orgName,
   ...
   /**
    * This method packs a ResponseInsertRuleMessage object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a ResponseInsertRuleMessage message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getResponseInsertRuleMessageSize();
      ...
      ResponseInsertRuleMessageEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      ResponseInsertRuleMessageEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      ResponseInsertRuleMessageEnum.MODEL_NAME.setLength(this.getModelName() != null ? this.getModelName().length() : 0);
      ResponseInsertRuleMessageEnum.RULE.setLength(this.getRule().getRuleSize());
      ResponseInsertRuleMessageEnum.USER_NAME.setLength(this.getUserName() != null ? this.getUserName().length() : 0);
      ResponseInsertRuleMessageEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getResponseInsertRuleMessageDirectorySize();
      if (directorySize != 0) {
         ...
         for (ResponseInsertRuleMessageEnum responseInsertRuleMessageEnum : ResponseInsertRuleMessageEnum.values()) {
            if (responseInsertRuleMessageEnum.isDirectoryEntry == true) {
               int id = responseInsertRuleMessageEnum.getId();
               int length = responseInsertRuleMessageEnum.getLength();
               ...
               // Insert the data
               if (id == ResponseInsertRuleMessageEnum.ORG_ID.getId()) {
               ...
               else if (id == ResponseInsertRuleMessageEnum.ORG_NAME.getId()) {
               ...
               else if (id == ResponseInsertRuleMessageEnum.MODEL_NAME.getId()) {
               ...
               else if (id == ResponseInsertRuleMessageEnum.RULE.getId()) {
               ...
               else if (id == ResponseInsertRuleMessageEnum.USER_NAME.getId()) {
               ...
               else if (id == ResponseInsertRuleMessageEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a ResponseInsertRuleMessage object.
    *
    * @return The byte array as a ResponseInsertRuleMessage message object.
    */
   public ResponseInsertRuleMessage unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == ResponseInsertRuleMessageEnum.ORG_ID.getId()) {
            responseInsertRuleMessage.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ResponseInsertRuleMessageEnum.ORG_NAME.getId()) {
            responseInsertRuleMessage.setOrgName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ResponseInsertRuleMessageEnum.MODEL_NAME.getId()) {
            responseInsertRuleMessage.setModelName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ResponseInsertRuleMessageEnum.USER_NAME.getId()) {
            responseInsertRuleMessage.setUserName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ResponseInsertRuleMessageEnum.SESSION_ID.getId()) {
            responseInsertRuleMessage.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ResponseInsertRuleMessageEnum.RULE.getId()) {
            ...
            responseInsertRuleMessage.setRule(new Rule().unpack(bytes));
         }
      }
   ...
   /**
    * This method packs a ResponseInsertRuleMessage object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a ResponseInsertRuleMessage message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeResponseInsertRuleMessage initializeResponseInsertRuleMessage = new InitializeResponseInsertRuleMessage(this);
      Element element = initializeResponseInsertRuleMessage.initialize();
    ...
    */
   public ResponseInsertRuleMessage unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the ResponseInsertRuleMessage object.
       */
       InstantiateResponseInsertRuleMessage instantiateResponseInsertRuleMessage = new InstantiateResponseInsertRuleMessage(element);
       ResponseInsertRuleMessage responseInsertRuleMessage = instantiateResponseInsertRuleMessage.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateResponseInsertRuleMessage.validate();
      if (result != null) {
    ...
    */
   private int getResponseInsertRuleMessageDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the ResponseInsertRuleMessage object.
    * @return The size in bytes.
    */
   public int getResponseInsertRuleMessageSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      ResponseInsertRuleMessage responseInsertRuleMessage = (ResponseInsertRuleMessage) obj;
      if (!responseInsertRuleMessage.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (!responseInsertRuleMessage.getOrgName().equals(this.getOrgName())) {
         return false;
      }

      if (!responseInsertRuleMessage.getModelName().equals(this.getModelName())) {
         return false;
      }

      if (!responseInsertRuleMessage.getUserName().equals(this.getUserName())) {
         return false;
      }

      if (responseInsertRuleMessage.getSessionId() == null && this.getSessionId() != null) {
         return false;
      }
      else if (responseInsertRuleMessage.getSessionId() != null && this.getSessionId() == null) {
         return false;
      }
      else if (responseInsertRuleMessage.getSessionId() != null && 
      !responseInsertRuleMessage.getSessionId().equals(this.getSessionId())) {
         return false;
      }
