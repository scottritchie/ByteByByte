...
/**
 * The MetaModelLockResponse class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a MetaModelLockResponse object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a MetaModelLockResponse object.
 */
public class MetaModelLockResponse {
   private static final int ID = GreenballMessagesEnum.META_MODEL_LOCK_RESPONSE.getId();

   /**
    * The number of bits required to represent the MetaModelLockResponseEnum IDs.
    * # of attributes: 4
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(MetaModelLockResponse.class);

   // Entered buildClassEnum()
   private enum MetaModelLockResponseEnum {
      ...
      MetaModelLockResponseEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The MetaModelLockResponse no-arg constructor.
    */
   public MetaModelLockResponse() {}

   /**
    * The MetaModelLockResponse constructor.
    ...
    */
   public MetaModelLockResponse(String user,
                                String metaModelId,
                                Boolean lock,
                                String sessionId) {
   ...
   /**
    * This method packs a MetaModelLockResponse object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a MetaModelLockResponse message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getMetaModelLockResponseSize();
      ...
      if (this.getLock() != null) {
         log4j.debug(String.format("inserting %s at offset %d", "lock", offset));
      ...
      MetaModelLockResponseEnum.USER.setLength(this.getUser() != null ? this.getUser().length() : 0);
      MetaModelLockResponseEnum.META_MODEL_ID.setLength(this.getMetaModelId() != null ? this.getMetaModelId().length() : 0);
      MetaModelLockResponseEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getMetaModelLockResponseDirectorySize();
      if (directorySize != 0) {
         ...
         for (MetaModelLockResponseEnum metaModelLockResponseEnum : MetaModelLockResponseEnum.values()) {
            if (metaModelLockResponseEnum.isDirectoryEntry == true) {
               int id = metaModelLockResponseEnum.getId();
               int length = metaModelLockResponseEnum.getLength();
               ...
               // Insert the data
               if (id == MetaModelLockResponseEnum.USER.getId()) {
               ...
               else if (id == MetaModelLockResponseEnum.META_MODEL_ID.getId()) {
               ...
               else if (id == MetaModelLockResponseEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a MetaModelLockResponse object.
    *
    * @return The byte array as a MetaModelLockResponse message object.
    */
   public MetaModelLockResponse unpack(byte[] ba) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);

      MetaModelLockResponse metaModelLockResponse = new MetaModelLockResponse();

      metaModelLockResponse.setLock(GreenballMessagesUtility.getBoolean(ba, MetaModelLockResponseEnum.LOCK.getOffsetInBits()));
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == MetaModelLockResponseEnum.USER.getId()) {
            metaModelLockResponse.setUser(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == MetaModelLockResponseEnum.META_MODEL_ID.getId()) {
            metaModelLockResponse.setMetaModelId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == MetaModelLockResponseEnum.SESSION_ID.getId()) {
            metaModelLockResponse.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a MetaModelLockResponse object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a MetaModelLockResponse message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeMetaModelLockResponse initializeMetaModelLockResponse = new InitializeMetaModelLockResponse(this);
      Element element = initializeMetaModelLockResponse.initialize();
    ...
    */
   public MetaModelLockResponse unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the MetaModelLockResponse object.
       */
       InstantiateMetaModelLockResponse instantiateMetaModelLockResponse = new InstantiateMetaModelLockResponse(element);
       MetaModelLockResponse metaModelLockResponse = instantiateMetaModelLockResponse.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateMetaModelLockResponse.validate();
      if (result != null) {
   ...
   /**
    * This method sets the metaModelId attribute. Setting of this value is required.
   ...
   /**
    * This method gets the metaModelId attribute. The metaModelId attribute is a required attribute.
    */
    ...
    */
   private int getMetaModelLockResponseDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the MetaModelLockResponse object.
    * @return The size in bytes.
    */
   public int getMetaModelLockResponseSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      MetaModelLockResponse metaModelLockResponse = (MetaModelLockResponse) obj;
      if (!metaModelLockResponse.getUser().equals(this.getUser())) {
         return false;
      }

      if (!metaModelLockResponse.getMetaModelId().equals(this.getMetaModelId())) {
         return false;
      }

      if (metaModelLockResponse.getLock() != this.getLock()) {
         return false;
      }

      if (!metaModelLockResponse.getSessionId().equals(this.getSessionId())) {
         return false;
      }
