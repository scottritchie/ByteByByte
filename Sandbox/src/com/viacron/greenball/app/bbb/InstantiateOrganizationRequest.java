...
public class InstantiateOrganizationRequest {
   private static Logger log4j = Logger.getLogger(InstantiateOrganizationRequest.class);
   ...
   /**
    * The InstantiateOrganizationRequest class instantiates the OrganizationRequest object.
    *
    * @param element The root element returned by the parser after parsing the string
    *                representing the OrganizationRequest.
    */
   public InstantiateOrganizationRequest(Element element) {
      this.element = element;   
      this.organizationRequest = new OrganizationRequest();
   }

   /**
    * This method instantiates the OrganizationRequest.
    *
    * @return The OrganizationRequest.
    */
   public OrganizationRequest instantiate() {
      final String METHOD = "instantiate()";
      log4j.debug("Entered " + METHOD);

      log4j.debug("OrganizationRequest: " + element.getName());
      log4j.debug("# of attributes: " + element.getAbstractAttributes().size());

      instantiateOrganizationRequestAttributes(element);
      ...
      instantiateOrganizationRequestSubTypeRefs(e);
      }
      }
      ...
      /*
       * This method instantiates the OrganizationRequest attributes.
       * 
       * @param Element element
       */
      private void instantiateOrganizationRequestAttributes(Element element) {
      final String METHOD = "instantiateOrganizationRequestAttributes()";
      log4j.debug("Entered " + METHOD);
      ...
      for (AbstractAttribute attr : element.getAbstractAttributes()) {
         for (KeyValuePair kvp : attr.getKeyValuePairs()) {
            ...
            if (kvp.getKey().equals("user")) {
               ...
               organizationRequest.setUser(kvp.getValue());
            }
            ...
            if (kvp.getKey().equals("orgId")) {
               ...
               organizationRequest.setOrgId(kvp.getValue());
            }
            // Leaving instantiateMsgAttribute()
            // Entered instantiateMsgAttribute()
            if (kvp.getKey().equals("orgName")) {
               ...
               organizationRequest.setOrgName(kvp.getValue());
            }
            // Leaving instantiateMsgAttribute()
            // Entered instantiateMsgAttribute()
            if (kvp.getKey().equals("sessionId")) {
               log4j.debug("setting value of \"sessionId\" to: " + kvp.getValue());
               organizationRequest.setSessionId(kvp.getValue());
            }
            // Leaving instantiateMsgAttribute()
         }
      }
   ...
   /*
    * This method instantiates the OrganizationRequest SubType references.
    * 
    * @param Element element
    */
   private void instantiateOrganizationRequestSubTypeRefs(Element element) {
      final String METHOD = "instantiateOrganizationRequestSubTypeRefs()";
      log4j.debug("Entered " + METHOD);
