...
public class ChatUser {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      if (this.getAvailable() != null) {
         log4j.debug(String.format("inserting %s at offset %d", "available", offset));
      ...
      ChatUserEnum.ORG.setLength(this.getOrg() != null ? this.getOrg().size() : 0);
   ...
   public ChatUser unpack(byte[] ba) {
      ...
      chatUser.setAction(ChatAction.toEnum(GreenballMessagesUtility.getByte(ba, ChatUserEnum.ACTION.getOffsetInBits())));
   ...
   public boolean equals(Object obj) {
      ...
      if (chatUser.getAction() != this.getAction()) {
         return false;
      }
