...
/**
 * The RuleSyncRequest class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a RuleSyncRequest object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a RuleSyncRequest object.
 */
public class RuleSyncRequest {
   private static final int ID = GreenballMessagesEnum.RULE_SYNC_REQUEST.getId();

   /**
    * The number of bits required to represent the RuleSyncRequestEnum IDs.
    * # of attributes: 1
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(RuleSyncRequest.class);

   // Entered buildClassEnum()
   private enum RuleSyncRequestEnum {
      ...
      RuleSyncRequestEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * This method packs a RuleSyncRequest object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a RuleSyncRequest message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getRuleSyncRequestSize();
      ...
      RuleSyncRequestEnum.REQUESTOR.setLength(this.getRequestor() != null ? this.getRequestor().length() : 0);

      int directorySize = getRuleSyncRequestDirectorySize();
      if (directorySize != 0) {
         ...
         for (RuleSyncRequestEnum ruleSyncRequestEnum : RuleSyncRequestEnum.values()) {
            if (ruleSyncRequestEnum.isDirectoryEntry == true) {
               int id = ruleSyncRequestEnum.getId();
               int length = ruleSyncRequestEnum.getLength();
               ...
               // Insert the data
               if (id == RuleSyncRequestEnum.REQUESTOR.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a RuleSyncRequest object.
    *
    * @return The byte array as a RuleSyncRequest message object.
    */
   public RuleSyncRequest unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == RuleSyncRequestEnum.REQUESTOR.getId()) {
            ruleSyncRequest.setRequestor(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a RuleSyncRequest object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a RuleSyncRequest message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeRuleSyncRequest initializeRuleSyncRequest = new InitializeRuleSyncRequest(this);
      Element element = initializeRuleSyncRequest.initialize();
    ...
    */
   public RuleSyncRequest unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the RuleSyncRequest object.
       */
       InstantiateRuleSyncRequest instantiateRuleSyncRequest = new InstantiateRuleSyncRequest(element);
       RuleSyncRequest ruleSyncRequest = instantiateRuleSyncRequest.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateRuleSyncRequest.validate();
      if (result != null) {
    ...
    */
   private int getRuleSyncRequestDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the RuleSyncRequest object.
    * @return The size in bytes.
    */
   public int getRuleSyncRequestSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      RuleSyncRequest ruleSyncRequest = (RuleSyncRequest) obj;
      if (!ruleSyncRequest.getRequestor().equals(this.getRequestor())) {
         return false;
      }
