...
public class ErrorMessage {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      ErrorMessageEnum.MSG.setLength(this.getMsg() != null ? this.getMsg().length() : 0);
      ErrorMessageEnum.DETAILS.setLength(this.getDetails() != null ? this.getDetails().length() : 0);
      ErrorMessageEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);
