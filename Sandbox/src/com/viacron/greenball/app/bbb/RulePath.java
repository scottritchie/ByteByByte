...
public class RulePath {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      RulePathEnum.CLASS_NAME.setLength(this.getClassName() != null ? this.getClassName().length() : 0);
      RulePathEnum.XREF_CLASS_NAME.setLength(this.getXrefClassName() != null ? this.getXrefClassName().length() : 0);
      RulePathEnum.ID.setLength(this.getId() != null ? this.getId().length() : 0);
