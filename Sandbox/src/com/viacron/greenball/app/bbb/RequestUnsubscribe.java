...
/**
 * The RequestUnsubscribe class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a RequestUnsubscribe object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a RequestUnsubscribe object.
 */
public class RequestUnsubscribe {
   private static final int ID = GreenballMessagesEnum.REQUEST_UNSUBSCRIBE.getId();

   /**
    * The number of bits required to represent the RequestUnsubscribeEnum IDs.
    * # of attributes: 4
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(RequestUnsubscribe.class);

   // Entered buildClassEnum()
   private enum RequestUnsubscribeEnum {
      ...
      RequestUnsubscribeEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The RequestUnsubscribe no-arg constructor.
    */
   public RequestUnsubscribe() {}

   /**
    * The RequestUnsubscribe constructor.
    ...
    */
   public RequestUnsubscribe(String orgId,
                             String orgName,
                             String userName,
                             String sessionId) {
   ...
   /**
    * This method packs a RequestUnsubscribe object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a RequestUnsubscribe message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getRequestUnsubscribeSize();
      ...
      RequestUnsubscribeEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      RequestUnsubscribeEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      RequestUnsubscribeEnum.USER_NAME.setLength(this.getUserName() != null ? this.getUserName().length() : 0);
      RequestUnsubscribeEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getRequestUnsubscribeDirectorySize();
      if (directorySize != 0) {
         ...
         for (RequestUnsubscribeEnum requestUnsubscribeEnum : RequestUnsubscribeEnum.values()) {
            if (requestUnsubscribeEnum.isDirectoryEntry == true) {
               int id = requestUnsubscribeEnum.getId();
               int length = requestUnsubscribeEnum.getLength();
               ...
               // Insert the data
               if (id == RequestUnsubscribeEnum.ORG_ID.getId()) {
               ...
               else if (id == RequestUnsubscribeEnum.ORG_NAME.getId()) {
               ...
               else if (id == RequestUnsubscribeEnum.USER_NAME.getId()) {
               ...
               else if (id == RequestUnsubscribeEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a RequestUnsubscribe object.
    *
    * @return The byte array as a RequestUnsubscribe message object.
    */
   public RequestUnsubscribe unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == RequestUnsubscribeEnum.ORG_ID.getId()) {
            requestUnsubscribe.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestUnsubscribeEnum.ORG_NAME.getId()) {
            requestUnsubscribe.setOrgName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestUnsubscribeEnum.USER_NAME.getId()) {
            requestUnsubscribe.setUserName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestUnsubscribeEnum.SESSION_ID.getId()) {
            requestUnsubscribe.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a RequestUnsubscribe object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a RequestUnsubscribe message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeRequestUnsubscribe initializeRequestUnsubscribe = new InitializeRequestUnsubscribe(this);
      Element element = initializeRequestUnsubscribe.initialize();
    ...
    */
   public RequestUnsubscribe unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the RequestUnsubscribe object.
       */
       InstantiateRequestUnsubscribe instantiateRequestUnsubscribe = new InstantiateRequestUnsubscribe(element);
       RequestUnsubscribe requestUnsubscribe = instantiateRequestUnsubscribe.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateRequestUnsubscribe.validate();
      if (result != null) {
    ...
    */
   private int getRequestUnsubscribeDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the RequestUnsubscribe object.
    * @return The size in bytes.
    */
   public int getRequestUnsubscribeSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      RequestUnsubscribe requestUnsubscribe = (RequestUnsubscribe) obj;
      if (!requestUnsubscribe.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (!requestUnsubscribe.getOrgName().equals(this.getOrgName())) {
         return false;
      }

      if (!requestUnsubscribe.getUserName().equals(this.getUserName())) {
         return false;
      }

      if (requestUnsubscribe.getSessionId() == null && this.getSessionId() != null) {
         return false;
      }
      else if (requestUnsubscribe.getSessionId() != null && this.getSessionId() == null) {
         return false;
      }
      else if (requestUnsubscribe.getSessionId() != null && 
      !requestUnsubscribe.getSessionId().equals(this.getSessionId())) {
         return false;
      }
