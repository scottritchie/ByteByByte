...
/**
 * The RequestModel class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a RequestModel object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a RequestModel object.
 */
public class RequestModel {
   private static final int ID = GreenballMessagesEnum.REQUEST_MODEL.getId();

   /**
    * The number of bits required to represent the RequestModelEnum IDs.
    * # of attributes: 4
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(RequestModel.class);

   // Entered buildClassEnum()
   private enum RequestModelEnum {
      ...
      RequestModelEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The RequestModel no-arg constructor.
    */
   public RequestModel() {}

   /**
    * The RequestModel constructor.
    ...
    */
   public RequestModel(String user,
                       String orgId,
                       String orgName,
                       String sessionId) {
   ...
   /**
    * This method packs a RequestModel object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a RequestModel message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getRequestModelSize();
      ...
      RequestModelEnum.USER.setLength(this.getUser() != null ? this.getUser().length() : 0);
      RequestModelEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      RequestModelEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      RequestModelEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getRequestModelDirectorySize();
      if (directorySize != 0) {
         ...
         for (RequestModelEnum requestModelEnum : RequestModelEnum.values()) {
            if (requestModelEnum.isDirectoryEntry == true) {
               int id = requestModelEnum.getId();
               int length = requestModelEnum.getLength();
               ...
               // Insert the data
               if (id == RequestModelEnum.USER.getId()) {
               ...
               else if (id == RequestModelEnum.ORG_ID.getId()) {
               ...
               else if (id == RequestModelEnum.ORG_NAME.getId()) {
               ...
               else if (id == RequestModelEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a RequestModel object.
    *
    * @return The byte array as a RequestModel message object.
    */
   public RequestModel unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == RequestModelEnum.USER.getId()) {
            requestModel.setUser(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestModelEnum.ORG_ID.getId()) {
            requestModel.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestModelEnum.ORG_NAME.getId()) {
            requestModel.setOrgName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestModelEnum.SESSION_ID.getId()) {
            requestModel.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a RequestModel object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a RequestModel message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeRequestModel initializeRequestModel = new InitializeRequestModel(this);
      Element element = initializeRequestModel.initialize();
    ...
    */
   public RequestModel unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the RequestModel object.
       */
       InstantiateRequestModel instantiateRequestModel = new InstantiateRequestModel(element);
       RequestModel requestModel = instantiateRequestModel.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateRequestModel.validate();
      if (result != null) {
    ...
    */
   private int getRequestModelDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the RequestModel object.
    * @return The size in bytes.
    */
   public int getRequestModelSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      if (!requestModel.getUser().equals(this.getUser())) {
         return false;
      }

      if (!requestModel.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (!requestModel.getOrgName().equals(this.getOrgName())) {
         return false;
      }

      if (requestModel.getSessionId() == null && this.getSessionId() != null) {
         return false;
      }
      else if (requestModel.getSessionId() != null && this.getSessionId() == null) {
         return false;
      }
      else if (requestModel.getSessionId() != null && 
      !requestModel.getSessionId().equals(this.getSessionId())) {
         return false;
      }
