...
public class ResponseSubscriptionRequest {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      ResponseSubscriptionRequestEnum.EMAIL_ADDRESS.setLength(this.getEmailAddress() != null ? this.getEmailAddress().length() : 0);
      ResponseSubscriptionRequestEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);
