...
/**
 * The OrganizationRequest class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a OrganizationRequest object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a OrganizationRequest object.
 */
public class OrganizationRequest {
   private static final int ID = GreenballMessagesEnum.ORGANIZATION_REQUEST.getId();

   /**
    * The number of bits required to represent the OrganizationRequestEnum IDs.
    * # of attributes: 4
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(OrganizationRequest.class);

   // Entered buildClassEnum()
   private enum OrganizationRequestEnum {
      ...
      OrganizationRequestEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The OrganizationRequest no-arg constructor.
    */
   public OrganizationRequest() {}

   /**
    * The OrganizationRequest constructor.
    ...
    */
   public OrganizationRequest(String user,
                              String orgId,
                              String orgName,
                              String sessionId) {
   ...
   /**
    * This method packs a OrganizationRequest object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a OrganizationRequest message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getOrganizationRequestSize();
      ...
      OrganizationRequestEnum.USER.setLength(this.getUser() != null ? this.getUser().length() : 0);
      OrganizationRequestEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      OrganizationRequestEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      OrganizationRequestEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getOrganizationRequestDirectorySize();
      if (directorySize != 0) {
         ...
         for (OrganizationRequestEnum organizationRequestEnum : OrganizationRequestEnum.values()) {
            if (organizationRequestEnum.isDirectoryEntry == true) {
               int id = organizationRequestEnum.getId();
               int length = organizationRequestEnum.getLength();
               ...
               // Insert the data
               if (id == OrganizationRequestEnum.USER.getId()) {
               ...
               else if (id == OrganizationRequestEnum.ORG_ID.getId()) {
               ...
               else if (id == OrganizationRequestEnum.ORG_NAME.getId()) {
               ...
               else if (id == OrganizationRequestEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a OrganizationRequest object.
    *
    * @return The byte array as a OrganizationRequest message object.
    */
   public OrganizationRequest unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == OrganizationRequestEnum.USER.getId()) {
            organizationRequest.setUser(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == OrganizationRequestEnum.ORG_ID.getId()) {
            organizationRequest.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == OrganizationRequestEnum.ORG_NAME.getId()) {
            organizationRequest.setOrgName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == OrganizationRequestEnum.SESSION_ID.getId()) {
            organizationRequest.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a OrganizationRequest object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a OrganizationRequest message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeOrganizationRequest initializeOrganizationRequest = new InitializeOrganizationRequest(this);
      Element element = initializeOrganizationRequest.initialize();
    ...
    */
   public OrganizationRequest unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the OrganizationRequest object.
       */
       InstantiateOrganizationRequest instantiateOrganizationRequest = new InstantiateOrganizationRequest(element);
       OrganizationRequest organizationRequest = instantiateOrganizationRequest.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateOrganizationRequest.validate();
      if (result != null) {
    ...
    */
   private int getOrganizationRequestDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the OrganizationRequest object.
    * @return The size in bytes.
    */
   public int getOrganizationRequestSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      if (!organizationRequest.getUser().equals(this.getUser())) {
         return false;
      }

      if (!organizationRequest.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (!organizationRequest.getOrgName().equals(this.getOrgName())) {
         return false;
      }

      if (organizationRequest.getSessionId() == null && this.getSessionId() != null) {
         return false;
      }
      else if (organizationRequest.getSessionId() != null && this.getSessionId() == null) {
         return false;
      }
      else if (organizationRequest.getSessionId() != null && 
      !organizationRequest.getSessionId().equals(this.getSessionId())) {
         return false;
      }
