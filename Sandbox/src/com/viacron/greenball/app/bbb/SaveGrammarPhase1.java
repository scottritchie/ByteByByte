...
/**
 * The SaveGrammarPhase1 class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a SaveGrammarPhase1 object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a SaveGrammarPhase1 object.
 */
public class SaveGrammarPhase1 {
   private static final int ID = GreenballMessagesEnum.SAVE_GRAMMAR_PHASE1.getId();

   /**
    * The number of bits required to represent the SaveGrammarPhase1Enum IDs.
    * # of attributes: 5
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(SaveGrammarPhase1.class);

   // Entered buildClassEnum()
   private enum SaveGrammarPhase1Enum {
      ...
      SaveGrammarPhase1Enum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The SaveGrammarPhase1 no-arg constructor.
    */
   public SaveGrammarPhase1() {}

   /**
    * The SaveGrammarPhase1 constructor.
    ...
    */
   public SaveGrammarPhase1(String orgId,
                            String orgName,
                            String userName,
                            String buffer,
                            String sessionId) {
   ...
   /**
    * This method packs a SaveGrammarPhase1 object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a SaveGrammarPhase1 message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getSaveGrammarPhase1Size();
      ...
      SaveGrammarPhase1Enum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      SaveGrammarPhase1Enum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      SaveGrammarPhase1Enum.USER_NAME.setLength(this.getUserName() != null ? this.getUserName().length() : 0);
      SaveGrammarPhase1Enum.BUFFER.setLength(this.getBuffer() != null ? this.getBuffer().length() : 0);
      SaveGrammarPhase1Enum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getSaveGrammarPhase1DirectorySize();
      if (directorySize != 0) {
         ...
         for (SaveGrammarPhase1Enum saveGrammarPhase1Enum : SaveGrammarPhase1Enum.values()) {
            if (saveGrammarPhase1Enum.isDirectoryEntry == true) {
               int id = saveGrammarPhase1Enum.getId();
               int length = saveGrammarPhase1Enum.getLength();
               ...
               // Insert the data
               if (id == SaveGrammarPhase1Enum.ORG_ID.getId()) {
               ...
               else if (id == SaveGrammarPhase1Enum.ORG_NAME.getId()) {
               ...
               else if (id == SaveGrammarPhase1Enum.USER_NAME.getId()) {
               ...
               else if (id == SaveGrammarPhase1Enum.BUFFER.getId()) {
               ...
               else if (id == SaveGrammarPhase1Enum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a SaveGrammarPhase1 object.
    *
    * @return The byte array as a SaveGrammarPhase1 message object.
    */
   public SaveGrammarPhase1 unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == SaveGrammarPhase1Enum.ORG_ID.getId()) {
            saveGrammarPhase1.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == SaveGrammarPhase1Enum.ORG_NAME.getId()) {
            saveGrammarPhase1.setOrgName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == SaveGrammarPhase1Enum.USER_NAME.getId()) {
            saveGrammarPhase1.setUserName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == SaveGrammarPhase1Enum.BUFFER.getId()) {
            saveGrammarPhase1.setBuffer(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == SaveGrammarPhase1Enum.SESSION_ID.getId()) {
            saveGrammarPhase1.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a SaveGrammarPhase1 object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a SaveGrammarPhase1 message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeSaveGrammarPhase1 initializeSaveGrammarPhase1 = new InitializeSaveGrammarPhase1(this);
      Element element = initializeSaveGrammarPhase1.initialize();
    ...
    */
   public SaveGrammarPhase1 unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the SaveGrammarPhase1 object.
       */
       InstantiateSaveGrammarPhase1 instantiateSaveGrammarPhase1 = new InstantiateSaveGrammarPhase1(element);
       SaveGrammarPhase1 saveGrammarPhase1 = instantiateSaveGrammarPhase1.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateSaveGrammarPhase1.validate();
      if (result != null) {
    ...
    */
   private int getSaveGrammarPhase1DirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the SaveGrammarPhase1 object.
    * @return The size in bytes.
    */
   public int getSaveGrammarPhase1Size() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      SaveGrammarPhase1 saveGrammarPhase1 = (SaveGrammarPhase1) obj;
      if (!saveGrammarPhase1.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (!saveGrammarPhase1.getOrgName().equals(this.getOrgName())) {
         return false;
      }

      if (!saveGrammarPhase1.getUserName().equals(this.getUserName())) {
         return false;
      }

      if (!saveGrammarPhase1.getBuffer().equals(this.getBuffer())) {
         return false;
      }

      if (saveGrammarPhase1.getSessionId() == null && this.getSessionId() != null) {
         return false;
      }
      else if (saveGrammarPhase1.getSessionId() != null && this.getSessionId() == null) {
         return false;
      }
      else if (saveGrammarPhase1.getSessionId() != null && 
      !saveGrammarPhase1.getSessionId().equals(this.getSessionId())) {
         return false;
      }
