...
/**
 * The RequestCloseConnection class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a RequestCloseConnection object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a RequestCloseConnection object.
 */
public class RequestCloseConnection {
   private static final int ID = GreenballMessagesEnum.REQUEST_CLOSE_CONNECTION.getId();

   /**
    * The number of bits required to represent the RequestCloseConnectionEnum IDs.
    * # of attributes: 2
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(RequestCloseConnection.class);

   // Entered buildClassEnum()
   private enum RequestCloseConnectionEnum {
      ...
      RequestCloseConnectionEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The RequestCloseConnection no-arg constructor.
    */
   public RequestCloseConnection() {}

   /**
    * The RequestCloseConnection constructor.
    ...
    */
   public RequestCloseConnection(String user,
                                 String sessionId) {
   ...
   /**
    * This method packs a RequestCloseConnection object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a RequestCloseConnection message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getRequestCloseConnectionSize();
      ...
      RequestCloseConnectionEnum.USER.setLength(this.getUser() != null ? this.getUser().length() : 0);
      RequestCloseConnectionEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getRequestCloseConnectionDirectorySize();
      if (directorySize != 0) {
         ...
         for (RequestCloseConnectionEnum requestCloseConnectionEnum : RequestCloseConnectionEnum.values()) {
            if (requestCloseConnectionEnum.isDirectoryEntry == true) {
               int id = requestCloseConnectionEnum.getId();
               int length = requestCloseConnectionEnum.getLength();
               ...
               // Insert the data
               if (id == RequestCloseConnectionEnum.USER.getId()) {
               ...
               else if (id == RequestCloseConnectionEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a RequestCloseConnection object.
    *
    * @return The byte array as a RequestCloseConnection message object.
    */
   public RequestCloseConnection unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == RequestCloseConnectionEnum.USER.getId()) {
            requestCloseConnection.setUser(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestCloseConnectionEnum.SESSION_ID.getId()) {
            requestCloseConnection.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a RequestCloseConnection object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a RequestCloseConnection message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeRequestCloseConnection initializeRequestCloseConnection = new InitializeRequestCloseConnection(this);
      Element element = initializeRequestCloseConnection.initialize();
    ...
    */
   public RequestCloseConnection unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the RequestCloseConnection object.
       */
       InstantiateRequestCloseConnection instantiateRequestCloseConnection = new InstantiateRequestCloseConnection(element);
       RequestCloseConnection requestCloseConnection = instantiateRequestCloseConnection.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateRequestCloseConnection.validate();
      if (result != null) {
    ...
    */
   private int getRequestCloseConnectionDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the RequestCloseConnection object.
    * @return The size in bytes.
    */
   public int getRequestCloseConnectionSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      RequestCloseConnection requestCloseConnection = (RequestCloseConnection) obj;
      if (!requestCloseConnection.getUser().equals(this.getUser())) {
         return false;
      }

      if (!requestCloseConnection.getSessionId().equals(this.getSessionId())) {
         return false;
      }
