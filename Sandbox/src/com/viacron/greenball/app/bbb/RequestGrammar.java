...
/**
 * The RequestGrammar class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a RequestGrammar object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a RequestGrammar object.
 */
public class RequestGrammar {
   private static final int ID = GreenballMessagesEnum.REQUEST_GRAMMAR.getId();

   /**
    * The number of bits required to represent the RequestGrammarEnum IDs.
    * # of attributes: 5
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(RequestGrammar.class);

   // Entered buildClassEnum()
   private enum RequestGrammarEnum {
      ...
      RequestGrammarEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The RequestGrammar no-arg constructor.
    */
   public RequestGrammar() {}

   /**
    * The RequestGrammar constructor.
    ...
    */
   public RequestGrammar(String orgId,
                         String orgName,
                         String userName,
                         String template,
                         String sessionId) {
   ...
   /**
    * This method packs a RequestGrammar object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a RequestGrammar message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getRequestGrammarSize();
      ...
      RequestGrammarEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      RequestGrammarEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      RequestGrammarEnum.USER_NAME.setLength(this.getUserName() != null ? this.getUserName().length() : 0);
      RequestGrammarEnum.TEMPLATE.setLength(this.getTemplate() != null ? this.getTemplate().length() : 0);
      RequestGrammarEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getRequestGrammarDirectorySize();
      if (directorySize != 0) {
         ...
         for (RequestGrammarEnum requestGrammarEnum : RequestGrammarEnum.values()) {
            if (requestGrammarEnum.isDirectoryEntry == true) {
               int id = requestGrammarEnum.getId();
               int length = requestGrammarEnum.getLength();
               ...
               // Insert the data
               if (id == RequestGrammarEnum.ORG_ID.getId()) {
               ...
               else if (id == RequestGrammarEnum.ORG_NAME.getId()) {
               ...
               else if (id == RequestGrammarEnum.USER_NAME.getId()) {
               ...
               else if (id == RequestGrammarEnum.TEMPLATE.getId()) {
               ...
               else if (id == RequestGrammarEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a RequestGrammar object.
    *
    * @return The byte array as a RequestGrammar message object.
    */
   public RequestGrammar unpack(byte[] ba) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);

      RequestGrammar requestGrammar = new RequestGrammar();
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == RequestGrammarEnum.ORG_ID.getId()) {
            requestGrammar.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestGrammarEnum.ORG_NAME.getId()) {
            requestGrammar.setOrgName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestGrammarEnum.USER_NAME.getId()) {
            requestGrammar.setUserName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestGrammarEnum.TEMPLATE.getId()) {
            requestGrammar.setTemplate(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestGrammarEnum.SESSION_ID.getId()) {
            requestGrammar.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a RequestGrammar object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a RequestGrammar message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeRequestGrammar initializeRequestGrammar = new InitializeRequestGrammar(this);
      Element element = initializeRequestGrammar.initialize();
    ...
    */
   public RequestGrammar unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the RequestGrammar object.
       */
       InstantiateRequestGrammar instantiateRequestGrammar = new InstantiateRequestGrammar(element);
       RequestGrammar requestGrammar = instantiateRequestGrammar.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateRequestGrammar.validate();
      if (result != null) {
    ...
    */
   private int getRequestGrammarDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the RequestGrammar object.
    * @return The size in bytes.
    */
   public int getRequestGrammarSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      RequestGrammar requestGrammar = (RequestGrammar) obj;
      if (!requestGrammar.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (!requestGrammar.getOrgName().equals(this.getOrgName())) {
         return false;
      }

      if (!requestGrammar.getUserName().equals(this.getUserName())) {
         return false;
      }

      if (requestGrammar.getTemplate() == null && this.getTemplate() != null) {
         return false;
      }
      else if (requestGrammar.getTemplate() != null && this.getTemplate() == null) {
         return false;
      }
      else if (requestGrammar.getTemplate() != null && 
      !requestGrammar.getTemplate().equals(this.getTemplate())) {
         return false;
      }

      if (requestGrammar.getSessionId() == null && this.getSessionId() != null) {
         return false;
      }
      else if (requestGrammar.getSessionId() != null && this.getSessionId() == null) {
         return false;
      }
      else if (requestGrammar.getSessionId() != null && 
      !requestGrammar.getSessionId().equals(this.getSessionId())) {
         return false;
      }
