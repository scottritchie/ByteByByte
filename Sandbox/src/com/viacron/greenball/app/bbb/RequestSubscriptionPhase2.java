...
/**
 * The RequestSubscriptionPhase2 class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a RequestSubscriptionPhase2 object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a RequestSubscriptionPhase2 object.
 */
public class RequestSubscriptionPhase2 {
   private static final int ID = GreenballMessagesEnum.REQUEST_SUBSCRIPTION_PHASE2.getId();

   /**
    * The number of bits required to represent the RequestSubscriptionPhase2Enum IDs.
    * # of attributes: 5
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(RequestSubscriptionPhase2.class);

   // Entered buildClassEnum()
   private enum RequestSubscriptionPhase2Enum {
      ...
      RequestSubscriptionPhase2Enum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The RequestSubscriptionPhase2 no-arg constructor.
    */
   public RequestSubscriptionPhase2() {}

   /**
    * The RequestSubscriptionPhase2 constructor.
    ...
    */
   public RequestSubscriptionPhase2(String requestor,
                                    String message,
                                    String orgId,
                                    String orgName,
                                    String sessionId) {
   ...
   /**
    * This method packs a RequestSubscriptionPhase2 object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a RequestSubscriptionPhase2 message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getRequestSubscriptionPhase2Size();
      ...
      RequestSubscriptionPhase2Enum.REQUESTOR.setLength(this.getRequestor() != null ? this.getRequestor().length() : 0);
      RequestSubscriptionPhase2Enum.MESSAGE.setLength(this.getMessage() != null ? this.getMessage().length() : 0);
      RequestSubscriptionPhase2Enum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      RequestSubscriptionPhase2Enum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      RequestSubscriptionPhase2Enum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getRequestSubscriptionPhase2DirectorySize();
      if (directorySize != 0) {
         ...
         for (RequestSubscriptionPhase2Enum requestSubscriptionPhase2Enum : RequestSubscriptionPhase2Enum.values()) {
            if (requestSubscriptionPhase2Enum.isDirectoryEntry == true) {
               int id = requestSubscriptionPhase2Enum.getId();
               int length = requestSubscriptionPhase2Enum.getLength();
               ...
               // Insert the data
               if (id == RequestSubscriptionPhase2Enum.REQUESTOR.getId()) {
               ...
               else if (id == RequestSubscriptionPhase2Enum.MESSAGE.getId()) {
               ...
               else if (id == RequestSubscriptionPhase2Enum.ORG_ID.getId()) {
               ...
               else if (id == RequestSubscriptionPhase2Enum.ORG_NAME.getId()) {
               ...
               else if (id == RequestSubscriptionPhase2Enum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a RequestSubscriptionPhase2 object.
    *
    * @return The byte array as a RequestSubscriptionPhase2 message object.
    */
   public RequestSubscriptionPhase2 unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == RequestSubscriptionPhase2Enum.REQUESTOR.getId()) {
            requestSubscriptionPhase2.setRequestor(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestSubscriptionPhase2Enum.MESSAGE.getId()) {
            requestSubscriptionPhase2.setMessage(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestSubscriptionPhase2Enum.ORG_ID.getId()) {
            requestSubscriptionPhase2.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestSubscriptionPhase2Enum.ORG_NAME.getId()) {
            requestSubscriptionPhase2.setOrgName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestSubscriptionPhase2Enum.SESSION_ID.getId()) {
            requestSubscriptionPhase2.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a RequestSubscriptionPhase2 object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a RequestSubscriptionPhase2 message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeRequestSubscriptionPhase2 initializeRequestSubscriptionPhase2 = new InitializeRequestSubscriptionPhase2(this);
      Element element = initializeRequestSubscriptionPhase2.initialize();
    ...
    */
   public RequestSubscriptionPhase2 unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the RequestSubscriptionPhase2 object.
       */
       InstantiateRequestSubscriptionPhase2 instantiateRequestSubscriptionPhase2 = new InstantiateRequestSubscriptionPhase2(element);
       RequestSubscriptionPhase2 requestSubscriptionPhase2 = instantiateRequestSubscriptionPhase2.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateRequestSubscriptionPhase2.validate();
      if (result != null) {
    ...
    */
   private int getRequestSubscriptionPhase2DirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the RequestSubscriptionPhase2 object.
    * @return The size in bytes.
    */
   public int getRequestSubscriptionPhase2Size() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      RequestSubscriptionPhase2 requestSubscriptionPhase2 = (RequestSubscriptionPhase2) obj;
      if (!requestSubscriptionPhase2.getRequestor().equals(this.getRequestor())) {
         return false;
      }

      if (requestSubscriptionPhase2.getMessage() == null && this.getMessage() != null) {
         return false;
      }
      else if (requestSubscriptionPhase2.getMessage() != null && this.getMessage() == null) {
         return false;
      }
      else if (requestSubscriptionPhase2.getMessage() != null && 
      !requestSubscriptionPhase2.getMessage().equals(this.getMessage())) {
         return false;
      }

      if (!requestSubscriptionPhase2.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (!requestSubscriptionPhase2.getOrgName().equals(this.getOrgName())) {
         return false;
      }

      if (!requestSubscriptionPhase2.getSessionId().equals(this.getSessionId())) {
         return false;
      }
