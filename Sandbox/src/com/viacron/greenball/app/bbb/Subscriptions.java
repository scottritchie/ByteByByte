...
/**
 * The Subscriptions class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a Subscriptions object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a Subscriptions object.
 */
public class Subscriptions {
   private static final int ID = GreenballMessagesEnum.SUBSCRIPTIONS.getId();

   /**
    * The number of bits required to represent the SubscriptionsEnum IDs.
    * # of attributes: 2
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(Subscriptions.class);
   ...
   private enum SubscriptionsEnum {
      ...
      SubscriptionsEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The Subscriptions no-arg constructor.
    */
   public Subscriptions() {}

   /**
    * The Subscriptions constructor.
   ...
   /**
    * This method packs a Subscriptions object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a Subscriptions message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getSubscriptionsSize();
      ...
      SubscriptionsEnum.USER_NAME.setLength(this.getUserName() != null ? this.getUserName().length() : 0);
      SubscriptionsEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getSubscriptionsDirectorySize();
      if (directorySize != 0) {
         ...
         for (SubscriptionsEnum subscriptionsEnum : SubscriptionsEnum.values()) {
            if (subscriptionsEnum.isDirectoryEntry == true) {
               int id = subscriptionsEnum.getId();
               int length = subscriptionsEnum.getLength();
               ...
               // Insert the data
               if (id == SubscriptionsEnum.USER_NAME.getId()) {
               ...
               else if (id == SubscriptionsEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a Subscriptions object.
    *
    * @return The byte array as a Subscriptions message object.
    */
   public Subscriptions unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == SubscriptionsEnum.USER_NAME.getId()) {
            subscriptions.setUserName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == SubscriptionsEnum.SESSION_ID.getId()) {
            subscriptions.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a Subscriptions object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a Subscriptions message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeSubscriptions initializeSubscriptions = new InitializeSubscriptions(this);
      Element element = initializeSubscriptions.initialize();
    ...
    */
   public Subscriptions unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the Subscriptions object.
       */
       InstantiateSubscriptions instantiateSubscriptions = new InstantiateSubscriptions(element);
       Subscriptions subscriptions = instantiateSubscriptions.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateSubscriptions.validate();
      if (result != null) {
    ...
    */
   private int getSubscriptionsDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the Subscriptions object.
   ...
   public boolean equals(Object obj) {
      ...
      if (!subscriptions.getUserName().equals(this.getUserName())) {
         return false;
      }

      if (!subscriptions.getSessionId().equals(this.getSessionId())) {
         return false;
      }
