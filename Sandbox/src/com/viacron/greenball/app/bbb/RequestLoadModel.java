...
/**
 * The RequestLoadModel class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a RequestLoadModel object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a RequestLoadModel object.
 */
public class RequestLoadModel {
   private static final int ID = GreenballMessagesEnum.REQUEST_LOAD_MODEL.getId();

   /**
    * The number of bits required to represent the RequestLoadModelEnum IDs.
    * # of attributes: 3
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(RequestLoadModel.class);

   // Entered buildClassEnum()
   private enum RequestLoadModelEnum {
      ...
      RequestLoadModelEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The RequestLoadModel no-arg constructor.
    */
   public RequestLoadModel() {}

   /**
    * The RequestLoadModel constructor.
    ...
    */
   public RequestLoadModel(String orgId,
                           String orgName,
                           String sessionId) {
   ...
   /**
    * This method packs a RequestLoadModel object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a RequestLoadModel message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getRequestLoadModelSize();
      ...
      RequestLoadModelEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      RequestLoadModelEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      RequestLoadModelEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getRequestLoadModelDirectorySize();
      if (directorySize != 0) {
         ...
         for (RequestLoadModelEnum requestLoadModelEnum : RequestLoadModelEnum.values()) {
            if (requestLoadModelEnum.isDirectoryEntry == true) {
               int id = requestLoadModelEnum.getId();
               int length = requestLoadModelEnum.getLength();
               ...
               // Insert the data
               if (id == RequestLoadModelEnum.ORG_ID.getId()) {
               ...
               else if (id == RequestLoadModelEnum.ORG_NAME.getId()) {
               ...
               else if (id == RequestLoadModelEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a RequestLoadModel object.
    *
    * @return The byte array as a RequestLoadModel message object.
    */
   public RequestLoadModel unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == RequestLoadModelEnum.ORG_ID.getId()) {
            requestLoadModel.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestLoadModelEnum.ORG_NAME.getId()) {
            requestLoadModel.setOrgName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestLoadModelEnum.SESSION_ID.getId()) {
            requestLoadModel.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a RequestLoadModel object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a RequestLoadModel message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeRequestLoadModel initializeRequestLoadModel = new InitializeRequestLoadModel(this);
      Element element = initializeRequestLoadModel.initialize();
    ...
    */
   public RequestLoadModel unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the RequestLoadModel object.
       */
       InstantiateRequestLoadModel instantiateRequestLoadModel = new InstantiateRequestLoadModel(element);
       RequestLoadModel requestLoadModel = instantiateRequestLoadModel.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateRequestLoadModel.validate();
      if (result != null) {
    ...
    */
   private int getRequestLoadModelDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the RequestLoadModel object.
    * @return The size in bytes.
    */
   public int getRequestLoadModelSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      RequestLoadModel requestLoadModel = (RequestLoadModel) obj;
      if (!requestLoadModel.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (!requestLoadModel.getOrgName().equals(this.getOrgName())) {
         return false;
      }

      if (!requestLoadModel.getSessionId().equals(this.getSessionId())) {
         return false;
      }
