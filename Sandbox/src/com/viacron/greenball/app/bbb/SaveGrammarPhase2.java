...
/**
 * The SaveGrammarPhase2 class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a SaveGrammarPhase2 object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a SaveGrammarPhase2 object.
 */
public class SaveGrammarPhase2 {
   private static final int ID = GreenballMessagesEnum.SAVE_GRAMMAR_PHASE2.getId();

   /**
    * The number of bits required to represent the SaveGrammarPhase2Enum IDs.
    * # of attributes: 5
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(SaveGrammarPhase2.class);

   // Entered buildClassEnum()
   private enum SaveGrammarPhase2Enum {
      ...
      SaveGrammarPhase2Enum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The SaveGrammarPhase2 no-arg constructor.
    */
   public SaveGrammarPhase2() {}

   /**
    * The SaveGrammarPhase2 constructor.
    ...
    */
   public SaveGrammarPhase2(String orgId,
                            String orgName,
                            String userName,
                            String buffer,
                            String sessionId) {
   ...
   /**
    * This method packs a SaveGrammarPhase2 object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a SaveGrammarPhase2 message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getSaveGrammarPhase2Size();
      ...
      SaveGrammarPhase2Enum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      SaveGrammarPhase2Enum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      SaveGrammarPhase2Enum.USER_NAME.setLength(this.getUserName() != null ? this.getUserName().length() : 0);
      SaveGrammarPhase2Enum.BUFFER.setLength(this.getBuffer() != null ? this.getBuffer().length() : 0);
      SaveGrammarPhase2Enum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getSaveGrammarPhase2DirectorySize();
      if (directorySize != 0) {
         ...
         for (SaveGrammarPhase2Enum saveGrammarPhase2Enum : SaveGrammarPhase2Enum.values()) {
            if (saveGrammarPhase2Enum.isDirectoryEntry == true) {
               int id = saveGrammarPhase2Enum.getId();
               int length = saveGrammarPhase2Enum.getLength();
               ...
               // Insert the data
               if (id == SaveGrammarPhase2Enum.ORG_ID.getId()) {
               ...
               else if (id == SaveGrammarPhase2Enum.ORG_NAME.getId()) {
               ...
               else if (id == SaveGrammarPhase2Enum.USER_NAME.getId()) {
               ...
               else if (id == SaveGrammarPhase2Enum.BUFFER.getId()) {
               ...
               else if (id == SaveGrammarPhase2Enum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a SaveGrammarPhase2 object.
    *
    * @return The byte array as a SaveGrammarPhase2 message object.
    */
   public SaveGrammarPhase2 unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == SaveGrammarPhase2Enum.ORG_ID.getId()) {
            saveGrammarPhase2.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == SaveGrammarPhase2Enum.ORG_NAME.getId()) {
            saveGrammarPhase2.setOrgName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == SaveGrammarPhase2Enum.USER_NAME.getId()) {
            saveGrammarPhase2.setUserName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == SaveGrammarPhase2Enum.BUFFER.getId()) {
            saveGrammarPhase2.setBuffer(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == SaveGrammarPhase2Enum.SESSION_ID.getId()) {
            saveGrammarPhase2.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a SaveGrammarPhase2 object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a SaveGrammarPhase2 message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeSaveGrammarPhase2 initializeSaveGrammarPhase2 = new InitializeSaveGrammarPhase2(this);
      Element element = initializeSaveGrammarPhase2.initialize();
    ...
    */
   public SaveGrammarPhase2 unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the SaveGrammarPhase2 object.
       */
       InstantiateSaveGrammarPhase2 instantiateSaveGrammarPhase2 = new InstantiateSaveGrammarPhase2(element);
       SaveGrammarPhase2 saveGrammarPhase2 = instantiateSaveGrammarPhase2.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateSaveGrammarPhase2.validate();
      if (result != null) {
    ...
    */
   private int getSaveGrammarPhase2DirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the SaveGrammarPhase2 object.
    * @return The size in bytes.
    */
   public int getSaveGrammarPhase2Size() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      SaveGrammarPhase2 saveGrammarPhase2 = (SaveGrammarPhase2) obj;
      if (!saveGrammarPhase2.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (!saveGrammarPhase2.getOrgName().equals(this.getOrgName())) {
         return false;
      }

      if (!saveGrammarPhase2.getUserName().equals(this.getUserName())) {
         return false;
      }

      if (!saveGrammarPhase2.getBuffer().equals(this.getBuffer())) {
         return false;
      }

      if (saveGrammarPhase2.getSessionId() == null && this.getSessionId() != null) {
         return false;
      }
      else if (saveGrammarPhase2.getSessionId() != null && this.getSessionId() == null) {
         return false;
      }
      else if (saveGrammarPhase2.getSessionId() != null && 
      !saveGrammarPhase2.getSessionId().equals(this.getSessionId())) {
         return false;
      }
