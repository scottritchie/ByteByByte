...
/**
 * The ResponseUnsubscribe class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a ResponseUnsubscribe object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a ResponseUnsubscribe object.
 */
public class ResponseUnsubscribe {
   private static final int ID = GreenballMessagesEnum.RESPONSE_UNSUBSCRIBE.getId();

   /**
    * The number of bits required to represent the ResponseUnsubscribeEnum IDs.
    * # of attributes: 4
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(ResponseUnsubscribe.class);

   // Entered buildClassEnum()
   private enum ResponseUnsubscribeEnum {
      ...
      ResponseUnsubscribeEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The ResponseUnsubscribe no-arg constructor.
    */
   public ResponseUnsubscribe() {}

   /**
    * The ResponseUnsubscribe constructor.
    ...
    */
   public ResponseUnsubscribe(String orgId,
                              String orgName,
                              String userName,
                              String sessionId) {
   ...
   /**
    * This method packs a ResponseUnsubscribe object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a ResponseUnsubscribe message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getResponseUnsubscribeSize();
      ...
      ResponseUnsubscribeEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      ResponseUnsubscribeEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      ResponseUnsubscribeEnum.USER_NAME.setLength(this.getUserName() != null ? this.getUserName().length() : 0);
      ResponseUnsubscribeEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getResponseUnsubscribeDirectorySize();
      if (directorySize != 0) {
         ...
         for (ResponseUnsubscribeEnum responseUnsubscribeEnum : ResponseUnsubscribeEnum.values()) {
            if (responseUnsubscribeEnum.isDirectoryEntry == true) {
               int id = responseUnsubscribeEnum.getId();
               int length = responseUnsubscribeEnum.getLength();
               ...
               // Insert the data
               if (id == ResponseUnsubscribeEnum.ORG_ID.getId()) {
               ...
               else if (id == ResponseUnsubscribeEnum.ORG_NAME.getId()) {
               ...
               else if (id == ResponseUnsubscribeEnum.USER_NAME.getId()) {
               ...
               else if (id == ResponseUnsubscribeEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a ResponseUnsubscribe object.
    *
    * @return The byte array as a ResponseUnsubscribe message object.
    */
   public ResponseUnsubscribe unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == ResponseUnsubscribeEnum.ORG_ID.getId()) {
            responseUnsubscribe.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ResponseUnsubscribeEnum.ORG_NAME.getId()) {
            responseUnsubscribe.setOrgName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ResponseUnsubscribeEnum.USER_NAME.getId()) {
            responseUnsubscribe.setUserName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ResponseUnsubscribeEnum.SESSION_ID.getId()) {
            responseUnsubscribe.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a ResponseUnsubscribe object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a ResponseUnsubscribe message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeResponseUnsubscribe initializeResponseUnsubscribe = new InitializeResponseUnsubscribe(this);
      Element element = initializeResponseUnsubscribe.initialize();
    ...
    */
   public ResponseUnsubscribe unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the ResponseUnsubscribe object.
       */
       InstantiateResponseUnsubscribe instantiateResponseUnsubscribe = new InstantiateResponseUnsubscribe(element);
       ResponseUnsubscribe responseUnsubscribe = instantiateResponseUnsubscribe.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateResponseUnsubscribe.validate();
      if (result != null) {
    ...
    */
   private int getResponseUnsubscribeDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the ResponseUnsubscribe object.
    * @return The size in bytes.
    */
   public int getResponseUnsubscribeSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      ResponseUnsubscribe responseUnsubscribe = (ResponseUnsubscribe) obj;
      if (!responseUnsubscribe.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (!responseUnsubscribe.getOrgName().equals(this.getOrgName())) {
         return false;
      }

      if (!responseUnsubscribe.getUserName().equals(this.getUserName())) {
         return false;
      }

      if (!responseUnsubscribe.getSessionId().equals(this.getSessionId())) {
         return false;
      }
