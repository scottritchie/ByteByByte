...
/**
 * The InitializeDeleteRulePhase2Message class initializes the element object with the DeleteRulePhase2Message object.
 *
 */
public class InitializeDeleteRulePhase2Message {
   private static Logger log4j = Logger.getLogger(InitializeDeleteRulePhase2Message.class);
    ...
    * The InitializeDeleteRulePhase2Message class initializes the element object with the DeleteRulePhase2Message object.
    *
    * @param deleteRulePhase2Message The object which will be used to initialize the element object.
    */
   public InitializeDeleteRulePhase2Message(DeleteRulePhase2Message deleteRulePhase2Message) {
      this.deleteRulePhase2Message = deleteRulePhase2Message;

      this.element = new Element("DeleteRulePhase2Message");
   }
   ...
   public Element initialize() throws MissingAttributeException {
      ...
      log4j.debug("element.getName(): DeleteRulePhase2Message");

      if (deleteRulePhase2Message.getOrgId() != null) {
         AbstractAttribute abstractAttribute = initializeOrgId(deleteRulePhase2Message.getOrgId());
      ...
      if (deleteRulePhase2Message.getOrgName() != null) {
         AbstractAttribute abstractAttribute = initializeOrgName(deleteRulePhase2Message.getOrgName());
         element.getAbstractAttributes().add(abstractAttribute);
      }
      else {
         // Missing required attribute, generate an error message and throw an exception
      ...
      if (deleteRulePhase2Message.getModelName() != null) {
         AbstractAttribute abstractAttribute = initializeModelName(deleteRulePhase2Message.getModelName());
         element.getAbstractAttributes().add(abstractAttribute);
      }
      else {
         // Missing required attribute, generate an error message and throw an exception
      ...
      if (deleteRulePhase2Message.getRule() != null) {
         AbstractAttribute abstractAttribute = initializeRule(deleteRulePhase2Message.getRule());
         element.getAbstractAttributes().add(abstractAttribute);
      }
      else {
         // Missing required attribute, generate an error message and throw an exception
      ...
      if (deleteRulePhase2Message.getUserName() != null) {
         AbstractAttribute abstractAttribute = initializeUserName(deleteRulePhase2Message.getUserName());
         element.getAbstractAttributes().add(abstractAttribute);
      }
      else {
         // Missing required attribute, generate an error message and throw an exception
      ...
      if (deleteRulePhase2Message.getSessionId() != null) {
         AbstractAttribute abstractAttribute = initializeSessionId(deleteRulePhase2Message.getSessionId());
         element.getAbstractAttributes().add(abstractAttribute);
      }
