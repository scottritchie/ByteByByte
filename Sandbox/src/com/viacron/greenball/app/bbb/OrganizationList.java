...
/**
 * The OrganizationList class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a OrganizationList object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a OrganizationList object.
 */
public class OrganizationList {
   private static final int ID = GreenballMessagesEnum.ORGANIZATION_LIST.getId();

   /**
    * The number of bits required to represent the OrganizationListEnum IDs.
    * # of attributes: 2
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(OrganizationList.class);

   // Entered buildClassEnum()
   private enum OrganizationListEnum {
      ...
      OrganizationListEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The OrganizationList no-arg constructor.
    */
   public OrganizationList() {}

   /**
    * The OrganizationList constructor.
    ...
    */
   public OrganizationList(List<OrganizationSubType> organizations,
                           String sessionId) {
   ...
   /**
    * This method packs a OrganizationList object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a OrganizationList message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getOrganizationListSize();
      ...
      OrganizationListEnum.ORGANIZATIONS.setLength(this.getOrganizations().size());
      OrganizationListEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getOrganizationListDirectorySize();
      if (directorySize != 0) {
         ...
         for (OrganizationListEnum organizationListEnum : OrganizationListEnum.values()) {
            if (organizationListEnum.isDirectoryEntry == true) {
               int id = organizationListEnum.getId();
               int length = organizationListEnum.getLength();
               ...
               // Insert the data
               if (id == OrganizationListEnum.ORGANIZATIONS.getId()) {
               ...
               else if (id == OrganizationListEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a OrganizationList object.
    *
    * @return The byte array as a OrganizationList message object.
    */
   public OrganizationList unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == OrganizationListEnum.SESSION_ID.getId()) {
            organizationList.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == OrganizationListEnum.ORGANIZATIONS.getId()) {
            byte[] bytes = new byte[length];
            for (int index = 0; index < length; index++) {
               bytes[index] = GreenballMessagesUtility.getByte(ba, (offset + index) * 8);
            }
            organizationList.getOrganizations().add(new OrganizationSubType().unpack(bytes));
         }
      }
   ...
   /**
    * This method packs a OrganizationList object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a OrganizationList message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeOrganizationList initializeOrganizationList = new InitializeOrganizationList(this);
      Element element = initializeOrganizationList.initialize();
    ...
    */
   public OrganizationList unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the OrganizationList object.
       */
       InstantiateOrganizationList instantiateOrganizationList = new InstantiateOrganizationList(element);
       OrganizationList organizationList = instantiateOrganizationList.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateOrganizationList.validate();
      if (result != null) {
    ...
    */
   private int getOrganizationListDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the OrganizationList object.
   ...
   public boolean equals(Object obj) {
      ...
      if (!organizationList.getSessionId().equals(this.getSessionId())) {
         return false;
      }
