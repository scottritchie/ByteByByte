...
public class MetaModelLockRequest {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      MetaModelLockRequestEnum.USER.setLength(this.getUser() != null ? this.getUser().length() : 0);
      MetaModelLockRequestEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      MetaModelLockRequestEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      MetaModelLockRequestEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);
