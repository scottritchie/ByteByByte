...
/**
 * The ModelElement class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a ModelElement object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a ModelElement object.
 */
public class ModelElement {
   private static final int ID = GreenballMessagesEnum.MODEL_ELEMENT.getId();

   /**
    * The number of bits required to represent the ModelElementEnum IDs.
    * # of attributes: 6
    * # of PEnumRefs: 1
    */
   ...
   private static Logger log4j = Logger.getLogger(ModelElement.class);

   // Entered buildClassEnum()
   private enum ModelElementEnum {
      ...
      ModelElementEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   private ModelElementAction action;


   private String theErrorMsg;

   /**
    * The ModelElement no-arg constructor.
    */
   public ModelElement() {}

   /**
    * The ModelElement constructor.
    ...
    * @param action The ModelElementAction message attribute.
    */
   public ModelElement(String orgId,
                       String orgName,
                       String id,
                       String path,
                       String value,
                       String sessionId, ModelElementAction action) {
   ...
   /**
    * This method packs a ModelElement object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a ModelElement message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getModelElementSize();
      ...
      ModelElementEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      ModelElementEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      ModelElementEnum.ID.setLength(this.getId() != null ? this.getId().length() : 0);
      ModelElementEnum.PATH.setLength(this.getPath() != null ? this.getPath().length() : 0);
      ModelElementEnum.VALUE.setLength(this.getValue() != null ? this.getValue().length() : 0);
      ModelElementEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getModelElementDirectorySize();
      if (directorySize != 0) {
         ...
         for (ModelElementEnum modelElementEnum : ModelElementEnum.values()) {
            if (modelElementEnum.isDirectoryEntry == true) {
               int id = modelElementEnum.getId();
               int length = modelElementEnum.getLength();
               ...
               // Insert the data
               if (id == ModelElementEnum.ORG_ID.getId()) {
               ...
               else if (id == ModelElementEnum.ORG_NAME.getId()) {
               ...
               else if (id == ModelElementEnum.ID.getId()) {
               ...
               else if (id == ModelElementEnum.PATH.getId()) {
               ...
               else if (id == ModelElementEnum.VALUE.getId()) {
               ...
               else if (id == ModelElementEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a ModelElement object.
    *
    * @return The byte array as a ModelElement message object.
    */
   public ModelElement unpack(byte[] ba) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);

      ModelElement modelElement = new ModelElement();

      modelElement.setAction(ModelElementAction.toEnum(GreenballMessagesUtility.getByte(ba, ModelElementEnum.ACTION.getOffsetInBits())));
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == ModelElementEnum.ORG_ID.getId()) {
            modelElement.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ModelElementEnum.ORG_NAME.getId()) {
            modelElement.setOrgName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ModelElementEnum.ID.getId()) {
            modelElement.setId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ModelElementEnum.PATH.getId()) {
            modelElement.setPath(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ModelElementEnum.VALUE.getId()) {
            modelElement.setValue(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ModelElementEnum.SESSION_ID.getId()) {
            modelElement.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a ModelElement object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a ModelElement message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeModelElement initializeModelElement = new InitializeModelElement(this);
      Element element = initializeModelElement.initialize();
    ...
    */
   public ModelElement unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the ModelElement object.
       */
       InstantiateModelElement instantiateModelElement = new InstantiateModelElement(element);
       ModelElement modelElement = instantiateModelElement.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateModelElement.validate();
      if (result != null) {
    ...
    */
   public void setAction(ModelElementAction action) {
      this.action = action;
   }
    ...
    */
   public ModelElementAction getAction() {
      return this.action;
   }
    ...
    */
   private int getModelElementDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the ModelElement object.
    * @return The size in bytes.
    */
   public int getModelElementSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      if (!modelElement.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (!modelElement.getOrgName().equals(this.getOrgName())) {
         return false;
      }

      if (!modelElement.getId().equals(this.getId())) {
         return false;
      }

      if (!modelElement.getPath().equals(this.getPath())) {
         return false;
      }

      if (!modelElement.getValue().equals(this.getValue())) {
         return false;
      }

      if (modelElement.getSessionId() == null && this.getSessionId() != null) {
         return false;
      }
      else if (modelElement.getSessionId() != null && this.getSessionId() == null) {
         return false;
      }
      else if (modelElement.getSessionId() != null && 
      !modelElement.getSessionId().equals(this.getSessionId())) {
         return false;
      }

      if (modelElement.getAction() != this.getAction()) {
         return false;
      }
