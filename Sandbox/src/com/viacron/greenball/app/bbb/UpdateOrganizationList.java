...
/**
 * The UpdateOrganizationList class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a UpdateOrganizationList object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a UpdateOrganizationList object.
 */
public class UpdateOrganizationList {
   private static final int ID = GreenballMessagesEnum.UPDATE_ORGANIZATION_LIST.getId();

   /**
    * The number of bits required to represent the UpdateOrganizationListEnum IDs.
    * # of attributes: 2
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(UpdateOrganizationList.class);

   // Entered buildClassEnum()
   private enum UpdateOrganizationListEnum {
      ...
      UpdateOrganizationListEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The UpdateOrganizationList no-arg constructor.
    */
   public UpdateOrganizationList() {}

   /**
    * The UpdateOrganizationList constructor.
    ...
    */
   public UpdateOrganizationList(OrganizationSubType organization,
                                 String sessionId) {
   ...
   /**
    * This method packs a UpdateOrganizationList object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a UpdateOrganizationList message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getUpdateOrganizationListSize();
      ...
      UpdateOrganizationListEnum.ORGANIZATION.setLength(this.getOrganization().getOrganizationSubTypeSize());
      UpdateOrganizationListEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getUpdateOrganizationListDirectorySize();
      if (directorySize != 0) {
         ...
         for (UpdateOrganizationListEnum updateOrganizationListEnum : UpdateOrganizationListEnum.values()) {
            if (updateOrganizationListEnum.isDirectoryEntry == true) {
               int id = updateOrganizationListEnum.getId();
               int length = updateOrganizationListEnum.getLength();
               ...
               // Insert the data
               if (id == UpdateOrganizationListEnum.ORGANIZATION.getId()) {
               ...
               else if (id == UpdateOrganizationListEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a UpdateOrganizationList object.
    *
    * @return The byte array as a UpdateOrganizationList message object.
    */
   public UpdateOrganizationList unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == UpdateOrganizationListEnum.SESSION_ID.getId()) {
            updateOrganizationList.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == UpdateOrganizationListEnum.ORGANIZATION.getId()) {
            ...
            updateOrganizationList.setOrganization(new OrganizationSubType().unpack(bytes));
         }
      }
   ...
   /**
    * This method packs a UpdateOrganizationList object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a UpdateOrganizationList message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeUpdateOrganizationList initializeUpdateOrganizationList = new InitializeUpdateOrganizationList(this);
      Element element = initializeUpdateOrganizationList.initialize();
    ...
    */
   public UpdateOrganizationList unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the UpdateOrganizationList object.
       */
       InstantiateUpdateOrganizationList instantiateUpdateOrganizationList = new InstantiateUpdateOrganizationList(element);
       UpdateOrganizationList updateOrganizationList = instantiateUpdateOrganizationList.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateUpdateOrganizationList.validate();
      if (result != null) {
    ...
    */
   private int getUpdateOrganizationListDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the UpdateOrganizationList object.
    * @return The size in bytes.
    */
   public int getUpdateOrganizationListSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      UpdateOrganizationList updateOrganizationList = (UpdateOrganizationList) obj;
      if (!updateOrganizationList.getSessionId().equals(this.getSessionId())) {
         return false;
      }
