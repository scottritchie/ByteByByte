...
/**
 * The InitializeResponseDeleteOrganization class initializes the element object with the ResponseDeleteOrganization object.
 *
 */
public class InitializeResponseDeleteOrganization {
   private static Logger log4j = Logger.getLogger(InitializeResponseDeleteOrganization.class);
    ...
    * The InitializeResponseDeleteOrganization class initializes the element object with the ResponseDeleteOrganization object.
    *
    * @param responseDeleteOrganization The object which will be used to initialize the element object.
    */
   public InitializeResponseDeleteOrganization(ResponseDeleteOrganization responseDeleteOrganization) {
      this.responseDeleteOrganization = responseDeleteOrganization;

      this.element = new Element("ResponseDeleteOrganization");
   }
   ...
   public Element initialize() throws MissingAttributeException {
      ...
      log4j.debug("element.getName(): ResponseDeleteOrganization");

      if (responseDeleteOrganization.getOrgId() != null) {
         AbstractAttribute abstractAttribute = initializeOrgId(responseDeleteOrganization.getOrgId());
      ...
      if (responseDeleteOrganization.getOrgName() != null) {
         AbstractAttribute abstractAttribute = initializeOrgName(responseDeleteOrganization.getOrgName());
         element.getAbstractAttributes().add(abstractAttribute);
      }
      else {
         // Missing required attribute, generate an error message and throw an exception
      ...
      if (responseDeleteOrganization.getUserName() != null) {
         AbstractAttribute abstractAttribute = initializeUserName(responseDeleteOrganization.getUserName());
         element.getAbstractAttributes().add(abstractAttribute);
      }
      else {
         // Missing required attribute, generate an error message and throw an exception
      ...
      if (responseDeleteOrganization.getSessionId() != null) {
         AbstractAttribute abstractAttribute = initializeSessionId(responseDeleteOrganization.getSessionId());
         element.getAbstractAttributes().add(abstractAttribute);
      }
      else {
         // Missing required attribute, generate an error message and throw an exception
