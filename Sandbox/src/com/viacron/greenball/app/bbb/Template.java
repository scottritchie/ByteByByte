...
public class Template {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      TemplateEnum.NAME.setLength(this.getName() != null ? this.getName().length() : 0);
      TemplateEnum.DESCRIPTION.setLength(this.getDescription() != null ? this.getDescription().length() : 0);
