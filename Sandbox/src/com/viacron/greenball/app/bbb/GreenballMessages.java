...
public class GreenballMessages {
   ...
   public static final String REQUEST_GRAMMAR = "RequestGrammar";
   ...
   public byte[] pack(Object obj) throws MissingAttributeException {
      ...
      if (obj != null) {
         ...
         else if (obj instanceof RequestGrammar) {
            log4j.debug("Found it");
            result = ((RequestGrammar) obj).pack();
         }
   ...
   public String packStr(Object obj) throws MissingAttributeException {
      ...
      if (obj != null) {
         ...
         if (obj instanceof AddOrganization) {
            ...
            log4j.debug("Found it");
            result = ((RequestGrammar) obj).packStr();
         }
         else if (obj instanceof RequestLoadModel) {
            log4j.debug("Found it");
   ...
   public Object unpack(byte[] buffer) {
      ...
      if (gme != null) {
         ...
         else if (gme.getId() == GreenballMessagesEnum.REQUEST_GRAMMAR.getId()) {
            log4j.debug("Found it");
            RequestGrammar requestGrammar = new RequestGrammar();
            result = requestGrammar.unpack(buffer);
         }
   ...
   public Object unpackStr(String buffer) {
      ...
      if (buffer == null) {
         ...
         else if (className.equals("RequestGrammar")) {
            log4j.debug("Found it");
         RequestGrammar requestGrammar = new RequestGrammar();
            result = requestGrammar.unpack(buffer);
         }
