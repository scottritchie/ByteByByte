...
/**
 * The RequestDeleteOrganization class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a RequestDeleteOrganization object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a RequestDeleteOrganization object.
 */
public class RequestDeleteOrganization {
   private static final int ID = GreenballMessagesEnum.REQUEST_DELETE_ORGANIZATION.getId();

   /**
    * The number of bits required to represent the RequestDeleteOrganizationEnum IDs.
    * # of attributes: 5
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(RequestDeleteOrganization.class);

   // Entered buildClassEnum()
   private enum RequestDeleteOrganizationEnum {
      ...
      RequestDeleteOrganizationEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The RequestDeleteOrganization no-arg constructor.
    */
   public RequestDeleteOrganization() {}

   /**
    * The RequestDeleteOrganization constructor.
    ...
    */
   public RequestDeleteOrganization(String orgId,
                                    String orgName,
                                    String userName,
                                    String message,
                                    String sessionId) {
   ...
   /**
    * This method packs a RequestDeleteOrganization object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a RequestDeleteOrganization message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getRequestDeleteOrganizationSize();
      ...
      RequestDeleteOrganizationEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      RequestDeleteOrganizationEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      RequestDeleteOrganizationEnum.USER_NAME.setLength(this.getUserName() != null ? this.getUserName().length() : 0);
      RequestDeleteOrganizationEnum.MESSAGE.setLength(this.getMessage() != null ? this.getMessage().length() : 0);
      RequestDeleteOrganizationEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getRequestDeleteOrganizationDirectorySize();
      if (directorySize != 0) {
         ...
         for (RequestDeleteOrganizationEnum requestDeleteOrganizationEnum : RequestDeleteOrganizationEnum.values()) {
            if (requestDeleteOrganizationEnum.isDirectoryEntry == true) {
               int id = requestDeleteOrganizationEnum.getId();
               int length = requestDeleteOrganizationEnum.getLength();
               ...
               // Insert the data
               if (id == RequestDeleteOrganizationEnum.ORG_ID.getId()) {
               ...
               else if (id == RequestDeleteOrganizationEnum.ORG_NAME.getId()) {
               ...
               else if (id == RequestDeleteOrganizationEnum.USER_NAME.getId()) {
               ...
               else if (id == RequestDeleteOrganizationEnum.MESSAGE.getId()) {
               ...
               else if (id == RequestDeleteOrganizationEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a RequestDeleteOrganization object.
    *
    * @return The byte array as a RequestDeleteOrganization message object.
    */
   public RequestDeleteOrganization unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == RequestDeleteOrganizationEnum.ORG_ID.getId()) {
            requestDeleteOrganization.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestDeleteOrganizationEnum.ORG_NAME.getId()) {
            requestDeleteOrganization.setOrgName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestDeleteOrganizationEnum.USER_NAME.getId()) {
            requestDeleteOrganization.setUserName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestDeleteOrganizationEnum.MESSAGE.getId()) {
            requestDeleteOrganization.setMessage(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestDeleteOrganizationEnum.SESSION_ID.getId()) {
            requestDeleteOrganization.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a RequestDeleteOrganization object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a RequestDeleteOrganization message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeRequestDeleteOrganization initializeRequestDeleteOrganization = new InitializeRequestDeleteOrganization(this);
      Element element = initializeRequestDeleteOrganization.initialize();
    ...
    */
   public RequestDeleteOrganization unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the RequestDeleteOrganization object.
       */
       InstantiateRequestDeleteOrganization instantiateRequestDeleteOrganization = new InstantiateRequestDeleteOrganization(element);
       RequestDeleteOrganization requestDeleteOrganization = instantiateRequestDeleteOrganization.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateRequestDeleteOrganization.validate();
      if (result != null) {
    ...
    */
   private int getRequestDeleteOrganizationDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the RequestDeleteOrganization object.
    * @return The size in bytes.
    */
   public int getRequestDeleteOrganizationSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      RequestDeleteOrganization requestDeleteOrganization = (RequestDeleteOrganization) obj;
      if (!requestDeleteOrganization.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (!requestDeleteOrganization.getOrgName().equals(this.getOrgName())) {
         return false;
      }

      if (!requestDeleteOrganization.getUserName().equals(this.getUserName())) {
         return false;
      }

      if (requestDeleteOrganization.getMessage() == null && this.getMessage() != null) {
         return false;
      }
      else if (requestDeleteOrganization.getMessage() != null && this.getMessage() == null) {
         return false;
      }
      else if (requestDeleteOrganization.getMessage() != null && 
      !requestDeleteOrganization.getMessage().equals(this.getMessage())) {
         return false;
      }

      if (requestDeleteOrganization.getSessionId() == null && this.getSessionId() != null) {
         return false;
      }
      else if (requestDeleteOrganization.getSessionId() != null && this.getSessionId() == null) {
         return false;
      }
      else if (requestDeleteOrganization.getSessionId() != null && 
      !requestDeleteOrganization.getSessionId().equals(this.getSessionId())) {
         return false;
      }
