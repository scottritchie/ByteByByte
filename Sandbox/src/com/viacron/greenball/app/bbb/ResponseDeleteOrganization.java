...
public class ResponseDeleteOrganization {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      ResponseDeleteOrganizationEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      ResponseDeleteOrganizationEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      ResponseDeleteOrganizationEnum.USER_NAME.setLength(this.getUserName() != null ? this.getUserName().length() : 0);
      ResponseDeleteOrganizationEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);
