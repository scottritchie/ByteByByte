...
/**
 * The ResponseCloseConnection class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a ResponseCloseConnection object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a ResponseCloseConnection object.
 */
public class ResponseCloseConnection {
   private static final int ID = GreenballMessagesEnum.RESPONSE_CLOSE_CONNECTION.getId();

   /**
    * The number of bits required to represent the ResponseCloseConnectionEnum IDs.
    * # of attributes: 3
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(ResponseCloseConnection.class);

   // Entered buildClassEnum()
   private enum ResponseCloseConnectionEnum {
      ...
      ResponseCloseConnectionEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
    ...
    */
   private String user;
   private List<OrganizationSubType> organizations;
   private String sessionId;

   private String theErrorMsg;

   /**
    * The ResponseCloseConnection no-arg constructor.
    */
   public ResponseCloseConnection() {}

   /**
    * The ResponseCloseConnection constructor.
    * See buildParameterAnnotations() in JBitByBitGenerator.java.
    *
    * @param user The user message attribute.
    * @param organizations The organizations message attribute.
    * @param sessionId The sessionId message attribute.
    */
   public ResponseCloseConnection(String user, List<OrganizationSubType> organizations,
                                  String sessionId) {
   ...
   /**
    * This method packs a ResponseCloseConnection object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a ResponseCloseConnection message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getResponseCloseConnectionSize();
      ...
      ResponseCloseConnectionEnum.USER.setLength(this.getUser() != null ? this.getUser().length() : 0);
      ResponseCloseConnectionEnum.ORGANIZATIONS.setLength(this.getOrganizations().size());
      ResponseCloseConnectionEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getResponseCloseConnectionDirectorySize();
      if (directorySize != 0) {
         ...
         for (ResponseCloseConnectionEnum responseCloseConnectionEnum : ResponseCloseConnectionEnum.values()) {
            if (responseCloseConnectionEnum.isDirectoryEntry == true) {
               int id = responseCloseConnectionEnum.getId();
               int length = responseCloseConnectionEnum.getLength();
               ...
               // Insert the data
               if (id == ResponseCloseConnectionEnum.USER.getId()) {
               ...
               else if (id == ResponseCloseConnectionEnum.ORGANIZATIONS.getId()) {
                  log4j.debug(String.format("inserting %s at offset %d", "organizations", offset));
                  for (OrganizationSubType organizationSubType : this.organizations) {
                     byte[] bytes = organizationSubType.pack();
               ...
               else if (id == ResponseCloseConnectionEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a ResponseCloseConnection object.
    *
    * @return The byte array as a ResponseCloseConnection message object.
    */
   public ResponseCloseConnection unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == ResponseCloseConnectionEnum.USER.getId()) {
            responseCloseConnection.setUser(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ResponseCloseConnectionEnum.SESSION_ID.getId()) {
            responseCloseConnection.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ResponseCloseConnectionEnum.ORGANIZATIONS.getId()) {
            ...
            responseCloseConnection.getOrganizations().add(new OrganizationSubType().unpack(bytes));
         }
      }
   ...
   /**
    * This method packs a ResponseCloseConnection object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a ResponseCloseConnection message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeResponseCloseConnection initializeResponseCloseConnection = new InitializeResponseCloseConnection(this);
      Element element = initializeResponseCloseConnection.initialize();
    ...
    */
   public ResponseCloseConnection unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the ResponseCloseConnection object.
       */
       InstantiateResponseCloseConnection instantiateResponseCloseConnection = new InstantiateResponseCloseConnection(element);
       ResponseCloseConnection responseCloseConnection = instantiateResponseCloseConnection.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateResponseCloseConnection.validate();
      if (result != null) {
   ...
   /**
    * This method sets the organizations attribute. Setting of this value is optional.
    * @param organizations The organizations.
    */
   public void setOrganizations(List<OrganizationSubType> organizations) {
      this.organizations = organizations;
   }

   /**
    * This method gets the organizations attribute. The organizations attribute is an optional attribute.
    */
   public List<OrganizationSubType> getOrganizations() {
      if (this.organizations == null) {
         this.organizations = new ArrayList<OrganizationSubType>();
      }
    ...
    */
   private int getResponseCloseConnectionDirectorySize() {
      int directorySize = 0;

      // user
      directorySize++;
      // organizations
      directorySize += getOrganizations().size();
      // sessionId
      directorySize++;
   ...
   /**
    * This method gets the size of the ResponseCloseConnection object.
    * @return The size in bytes.
    */
   public int getResponseCloseConnectionSize() {
      int size = 0;
      ...
      // Add size of organizations
      for (OrganizationSubType organizationSubType: getOrganizations()) {
         size += organizationSubType.getOrganizationSubTypeSize();
      }
   ...
   public String toString() {
      ...
      if (organizations != null) {
         for (OrganizationSubType organizationsOrganizationSubType : organizations) {
            result.append(organizationsOrganizationSubType.toString());
         }
      }
   ...
   public boolean equals(Object obj) {
      ...
      ResponseCloseConnection responseCloseConnection = (ResponseCloseConnection) obj;
      if (!responseCloseConnection.getUser().equals(this.getUser())) {
         return false;
      }

      if (!responseCloseConnection.getSessionId().equals(this.getSessionId())) {
         return false;
      }
