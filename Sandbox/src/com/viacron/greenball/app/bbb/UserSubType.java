...
public class UserSubType {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      UserSubTypeEnum.FIRST_NAME.setLength(this.getFirstName() != null ? this.getFirstName().length() : 0);
      UserSubTypeEnum.MIDDLE_NAME.setLength(this.getMiddleName() != null ? this.getMiddleName().length() : 0);
      UserSubTypeEnum.LAST_NAME.setLength(this.getLastName() != null ? this.getLastName().length() : 0);
      UserSubTypeEnum.USER_NAME.setLength(this.getUserName() != null ? this.getUserName().length() : 0);
      UserSubTypeEnum.PASSWORD.setLength(this.getPassword() != null ? this.getPassword().length() : 0);
   ...
   public boolean equals(Object obj) {
      ...
      if (userSubType.getUserRole() != this.getUserRole()) {
         return false;
      }

      if (userSubType.getUserStatus() != this.getUserStatus()) {
         return false;
      }

      if (userSubType.getPaymentStatus() != this.getPaymentStatus()) {
         return false;
      }
