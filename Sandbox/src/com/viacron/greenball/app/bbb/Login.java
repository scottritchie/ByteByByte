...
/**
 * The Login class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a Login object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a Login object.
 */
public class Login {
   private static final int ID = GreenballMessagesEnum.LOGIN.getId();

   /**
    * The number of bits required to represent the LoginEnum IDs.
    * # of attributes: 3
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(Login.class);
   ...
   private enum LoginEnum {
      ...
      LoginEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * This method packs a Login object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a Login message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getLoginSize();
      ...
      LoginEnum.USER.setLength(this.getUser() != null ? this.getUser().length() : 0);
      LoginEnum.PASSWORD.setLength(this.getPassword() != null ? this.getPassword().length() : 0);
      LoginEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getLoginDirectorySize();
      if (directorySize != 0) {
         ...
         for (LoginEnum loginEnum : LoginEnum.values()) {
            if (loginEnum.isDirectoryEntry == true) {
               int id = loginEnum.getId();
               int length = loginEnum.getLength();
               ...
               else if (id == LoginEnum.PASSWORD.getId()) {
               ...
               else if (id == LoginEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a Login object.
    *
    * @return The byte array as a Login message object.
    */
   public Login unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == LoginEnum.USER.getId()) {
            login.setUser(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == LoginEnum.PASSWORD.getId()) {
            login.setPassword(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == LoginEnum.SESSION_ID.getId()) {
            login.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a Login object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a Login message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
      ...
      Element element = initializeLogin.initialize();
    ...
    */
   public Login unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
       ...
       */
       InstantiateLogin instantiateLogin = new InstantiateLogin(element);
       Login login = instantiateLogin.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateLogin.validate();
      if (result != null) {
    ...
    */
   private int getLoginDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the Login object.
   ...
   public boolean equals(Object obj) {
      ...
      if (!login.getUser().equals(this.getUser())) {
         return false;
      }
      ...
      if (login.getSessionId() == null && this.getSessionId() != null) {
         return false;
      }
      else if (login.getSessionId() != null && this.getSessionId() == null) {
         return false;
      }
      else if (login.getSessionId() != null && 
      !login.getSessionId().equals(this.getSessionId())) {
         return false;
      }
