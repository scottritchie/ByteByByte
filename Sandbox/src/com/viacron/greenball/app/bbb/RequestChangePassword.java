...
public class RequestChangePassword {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      RequestChangePasswordEnum.USER.setLength(this.getUser() != null ? this.getUser().length() : 0);
      RequestChangePasswordEnum.OLD_PASSWORD.setLength(this.getOldPassword() != null ? this.getOldPassword().length() : 0);
      RequestChangePasswordEnum.NEW_PASSWORD.setLength(this.getNewPassword() != null ? this.getNewPassword().length() : 0);
      RequestChangePasswordEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);
