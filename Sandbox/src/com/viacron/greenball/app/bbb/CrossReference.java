...
public class CrossReference {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      CrossReferenceEnum.NAME.setLength(this.getName() != null ? this.getName().length() : 0);
      CrossReferenceEnum.REFERENCED_OBJECT.setLength(this.getReferencedObject() != null ? this.getReferencedObject().length() : 0);
