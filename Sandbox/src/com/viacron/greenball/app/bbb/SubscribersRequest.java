...
public class SubscribersRequest {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      SubscribersRequestEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      SubscribersRequestEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      SubscribersRequestEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);
