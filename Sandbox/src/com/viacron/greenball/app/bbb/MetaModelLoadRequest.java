...
/**
 * The MetaModelLoadRequest class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a MetaModelLoadRequest object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a MetaModelLoadRequest object.
 */
public class MetaModelLoadRequest {
   private static final int ID = GreenballMessagesEnum.META_MODEL_LOAD_REQUEST.getId();

   /**
    * The number of bits required to represent the MetaModelLoadRequestEnum IDs.
    * # of attributes: 3
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(MetaModelLoadRequest.class);

   // Entered buildClassEnum()
   private enum MetaModelLoadRequestEnum {
      ...
      MetaModelLoadRequestEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The MetaModelLoadRequest no-arg constructor.
    */
   public MetaModelLoadRequest() {}

   /**
    * The MetaModelLoadRequest constructor.
    ...
    */
   public MetaModelLoadRequest(String orgId,
                               String orgName,
                               String sessionId) {
   ...
   /**
    * This method packs a MetaModelLoadRequest object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a MetaModelLoadRequest message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getMetaModelLoadRequestSize();
      ...
      MetaModelLoadRequestEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      MetaModelLoadRequestEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      MetaModelLoadRequestEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getMetaModelLoadRequestDirectorySize();
      if (directorySize != 0) {
         ...
         for (MetaModelLoadRequestEnum metaModelLoadRequestEnum : MetaModelLoadRequestEnum.values()) {
            if (metaModelLoadRequestEnum.isDirectoryEntry == true) {
               int id = metaModelLoadRequestEnum.getId();
               int length = metaModelLoadRequestEnum.getLength();
               ...
               // Insert the data
               if (id == MetaModelLoadRequestEnum.ORG_ID.getId()) {
               ...
               else if (id == MetaModelLoadRequestEnum.ORG_NAME.getId()) {
               ...
               else if (id == MetaModelLoadRequestEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a MetaModelLoadRequest object.
    *
    * @return The byte array as a MetaModelLoadRequest message object.
    */
   public MetaModelLoadRequest unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == MetaModelLoadRequestEnum.ORG_ID.getId()) {
            metaModelLoadRequest.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == MetaModelLoadRequestEnum.ORG_NAME.getId()) {
            metaModelLoadRequest.setOrgName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == MetaModelLoadRequestEnum.SESSION_ID.getId()) {
            metaModelLoadRequest.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }

      log4j.debug("Leaving " + METHOD);
      return metaModelLoadRequest;
   }
   // Leaving buildUnpackMethod()

   // Entered buildPackStrMethod()
   /**
    * This method packs a MetaModelLoadRequest object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a MetaModelLoadRequest message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeMetaModelLoadRequest initializeMetaModelLoadRequest = new InitializeMetaModelLoadRequest(this);
      Element element = initializeMetaModelLoadRequest.initialize();
    ...
    */
   public MetaModelLoadRequest unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the MetaModelLoadRequest object.
       */
       InstantiateMetaModelLoadRequest instantiateMetaModelLoadRequest = new InstantiateMetaModelLoadRequest(element);
       MetaModelLoadRequest metaModelLoadRequest = instantiateMetaModelLoadRequest.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateMetaModelLoadRequest.validate();
      if (result != null) {
    ...
    */
   private int getMetaModelLoadRequestDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the MetaModelLoadRequest object.
    * @return The size in bytes.
    */
   public int getMetaModelLoadRequestSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      MetaModelLoadRequest metaModelLoadRequest = (MetaModelLoadRequest) obj;
      if (!metaModelLoadRequest.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (!metaModelLoadRequest.getOrgName().equals(this.getOrgName())) {
         return false;
      }

      if (metaModelLoadRequest.getSessionId() == null && this.getSessionId() != null) {
         return false;
      }
      else if (metaModelLoadRequest.getSessionId() != null && this.getSessionId() == null) {
         return false;
      }
      else if (metaModelLoadRequest.getSessionId() != null && 
      !metaModelLoadRequest.getSessionId().equals(this.getSessionId())) {
         return false;
      }
