...
/**
 * The RequestOrganizationList class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a RequestOrganizationList object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a RequestOrganizationList object.
 */
public class RequestOrganizationList {
   private static final int ID = GreenballMessagesEnum.REQUEST_ORGANIZATION_LIST.getId();

   /**
    * The number of bits required to represent the RequestOrganizationListEnum IDs.
    * # of attributes: 1
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(RequestOrganizationList.class);

   // Entered buildClassEnum()
   private enum RequestOrganizationListEnum {
      ...
      RequestOrganizationListEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The RequestOrganizationList no-arg constructor.
    */
   public RequestOrganizationList() {}

   /**
    * The RequestOrganizationList constructor.
    * See buildParameterAnnotations() in JBitByBitGenerator.java.
    *
    * @param sessionId The sessionId message attribute.
    */
   public RequestOrganizationList(String sessionId) {
   ...
   /**
    * This method packs a RequestOrganizationList object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a RequestOrganizationList message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getRequestOrganizationListSize();
      ...
      RequestOrganizationListEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getRequestOrganizationListDirectorySize();
      if (directorySize != 0) {
         ...
         for (RequestOrganizationListEnum requestOrganizationListEnum : RequestOrganizationListEnum.values()) {
            if (requestOrganizationListEnum.isDirectoryEntry == true) {
               int id = requestOrganizationListEnum.getId();
               int length = requestOrganizationListEnum.getLength();
               ...
               // Insert the data
               if (id == RequestOrganizationListEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a RequestOrganizationList object.
    *
    * @return The byte array as a RequestOrganizationList message object.
    */
   public RequestOrganizationList unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == RequestOrganizationListEnum.SESSION_ID.getId()) {
            requestOrganizationList.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a RequestOrganizationList object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a RequestOrganizationList message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeRequestOrganizationList initializeRequestOrganizationList = new InitializeRequestOrganizationList(this);
      Element element = initializeRequestOrganizationList.initialize();
    ...
    */
   public RequestOrganizationList unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the RequestOrganizationList object.
       */
       InstantiateRequestOrganizationList instantiateRequestOrganizationList = new InstantiateRequestOrganizationList(element);
       RequestOrganizationList requestOrganizationList = instantiateRequestOrganizationList.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateRequestOrganizationList.validate();
      if (result != null) {
    ...
    */
   private int getRequestOrganizationListDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the RequestOrganizationList object.
    * @return The size in bytes.
    */
   public int getRequestOrganizationListSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      RequestOrganizationList requestOrganizationList = (RequestOrganizationList) obj;
      if (!requestOrganizationList.getSessionId().equals(this.getSessionId())) {
         return false;
      }
