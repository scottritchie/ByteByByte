...
/**
 * The NewSubscription class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a NewSubscription object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a NewSubscription object.
 */
public class NewSubscription {
   private static final int ID = GreenballMessagesEnum.NEW_SUBSCRIPTION.getId();

   /**
    * The number of bits required to represent the NewSubscriptionEnum IDs.
    * # of attributes: 2
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(NewSubscription.class);

   // Entered buildClassEnum()
   private enum NewSubscriptionEnum {
      ...
      NewSubscriptionEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The NewSubscription no-arg constructor.
    */
   public NewSubscription() {}

   /**
    * The NewSubscription constructor.
    ...
    */
   public NewSubscription(OrganizationSubType organization,
                          String sessionId) {
   ...
   /**
    * This method packs a NewSubscription object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a NewSubscription message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getNewSubscriptionSize();
      ...
      NewSubscriptionEnum.ORGANIZATION.setLength(this.getOrganization().getOrganizationSubTypeSize());
      NewSubscriptionEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getNewSubscriptionDirectorySize();
      if (directorySize != 0) {
         ...
         for (NewSubscriptionEnum newSubscriptionEnum : NewSubscriptionEnum.values()) {
            if (newSubscriptionEnum.isDirectoryEntry == true) {
               int id = newSubscriptionEnum.getId();
               int length = newSubscriptionEnum.getLength();
               ...
               // Insert the data
               if (id == NewSubscriptionEnum.ORGANIZATION.getId()) {
               ...
               else if (id == NewSubscriptionEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a NewSubscription object.
    *
    * @return The byte array as a NewSubscription message object.
    */
   public NewSubscription unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == NewSubscriptionEnum.SESSION_ID.getId()) {
            newSubscription.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == NewSubscriptionEnum.ORGANIZATION.getId()) {
            ...
            newSubscription.setOrganization(new OrganizationSubType().unpack(bytes));
         }
      }
   ...
   /**
    * This method packs a NewSubscription object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a NewSubscription message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeNewSubscription initializeNewSubscription = new InitializeNewSubscription(this);
      Element element = initializeNewSubscription.initialize();
    ...
    */
   public NewSubscription unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the NewSubscription object.
       */
       InstantiateNewSubscription instantiateNewSubscription = new InstantiateNewSubscription(element);
       NewSubscription newSubscription = instantiateNewSubscription.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateNewSubscription.validate();
      if (result != null) {
    ...
    */
   private int getNewSubscriptionDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the NewSubscription object.
    * @return The size in bytes.
    */
   public int getNewSubscriptionSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      if (!newSubscription.getSessionId().equals(this.getSessionId())) {
         return false;
      }
