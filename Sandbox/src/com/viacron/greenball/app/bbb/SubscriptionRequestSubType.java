...
public class SubscriptionRequestSubType {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      SubscriptionRequestSubTypeEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      SubscriptionRequestSubTypeEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      SubscriptionRequestSubTypeEnum.REQUESTOR.setLength(this.getRequestor() != null ? this.getRequestor().length() : 0);
      SubscriptionRequestSubTypeEnum.MESSAGE.setLength(this.getMessage() != null ? this.getMessage().length() : 0);
      SubscriptionRequestSubTypeEnum.OWNER.setLength(this.getOwner() != null ? this.getOwner().length() : 0);
