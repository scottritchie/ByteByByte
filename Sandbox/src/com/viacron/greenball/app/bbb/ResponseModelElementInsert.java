...
/**
 * The ResponseModelElementInsert class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a ResponseModelElementInsert object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a ResponseModelElementInsert object.
 */
public class ResponseModelElementInsert {
   private static final int ID = GreenballMessagesEnum.RESPONSE_MODEL_ELEMENT_INSERT.getId();

   /**
    * The number of bits required to represent the ResponseModelElementInsertEnum IDs.
    * # of attributes: 3
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(ResponseModelElementInsert.class);

   // Entered buildClassEnum()
   private enum ResponseModelElementInsertEnum {
      ...
      ResponseModelElementInsertEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The ResponseModelElementInsert no-arg constructor.
    */
   public ResponseModelElementInsert() {}

   /**
    * The ResponseModelElementInsert constructor.
    ...
    */
   public ResponseModelElementInsert(String orgId, TreeNodeType treeNode,
                                     String sessionId) {
   ...
   /**
    * This method packs a ResponseModelElementInsert object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a ResponseModelElementInsert message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getResponseModelElementInsertSize();
      ...
      ResponseModelElementInsertEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      ResponseModelElementInsertEnum.TREE_NODE.setLength(this.getTreeNode().getTreeNodeTypeSize());
      ResponseModelElementInsertEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getResponseModelElementInsertDirectorySize();
      if (directorySize != 0) {
         ...
         for (ResponseModelElementInsertEnum responseModelElementInsertEnum : ResponseModelElementInsertEnum.values()) {
            if (responseModelElementInsertEnum.isDirectoryEntry == true) {
               int id = responseModelElementInsertEnum.getId();
               int length = responseModelElementInsertEnum.getLength();
               ...
               // Insert the data
               if (id == ResponseModelElementInsertEnum.ORG_ID.getId()) {
               ...
               else if (id == ResponseModelElementInsertEnum.TREE_NODE.getId()) {
               ...
               else if (id == ResponseModelElementInsertEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a ResponseModelElementInsert object.
    *
    * @return The byte array as a ResponseModelElementInsert message object.
    */
   public ResponseModelElementInsert unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == ResponseModelElementInsertEnum.ORG_ID.getId()) {
            responseModelElementInsert.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ResponseModelElementInsertEnum.SESSION_ID.getId()) {
            responseModelElementInsert.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == ResponseModelElementInsertEnum.TREE_NODE.getId()) {
            ...
            responseModelElementInsert.setTreeNode(new TreeNodeType().unpack(bytes));
         }
      }
   ...
   /**
    * This method packs a ResponseModelElementInsert object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a ResponseModelElementInsert message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeResponseModelElementInsert initializeResponseModelElementInsert = new InitializeResponseModelElementInsert(this);
      Element element = initializeResponseModelElementInsert.initialize();
    ...
    */
   public ResponseModelElementInsert unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the ResponseModelElementInsert object.
       */
       InstantiateResponseModelElementInsert instantiateResponseModelElementInsert = new InstantiateResponseModelElementInsert(element);
       ResponseModelElementInsert responseModelElementInsert = instantiateResponseModelElementInsert.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateResponseModelElementInsert.validate();
      if (result != null) {
    ...
    */
   private int getResponseModelElementInsertDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the ResponseModelElementInsert object.
    * @return The size in bytes.
    */
   public int getResponseModelElementInsertSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      ResponseModelElementInsert responseModelElementInsert = (ResponseModelElementInsert) obj;
      if (!responseModelElementInsert.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (responseModelElementInsert.getSessionId() == null && this.getSessionId() != null) {
         return false;
      }
      else if (responseModelElementInsert.getSessionId() != null && this.getSessionId() == null) {
         return false;
      }
      else if (responseModelElementInsert.getSessionId() != null && 
      !responseModelElementInsert.getSessionId().equals(this.getSessionId())) {
         return false;
      }
