...
public class ResponseLogin {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      ResponseLoginEnum.MSG.setLength(this.getMsg() != null ? this.getMsg().length() : 0);
      ResponseLoginEnum.USER.setLength(this.getUser() != null ? this.getUser().length() : 0);
      ResponseLoginEnum.PASSWORD.setLength(this.getPassword() != null ? this.getPassword().length() : 0);
      ResponseLoginEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);
