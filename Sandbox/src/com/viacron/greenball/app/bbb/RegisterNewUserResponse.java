...
/**
 * The RegisterNewUserResponse class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a RegisterNewUserResponse object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a RegisterNewUserResponse object.
 */
public class RegisterNewUserResponse {
   private static final int ID = GreenballMessagesEnum.REGISTER_NEW_USER_RESPONSE.getId();

   /**
    * The number of bits required to represent the RegisterNewUserResponseEnum IDs.
    * # of attributes: 2
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(RegisterNewUserResponse.class);

   // Entered buildClassEnum()
   private enum RegisterNewUserResponseEnum {
      ...
      RegisterNewUserResponseEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
    ...
    */
   private UserSubType user;
   private String sessionId;

   private String theErrorMsg;

   /**
    * The RegisterNewUserResponse no-arg constructor.
    */
   public RegisterNewUserResponse() {}

   /**
    * The RegisterNewUserResponse constructor.
    ...
    */
   public RegisterNewUserResponse(UserSubType user,
                                  String sessionId) {
   ...
   /**
    * This method packs a RegisterNewUserResponse object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a RegisterNewUserResponse message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getRegisterNewUserResponseSize();
      ...
      RegisterNewUserResponseEnum.USER.setLength(this.getUser().getUserSubTypeSize());
      RegisterNewUserResponseEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getRegisterNewUserResponseDirectorySize();
      if (directorySize != 0) {
         ...
         for (RegisterNewUserResponseEnum registerNewUserResponseEnum : RegisterNewUserResponseEnum.values()) {
            if (registerNewUserResponseEnum.isDirectoryEntry == true) {
               int id = registerNewUserResponseEnum.getId();
               int length = registerNewUserResponseEnum.getLength();
               ...
               // Insert the data
               if (id == RegisterNewUserResponseEnum.USER.getId()) {
                  log4j.debug(String.format("inserting %s at offset %d", "user", offset));
                  byte[] bytes = this.getUser().pack();
                  bb = GreenballMessagesUtility.insertBytes(bb, offset, bytes);
                  offset += bytes.length;
               }
               else if (id == RegisterNewUserResponseEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a RegisterNewUserResponse object.
    *
    * @return The byte array as a RegisterNewUserResponse message object.
    */
   public RegisterNewUserResponse unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == RegisterNewUserResponseEnum.SESSION_ID.getId()) {
            registerNewUserResponse.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RegisterNewUserResponseEnum.USER.getId()) {
            ...
            registerNewUserResponse.setUser(new UserSubType().unpack(bytes));
         }
      }
   ...
   /**
    * This method packs a RegisterNewUserResponse object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a RegisterNewUserResponse message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeRegisterNewUserResponse initializeRegisterNewUserResponse = new InitializeRegisterNewUserResponse(this);
      Element element = initializeRegisterNewUserResponse.initialize();
    ...
    */
   public RegisterNewUserResponse unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the RegisterNewUserResponse object.
       */
       InstantiateRegisterNewUserResponse instantiateRegisterNewUserResponse = new InstantiateRegisterNewUserResponse(element);
       RegisterNewUserResponse registerNewUserResponse = instantiateRegisterNewUserResponse.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateRegisterNewUserResponse.validate();
      if (result != null) {
    ...
    * @param user The user.
    */
   public void setUser(UserSubType user) {
      this.user = user;
   }
    ...
    */
   private int getRegisterNewUserResponseDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the RegisterNewUserResponse object.
    * @return The size in bytes.
    */
   public int getRegisterNewUserResponseSize() {
      int size = 0;
      ...
      // Add size of user
      size += getUser().getUserSubTypeSize();
   ...
   public boolean equals(Object obj) {
      ...
      RegisterNewUserResponse registerNewUserResponse = (RegisterNewUserResponse) obj;
      if (!registerNewUserResponse.getSessionId().equals(this.getSessionId())) {
         return false;
      }
