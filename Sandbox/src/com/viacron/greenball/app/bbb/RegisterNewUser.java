...
/**
 * The RegisterNewUser class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a RegisterNewUser object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a RegisterNewUser object.
 */
public class RegisterNewUser {
   private static final int ID = GreenballMessagesEnum.REGISTER_NEW_USER.getId();

   /**
    * The number of bits required to represent the RegisterNewUserEnum IDs.
    * # of attributes: 2
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(RegisterNewUser.class);

   // Entered buildClassEnum()
   private enum RegisterNewUserEnum {
      ...
      RegisterNewUserEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The RegisterNewUser no-arg constructor.
    */
   public RegisterNewUser() {}

   /**
    * The RegisterNewUser constructor.
    ...
    */
   public RegisterNewUser(UserSubType user,
                          String sessionId) {
   ...
   /**
    * This method packs a RegisterNewUser object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a RegisterNewUser message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getRegisterNewUserSize();
      ...
      RegisterNewUserEnum.USER.setLength(this.getUser().getUserSubTypeSize());
      RegisterNewUserEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getRegisterNewUserDirectorySize();
      if (directorySize != 0) {
         ...
         for (RegisterNewUserEnum registerNewUserEnum : RegisterNewUserEnum.values()) {
            if (registerNewUserEnum.isDirectoryEntry == true) {
               int id = registerNewUserEnum.getId();
               int length = registerNewUserEnum.getLength();
               ...
               // Insert the data
               if (id == RegisterNewUserEnum.USER.getId()) {
               ...
               else if (id == RegisterNewUserEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a RegisterNewUser object.
    *
    * @return The byte array as a RegisterNewUser message object.
    */
   public RegisterNewUser unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == RegisterNewUserEnum.SESSION_ID.getId()) {
            registerNewUser.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RegisterNewUserEnum.USER.getId()) {
            ...
            registerNewUser.setUser(new UserSubType().unpack(bytes));
         }
      }
   ...
   /**
    * This method packs a RegisterNewUser object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a RegisterNewUser message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeRegisterNewUser initializeRegisterNewUser = new InitializeRegisterNewUser(this);
      Element element = initializeRegisterNewUser.initialize();
    ...
    */
   public RegisterNewUser unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the RegisterNewUser object.
       */
       InstantiateRegisterNewUser instantiateRegisterNewUser = new InstantiateRegisterNewUser(element);
       RegisterNewUser registerNewUser = instantiateRegisterNewUser.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateRegisterNewUser.validate();
      if (result != null) {
    ...
    */
   private int getRegisterNewUserDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the RegisterNewUser object.
    * @return The size in bytes.
    */
   public int getRegisterNewUserSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      RegisterNewUser registerNewUser = (RegisterNewUser) obj;
      if (registerNewUser.getSessionId() == null && this.getSessionId() != null) {
         return false;
      }
      else if (registerNewUser.getSessionId() != null && this.getSessionId() == null) {
         return false;
      }
      else if (registerNewUser.getSessionId() != null && 
      !registerNewUser.getSessionId().equals(this.getSessionId())) {
         return false;
      }
