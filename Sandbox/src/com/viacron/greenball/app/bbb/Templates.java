...
/**
 * The Templates class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a Templates object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a Templates object.
 */
public class Templates {
   private static final int ID = GreenballMessagesEnum.TEMPLATES.getId();

   /**
    * The number of bits required to represent the TemplatesEnum IDs.
    * # of attributes: 2
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(Templates.class);

   // Entered buildClassEnum()
   private enum TemplatesEnum {
      // This is a directory item. It's offset and length cannot be determined
      // until runtime.
      TEMPLATES(0, -1, 0, true),
      ...
      TemplatesEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The Templates no-arg constructor.
    */
   public Templates() {}
    ...
    *
    * @param templates The templates message attribute.
    * @param sessionId The sessionId message attribute.
    */
   public Templates(List<String> templates,
                    String sessionId) {
   ...
   /**
    * This method packs a Templates object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a Templates message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getTemplatesSize();
      ...
      TemplatesEnum.TEMPLATES.setLength(this.getTemplates() != null ? this.getTemplates().size() : 0);
      TemplatesEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getTemplatesDirectorySize();
      if (directorySize != 0) {
         ...
         for (TemplatesEnum templatesEnum : TemplatesEnum.values()) {
            if (templatesEnum.isDirectoryEntry == true) {
               int id = templatesEnum.getId();
               int length = templatesEnum.getLength();
               ...
               // Insert the data
               if (id == TemplatesEnum.TEMPLATES.getId()) {
                  log4j.debug(String.format("inserting %s at offset %d", "templates", offset));
                  for (String s : getTemplates()) {
               ...
               else if (id == TemplatesEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a Templates object.
    *
    * @return The byte array as a Templates message object.
    */
   public Templates unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == TemplatesEnum.TEMPLATES.getId()) {
            ...
            templates.getTemplates().add(s);
         }
         else if (id == TemplatesEnum.SESSION_ID.getId()) {
            templates.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a Templates object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a Templates message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeTemplates initializeTemplates = new InitializeTemplates(this);
      Element element = initializeTemplates.initialize();
    ...
    */
   public Templates unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the Templates object.
       */
       InstantiateTemplates instantiateTemplates = new InstantiateTemplates(element);
       Templates templates = instantiateTemplates.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateTemplates.validate();
      if (result != null) {
   ...
   /**
    * This method sets the templates attribute. Setting of this value is optional.
    * @param templates The templates attribute.
    */
   ...
   /**
    * This method gets the templates attribute. The templates attribute is an optional attribute.
    */
    ...
    */
   private int getTemplatesDirectorySize() {
      int directorySize = 0;

      // templates
      directorySize += getTemplates().size();
      // sessionId
      directorySize++;
   ...
   /**
    * This method gets the size of the Templates object.
   ...
   public String toString() {
      ...
      if (templates != null) {
         int i = 0;
         for (String templatesString : templates) {
            result.append(" templates[" + i + "]: " + templatesString.toString() + NEW_LINE);
            i++;
         }
      }
   ...
   public boolean equals(Object obj) {
      ...
      if (templates.getTemplates() == null && this.getTemplates() != null) {
         return false;
      }
      else if (templates.getTemplates() != null && this.getTemplates() == null) {
         return false;
      }
      else if (templates.getTemplates() != null && 
      !templates.getTemplates().equals(this.getTemplates())) {
         return false;
      }

      if (!templates.getSessionId().equals(this.getSessionId())) {
         return false;
      }
