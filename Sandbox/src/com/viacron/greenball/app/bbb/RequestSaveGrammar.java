...
/**
 * The RequestSaveGrammar class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a RequestSaveGrammar object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a RequestSaveGrammar object.
 */
public class RequestSaveGrammar {
   private static final int ID = GreenballMessagesEnum.REQUEST_SAVE_GRAMMAR.getId();

   /**
    * The number of bits required to represent the RequestSaveGrammarEnum IDs.
    * # of attributes: 5
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(RequestSaveGrammar.class);

   // Entered buildClassEnum()
   private enum RequestSaveGrammarEnum {
      ...
      RequestSaveGrammarEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The RequestSaveGrammar no-arg constructor.
    */
   public RequestSaveGrammar() {}

   /**
    * The RequestSaveGrammar constructor.
    ...
    * @param buffer The buffer message attribute.
    * @param sessionId The sessionId message attribute.
    */
   public RequestSaveGrammar(String orgId,
                             String orgName,
                             String userName,
                             String buffer,
                             String sessionId) {
   ...
   /**
    * This method packs a RequestSaveGrammar object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a RequestSaveGrammar message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getRequestSaveGrammarSize();
      ...
      RequestSaveGrammarEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      RequestSaveGrammarEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      RequestSaveGrammarEnum.USER_NAME.setLength(this.getUserName() != null ? this.getUserName().length() : 0);
      RequestSaveGrammarEnum.BUFFER.setLength(this.getBuffer() != null ? this.getBuffer().length() : 0);
      RequestSaveGrammarEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getRequestSaveGrammarDirectorySize();
      if (directorySize != 0) {
         ...
         for (RequestSaveGrammarEnum requestSaveGrammarEnum : RequestSaveGrammarEnum.values()) {
            if (requestSaveGrammarEnum.isDirectoryEntry == true) {
               int id = requestSaveGrammarEnum.getId();
               int length = requestSaveGrammarEnum.getLength();
               ...
               // Insert the data
               if (id == RequestSaveGrammarEnum.ORG_ID.getId()) {
               ...
               else if (id == RequestSaveGrammarEnum.ORG_NAME.getId()) {
               ...
               else if (id == RequestSaveGrammarEnum.USER_NAME.getId()) {
               ...
               else if (id == RequestSaveGrammarEnum.BUFFER.getId()) {
                  log4j.debug(String.format("inserting %s at offset %d", "buffer", offset));
                  if (getBuffer() != null) {
                     bb = GreenballMessagesUtility.insertString(bb, offset, getBuffer());
                     offset += length * 1;
                  }
               }
               else if (id == RequestSaveGrammarEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a RequestSaveGrammar object.
    *
    * @return The byte array as a RequestSaveGrammar message object.
    */
   public RequestSaveGrammar unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == RequestSaveGrammarEnum.ORG_ID.getId()) {
            requestSaveGrammar.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestSaveGrammarEnum.ORG_NAME.getId()) {
            requestSaveGrammar.setOrgName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestSaveGrammarEnum.USER_NAME.getId()) {
            requestSaveGrammar.setUserName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestSaveGrammarEnum.BUFFER.getId()) {
            requestSaveGrammar.setBuffer(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == RequestSaveGrammarEnum.SESSION_ID.getId()) {
            requestSaveGrammar.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a RequestSaveGrammar object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a RequestSaveGrammar message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeRequestSaveGrammar initializeRequestSaveGrammar = new InitializeRequestSaveGrammar(this);
      Element element = initializeRequestSaveGrammar.initialize();
    ...
    */
   public RequestSaveGrammar unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the RequestSaveGrammar object.
       */
       InstantiateRequestSaveGrammar instantiateRequestSaveGrammar = new InstantiateRequestSaveGrammar(element);
       RequestSaveGrammar requestSaveGrammar = instantiateRequestSaveGrammar.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateRequestSaveGrammar.validate();
      if (result != null) {
   ...
   /**
    * This method sets the buffer attribute. Setting of this value is required.
   ...
   /**
    * This method gets the buffer attribute. The buffer attribute is a required attribute.
    */
    ...
    */
   private int getRequestSaveGrammarDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the RequestSaveGrammar object.
    * @return The size in bytes.
    */
   public int getRequestSaveGrammarSize() {
      int size = 0;
      ...
      // Add size of buffer
      size += (getBuffer() != null ? getBuffer().length() : 0);
   ...
   public String toString() {
      ...
      result.append(" buffer: " + buffer + NEW_LINE);
   ...
   public boolean equals(Object obj) {
      ...
      RequestSaveGrammar requestSaveGrammar = (RequestSaveGrammar) obj;
      if (!requestSaveGrammar.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (!requestSaveGrammar.getOrgName().equals(this.getOrgName())) {
         return false;
      }

      if (!requestSaveGrammar.getUserName().equals(this.getUserName())) {
         return false;
      }

      if (!requestSaveGrammar.getBuffer().equals(this.getBuffer())) {
         return false;
      }

      if (requestSaveGrammar.getSessionId() == null && this.getSessionId() != null) {
         return false;
      }
      else if (requestSaveGrammar.getSessionId() != null && this.getSessionId() == null) {
         return false;
      }
      else if (requestSaveGrammar.getSessionId() != null && 
      !requestSaveGrammar.getSessionId().equals(this.getSessionId())) {
         return false;
      }
