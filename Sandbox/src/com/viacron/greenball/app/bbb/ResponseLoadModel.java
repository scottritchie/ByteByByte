...
public class ResponseLoadModel {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      ResponseLoadModelEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      ResponseLoadModelEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      ResponseLoadModelEnum.NAME.setLength(this.getName() != null ? this.getName().length() : 0);
      ...
      ResponseLoadModelEnum.ID.setLength(this.getId() != null ? this.getId().length() : 0);
      ResponseLoadModelEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);
