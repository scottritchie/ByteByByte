...
/**
 * The EditRuleMessage class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a EditRuleMessage object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a EditRuleMessage object.
 */
public class EditRuleMessage {
   private static final int ID = GreenballMessagesEnum.EDIT_RULE_MESSAGE.getId();

   /**
    * The number of bits required to represent the EditRuleMessageEnum IDs.
    * # of attributes: 7
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(EditRuleMessage.class);

   // Entered buildClassEnum()
   private enum EditRuleMessageEnum {
      ...
      EditRuleMessageEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The EditRuleMessage no-arg constructor.
    */
   public EditRuleMessage() {}

   /**
    * The EditRuleMessage constructor.
    ...
    */
   public EditRuleMessage(String orgId,
                          String orgName,
                          String modelName,
                          String userName, Rule newRule, Rule oldRule,
                          String sessionId) {
   ...
   /**
    * This method packs a EditRuleMessage object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a EditRuleMessage message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getEditRuleMessageSize();
      ...
      EditRuleMessageEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      EditRuleMessageEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      EditRuleMessageEnum.MODEL_NAME.setLength(this.getModelName() != null ? this.getModelName().length() : 0);
      EditRuleMessageEnum.USER_NAME.setLength(this.getUserName() != null ? this.getUserName().length() : 0);
      EditRuleMessageEnum.NEW_RULE.setLength(this.getNewRule().getRuleSize());
      EditRuleMessageEnum.OLD_RULE.setLength(this.getOldRule().getRuleSize());
      EditRuleMessageEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getEditRuleMessageDirectorySize();
      if (directorySize != 0) {
         ...
         for (EditRuleMessageEnum editRuleMessageEnum : EditRuleMessageEnum.values()) {
            if (editRuleMessageEnum.isDirectoryEntry == true) {
               int id = editRuleMessageEnum.getId();
               int length = editRuleMessageEnum.getLength();
               ...
               // Insert the data
               if (id == EditRuleMessageEnum.ORG_ID.getId()) {
               ...
               else if (id == EditRuleMessageEnum.ORG_NAME.getId()) {
               ...
               else if (id == EditRuleMessageEnum.MODEL_NAME.getId()) {
               ...
               else if (id == EditRuleMessageEnum.USER_NAME.getId()) {
               ...
               else if (id == EditRuleMessageEnum.NEW_RULE.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a EditRuleMessage object.
    *
    * @return The byte array as a EditRuleMessage message object.
    */
   public EditRuleMessage unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == EditRuleMessageEnum.ORG_ID.getId()) {
            editRuleMessage.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == EditRuleMessageEnum.ORG_NAME.getId()) {
            editRuleMessage.setOrgName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == EditRuleMessageEnum.MODEL_NAME.getId()) {
            editRuleMessage.setModelName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == EditRuleMessageEnum.USER_NAME.getId()) {
            editRuleMessage.setUserName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == EditRuleMessageEnum.SESSION_ID.getId()) {
            editRuleMessage.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == EditRuleMessageEnum.NEW_RULE.getId()) {
            ...
            editRuleMessage.setNewRule(new Rule().unpack(bytes));
         }
         else if (id == EditRuleMessageEnum.OLD_RULE.getId()) {
            byte[] bytes = new byte[length];
            ...
            editRuleMessage.setOldRule(new Rule().unpack(bytes));
         }
      }
   ...
   /**
    * This method packs a EditRuleMessage object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a EditRuleMessage message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeEditRuleMessage initializeEditRuleMessage = new InitializeEditRuleMessage(this);
      Element element = initializeEditRuleMessage.initialize();
    ...
    */
   public EditRuleMessage unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the EditRuleMessage object.
       */
       InstantiateEditRuleMessage instantiateEditRuleMessage = new InstantiateEditRuleMessage(element);
       EditRuleMessage editRuleMessage = instantiateEditRuleMessage.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateEditRuleMessage.validate();
      if (result != null) {
    ...
    */
   private int getEditRuleMessageDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the EditRuleMessage object.
    * @return The size in bytes.
    */
   public int getEditRuleMessageSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      EditRuleMessage editRuleMessage = (EditRuleMessage) obj;
      if (!editRuleMessage.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (!editRuleMessage.getOrgName().equals(this.getOrgName())) {
         return false;
      }

      if (!editRuleMessage.getModelName().equals(this.getModelName())) {
         return false;
      }

      if (!editRuleMessage.getUserName().equals(this.getUserName())) {
         return false;
      }

      if (editRuleMessage.getSessionId() == null && this.getSessionId() != null) {
         return false;
      }
      else if (editRuleMessage.getSessionId() != null && this.getSessionId() == null) {
         return false;
      }
      else if (editRuleMessage.getSessionId() != null && 
      !editRuleMessage.getSessionId().equals(this.getSessionId())) {
         return false;
      }
