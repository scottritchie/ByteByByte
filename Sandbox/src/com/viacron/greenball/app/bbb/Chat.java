...
public class Chat {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      if (this.getDud1() != null) {
         log4j.debug(String.format("inserting %s at offset %d", "dud1", offset));
      ...
      if (this.getDud2() != null) {
         log4j.debug(String.format("inserting %s at offset %d", "dud2", offset));
      ...
      if (this.getDud3() != null) {
         log4j.debug(String.format("inserting %s at offset %d", "dud3", offset));
      ...
      if (this.getDud4() != null) {
         log4j.debug(String.format("inserting %s at offset %d", "dud4", offset));
      ...
      if (this.getDud5() != null) {
         log4j.debug(String.format("inserting %s at offset %d", "dud5", offset));
      ...
      if (this.getDud6() != null) {
         log4j.debug(String.format("inserting %s at offset %d", "dud6", offset));
      ...
      if (this.getDud7() != null) {
         log4j.debug(String.format("inserting %s at offset %d", "dud7", offset));
      ...
      ChatEnum.USER.setLength(this.getUser() != null ? this.getUser().length() : 0);
      ChatEnum.MSG.setLength(this.getMsg() != null ? this.getMsg().length() : 0);
      ChatEnum.SOME_BOOLEANS.setLength(this.getSomeBooleans() != null ? this.getSomeBooleans().size() : 0);
      ChatEnum.SOME_BYTES.setLength(this.getSomeBytes() != null ? this.getSomeBytes().size() : 0);
      ChatEnum.SOME_CHARS.setLength(this.getSomeChars() != null ? this.getSomeChars().size() : 0);
      ChatEnum.SOME_INTS.setLength(this.getSomeInts() != null ? this.getSomeInts().size() : 0);
      ChatEnum.SOME_FLOATS.setLength(this.getSomeFloats() != null ? this.getSomeFloats().size() : 0);
      ChatEnum.SOME_LONGS.setLength(this.getSomeLongs() != null ? this.getSomeLongs().size() : 0);
      ChatEnum.SOME_SHORTS.setLength(this.getSomeShorts() != null ? this.getSomeShorts().size() : 0);
      ChatEnum.SOME_STRINGS.setLength(this.getSomeStrings() != null ? this.getSomeStrings().size() : 0);
      ChatEnum.SOME_DOUBLES.setLength(this.getSomeDoubles() != null ? this.getSomeDoubles().size() : 0);
   ...
   public Chat unpack(byte[] ba) {
      ...
      chat.setAction(ChatAction.toEnum(GreenballMessagesUtility.getByte(ba, ChatEnum.ACTION.getOffsetInBits())));
   ...
   public boolean equals(Object obj) {
      ...
      if (chat.getAction() != this.getAction()) {
         return false;
      }
