...
/**
 * The DeleteSubscriptionRequest class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a DeleteSubscriptionRequest object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a DeleteSubscriptionRequest object.
 */
public class DeleteSubscriptionRequest {
   private static final int ID = GreenballMessagesEnum.DELETE_SUBSCRIPTION_REQUEST.getId();

   /**
    * The number of bits required to represent the DeleteSubscriptionRequestEnum IDs.
    * # of attributes: 5
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(DeleteSubscriptionRequest.class);

   // Entered buildClassEnum()
   private enum DeleteSubscriptionRequestEnum {
      ...
      DeleteSubscriptionRequestEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The DeleteSubscriptionRequest no-arg constructor.
    */
   public DeleteSubscriptionRequest() {}

   /**
    * The DeleteSubscriptionRequest constructor.
    ...
    */
   public DeleteSubscriptionRequest(String orgId,
                                    String orgName,
                                    String userName,
                                    String message,
                                    String sessionId) {
   ...
   /**
    * This method packs a DeleteSubscriptionRequest object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a DeleteSubscriptionRequest message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getDeleteSubscriptionRequestSize();
      ...
      DeleteSubscriptionRequestEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      DeleteSubscriptionRequestEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      DeleteSubscriptionRequestEnum.USER_NAME.setLength(this.getUserName() != null ? this.getUserName().length() : 0);
      DeleteSubscriptionRequestEnum.MESSAGE.setLength(this.getMessage() != null ? this.getMessage().length() : 0);
      DeleteSubscriptionRequestEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getDeleteSubscriptionRequestDirectorySize();
      if (directorySize != 0) {
         ...
         for (DeleteSubscriptionRequestEnum deleteSubscriptionRequestEnum : DeleteSubscriptionRequestEnum.values()) {
            if (deleteSubscriptionRequestEnum.isDirectoryEntry == true) {
               int id = deleteSubscriptionRequestEnum.getId();
               int length = deleteSubscriptionRequestEnum.getLength();
               ...
               // Insert the data
               if (id == DeleteSubscriptionRequestEnum.ORG_ID.getId()) {
               ...
               else if (id == DeleteSubscriptionRequestEnum.ORG_NAME.getId()) {
               ...
               else if (id == DeleteSubscriptionRequestEnum.USER_NAME.getId()) {
               ...
               else if (id == DeleteSubscriptionRequestEnum.MESSAGE.getId()) {
               ...
               else if (id == DeleteSubscriptionRequestEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a DeleteSubscriptionRequest object.
    *
    * @return The byte array as a DeleteSubscriptionRequest message object.
    */
   public DeleteSubscriptionRequest unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == DeleteSubscriptionRequestEnum.ORG_ID.getId()) {
            deleteSubscriptionRequest.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == DeleteSubscriptionRequestEnum.ORG_NAME.getId()) {
            deleteSubscriptionRequest.setOrgName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == DeleteSubscriptionRequestEnum.USER_NAME.getId()) {
            deleteSubscriptionRequest.setUserName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == DeleteSubscriptionRequestEnum.MESSAGE.getId()) {
            deleteSubscriptionRequest.setMessage(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == DeleteSubscriptionRequestEnum.SESSION_ID.getId()) {
            deleteSubscriptionRequest.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
      }
   ...
   /**
    * This method packs a DeleteSubscriptionRequest object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a DeleteSubscriptionRequest message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeDeleteSubscriptionRequest initializeDeleteSubscriptionRequest = new InitializeDeleteSubscriptionRequest(this);
      Element element = initializeDeleteSubscriptionRequest.initialize();
    ...
    */
   public DeleteSubscriptionRequest unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the DeleteSubscriptionRequest object.
       */
       InstantiateDeleteSubscriptionRequest instantiateDeleteSubscriptionRequest = new InstantiateDeleteSubscriptionRequest(element);
       DeleteSubscriptionRequest deleteSubscriptionRequest = instantiateDeleteSubscriptionRequest.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateDeleteSubscriptionRequest.validate();
      if (result != null) {
    ...
    */
   private int getDeleteSubscriptionRequestDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the DeleteSubscriptionRequest object.
    * @return The size in bytes.
    */
   public int getDeleteSubscriptionRequestSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      if (!deleteSubscriptionRequest.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (!deleteSubscriptionRequest.getOrgName().equals(this.getOrgName())) {
         return false;
      }

      if (!deleteSubscriptionRequest.getUserName().equals(this.getUserName())) {
         return false;
      }

      if (deleteSubscriptionRequest.getMessage() == null && this.getMessage() != null) {
         return false;
      }
      else if (deleteSubscriptionRequest.getMessage() != null && this.getMessage() == null) {
         return false;
      }
      else if (deleteSubscriptionRequest.getMessage() != null && 
      !deleteSubscriptionRequest.getMessage().equals(this.getMessage())) {
         return false;
      }

      if (!deleteSubscriptionRequest.getSessionId().equals(this.getSessionId())) {
         return false;
      }
