...
/**
 * The SubscriptionRequests class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a SubscriptionRequests object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a SubscriptionRequests object.
 */
public class SubscriptionRequests {
   private static final int ID = GreenballMessagesEnum.SUBSCRIPTION_REQUESTS.getId();

   /**
    * The number of bits required to represent the SubscriptionRequestsEnum IDs.
    * # of attributes: 2
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(SubscriptionRequests.class);

   // Entered buildClassEnum()
   private enum SubscriptionRequestsEnum {
      ...
      SubscriptionRequestsEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
    ...
    */
   private List<SubscriptionRequestSubType> requests;
   private String sessionId;

   private String theErrorMsg;

   /**
    * The SubscriptionRequests no-arg constructor.
    */
   public SubscriptionRequests() {}

   /**
    * The SubscriptionRequests constructor.
    * See buildParameterAnnotations() in JBitByBitGenerator.java.
    *
    * @param requests The requests message attribute.
    * @param sessionId The sessionId message attribute.
    */
   public SubscriptionRequests(List<SubscriptionRequestSubType> requests,
                               String sessionId) {
   ...
   /**
    * This method packs a SubscriptionRequests object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a SubscriptionRequests message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getSubscriptionRequestsSize();
      ...
      SubscriptionRequestsEnum.REQUESTS.setLength(this.getRequests().size());
      SubscriptionRequestsEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getSubscriptionRequestsDirectorySize();
      if (directorySize != 0) {
         ...
         for (SubscriptionRequestsEnum subscriptionRequestsEnum : SubscriptionRequestsEnum.values()) {
            if (subscriptionRequestsEnum.isDirectoryEntry == true) {
               int id = subscriptionRequestsEnum.getId();
               int length = subscriptionRequestsEnum.getLength();
               ...
               // Insert the data
               if (id == SubscriptionRequestsEnum.REQUESTS.getId()) {
                  log4j.debug(String.format("inserting %s at offset %d", "requests", offset));
                  for (SubscriptionRequestSubType subscriptionRequestSubType : this.requests) {
                     byte[] bytes = subscriptionRequestSubType.pack();
               ...
               else if (id == SubscriptionRequestsEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a SubscriptionRequests object.
    *
    * @return The byte array as a SubscriptionRequests message object.
    */
   public SubscriptionRequests unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == SubscriptionRequestsEnum.SESSION_ID.getId()) {
            subscriptionRequests.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == SubscriptionRequestsEnum.REQUESTS.getId()) {
            byte[] bytes = new byte[length];
            for (int index = 0; index < length; index++) {
               bytes[index] = GreenballMessagesUtility.getByte(ba, (offset + index) * 8);
            }
            subscriptionRequests.getRequests().add(new SubscriptionRequestSubType().unpack(bytes));
         }
      }
   ...
   /**
    * This method packs a SubscriptionRequests object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a SubscriptionRequests message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeSubscriptionRequests initializeSubscriptionRequests = new InitializeSubscriptionRequests(this);
      Element element = initializeSubscriptionRequests.initialize();
    ...
    */
   public SubscriptionRequests unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the SubscriptionRequests object.
       */
       InstantiateSubscriptionRequests instantiateSubscriptionRequests = new InstantiateSubscriptionRequests(element);
       SubscriptionRequests subscriptionRequests = instantiateSubscriptionRequests.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateSubscriptionRequests.validate();
      if (result != null) {
   ...
   /**
    * This method sets the requests attribute. Setting of this value is required.
    * @param requests The requests.
    */
   public void setRequests(List<SubscriptionRequestSubType> requests) {
      this.requests = requests;
   }

   /**
    * This method gets the requests attribute. The requests attribute is a required attribute.
    */
   public List<SubscriptionRequestSubType> getRequests() {
      if (this.requests == null) {
         this.requests = new ArrayList<SubscriptionRequestSubType>();
      }
    ...
    */
   private int getSubscriptionRequestsDirectorySize() {
      int directorySize = 0;

      // requests
      directorySize += getRequests().size();
      // sessionId
      directorySize++;
   ...
   /**
    * This method gets the size of the SubscriptionRequests object.
    * @return The size in bytes.
    */
   public int getSubscriptionRequestsSize() {
      int size = 0;
      ...
      // Add size of requests
      for (SubscriptionRequestSubType subscriptionRequestSubType: getRequests()) {
         size += subscriptionRequestSubType.getSubscriptionRequestSubTypeSize();
      }
   ...
   public String toString() {
      ...
      if (requests != null) {
         for (SubscriptionRequestSubType requestsSubscriptionRequestSubType : requests) {
            result.append(requestsSubscriptionRequestSubType.toString());
         }
      }
   ...
   public boolean equals(Object obj) {
      ...
      SubscriptionRequests subscriptionRequests = (SubscriptionRequests) obj;
      if (!subscriptionRequests.getSessionId().equals(this.getSessionId())) {
         return false;
      }
