...
/**
 * The InsertRuleMessage class defines a message of the messaging system defined
 * by the GreenballMessages grammar. It provides methods for packing a InsertRuleMessage object
 * into a byte array or string, and for unpacking a byte array or string
 * back into a InsertRuleMessage object.
 */
public class InsertRuleMessage {
   private static final int ID = GreenballMessagesEnum.INSERT_RULE_MESSAGE.getId();

   /**
    * The number of bits required to represent the InsertRuleMessageEnum IDs.
    * # of attributes: 6
    * # of PEnumRefs: 0
    */
   ...
   private static Logger log4j = Logger.getLogger(InsertRuleMessage.class);

   // Entered buildClassEnum()
   private enum InsertRuleMessageEnum {
      ...
      InsertRuleMessageEnum(int id, int offsetInBits, int length, boolean isDirectoryEntry) {
         this.id = id;
   ...
   /**
    * The InsertRuleMessage no-arg constructor.
    */
   public InsertRuleMessage() {}

   /**
    * The InsertRuleMessage constructor.
    ...
    */
   public InsertRuleMessage(String orgId,
                            String orgName,
   ...
   /**
    * This method packs a InsertRuleMessage object into a byte array. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A byte array which represents a InsertRuleMessage message object.
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      int byteArraySize = getInsertRuleMessageSize();
      ...
      InsertRuleMessageEnum.ORG_ID.setLength(this.getOrgId() != null ? this.getOrgId().length() : 0);
      InsertRuleMessageEnum.ORG_NAME.setLength(this.getOrgName() != null ? this.getOrgName().length() : 0);
      InsertRuleMessageEnum.MODEL_NAME.setLength(this.getModelName() != null ? this.getModelName().length() : 0);
      InsertRuleMessageEnum.RULE.setLength(this.getRule().getRuleSize());
      InsertRuleMessageEnum.USER_NAME.setLength(this.getUserName() != null ? this.getUserName().length() : 0);
      InsertRuleMessageEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);

      int directorySize = getInsertRuleMessageDirectorySize();
      if (directorySize != 0) {
         ...
         for (InsertRuleMessageEnum insertRuleMessageEnum : InsertRuleMessageEnum.values()) {
            if (insertRuleMessageEnum.isDirectoryEntry == true) {
               int id = insertRuleMessageEnum.getId();
               int length = insertRuleMessageEnum.getLength();
               ...
               // Insert the data
               if (id == InsertRuleMessageEnum.ORG_ID.getId()) {
               ...
               else if (id == InsertRuleMessageEnum.ORG_NAME.getId()) {
               ...
               else if (id == InsertRuleMessageEnum.MODEL_NAME.getId()) {
               ...
               else if (id == InsertRuleMessageEnum.RULE.getId()) {
               ...
               else if (id == InsertRuleMessageEnum.USER_NAME.getId()) {
               ...
               else if (id == InsertRuleMessageEnum.SESSION_ID.getId()) {
   ...
   /**
    * This method unpacks a byte array containing a InsertRuleMessage object.
    *
    * @return The byte array as a InsertRuleMessage message object.
    */
   public InsertRuleMessage unpack(byte[] ba) {
      ...
      for (GreenballMessagesDirectoryEntry directoryEntry : theDirectory) {
         ...
         if (id == InsertRuleMessageEnum.ORG_ID.getId()) {
            insertRuleMessage.setOrgId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == InsertRuleMessageEnum.ORG_NAME.getId()) {
            insertRuleMessage.setOrgName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == InsertRuleMessageEnum.MODEL_NAME.getId()) {
            insertRuleMessage.setModelName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == InsertRuleMessageEnum.USER_NAME.getId()) {
            insertRuleMessage.setUserName(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == InsertRuleMessageEnum.SESSION_ID.getId()) {
            insertRuleMessage.setSessionId(GreenballMessagesUtility.getString(ba, offset, length));
         }
         else if (id == InsertRuleMessageEnum.RULE.getId()) {
            ...
            insertRuleMessage.setRule(new Rule().unpack(bytes));
         }
      }

      log4j.debug("Leaving " + METHOD);
      return insertRuleMessage;
   }
   // Leaving buildUnpackMethod()

   // Entered buildPackStrMethod()
   /**
    * This method packs a InsertRuleMessage object into a String. If a required attribute is not
    * provided an exception will be thrown.
    *
    * @return A String which represents a InsertRuleMessage message object.
    * @throws MissingAttributeException
    */
   public String packStr() throws MissingAttributeException {
       ...
       */
      InitializeInsertRuleMessage initializeInsertRuleMessage = new InitializeInsertRuleMessage(this);
      Element element = initializeInsertRuleMessage.initialize();
    ...
    */
   public InsertRuleMessage unpack(String buffer) {
      final String METHOD = "unpack()";
      log4j.debug("Entered " + METHOD);
      ...
      /*
       * Instantiate the InsertRuleMessage object.
       */
       InstantiateInsertRuleMessage instantiateInsertRuleMessage = new InstantiateInsertRuleMessage(element);
       InsertRuleMessage insertRuleMessage = instantiateInsertRuleMessage.instantiate();

      /*
       * Verify that a value was provided for all mandatory attributes.
       */
      String result = instantiateInsertRuleMessage.validate();
      if (result != null) {
    ...
    */
   private int getInsertRuleMessageDirectorySize() {
      int directorySize = 0;
   ...
   /**
    * This method gets the size of the InsertRuleMessage object.
    * @return The size in bytes.
    */
   public int getInsertRuleMessageSize() {
      int size = 0;
   ...
   public boolean equals(Object obj) {
      ...
      InsertRuleMessage insertRuleMessage = (InsertRuleMessage) obj;
      if (!insertRuleMessage.getOrgId().equals(this.getOrgId())) {
         return false;
      }

      if (!insertRuleMessage.getOrgName().equals(this.getOrgName())) {
         return false;
      }

      if (!insertRuleMessage.getModelName().equals(this.getModelName())) {
         return false;
      }

      if (!insertRuleMessage.getUserName().equals(this.getUserName())) {
         return false;
      }

      if (insertRuleMessage.getSessionId() == null && this.getSessionId() != null) {
         return false;
      }
      else if (insertRuleMessage.getSessionId() != null && this.getSessionId() == null) {
         return false;
      }
      else if (insertRuleMessage.getSessionId() != null && 
      !insertRuleMessage.getSessionId().equals(this.getSessionId())) {
         return false;
      }
