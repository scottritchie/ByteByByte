...
public class AddOrganization {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      AddOrganizationEnum.USER_NAME.setLength(this.getUserName() != null ? this.getUserName().length() : 0);
      AddOrganizationEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);
