...
public class Subscribers {
   ...
   public byte[] pack() throws MissingAttributeException {
      ...
      SubscribersEnum.ORGANIZATION.setLength(this.getOrganization() != null ? this.getOrganization().length() : 0);
      SubscribersEnum.USERS.setLength(this.getUsers().size());
      SubscribersEnum.SESSION_ID.setLength(this.getSessionId() != null ? this.getSessionId().length() : 0);
