...
/**
 * The ExampleMessagesUtility class provides utility methods for the messaging system defined
 * by the Example grammar.
 */
public class ExampleMessagesUtility {

   private static Logger log4j = Logger.getLogger(ExampleMessagesUtility.class);
    ...
    * @param byteArray The byte array.
    * @param offset The offset in bytes in the byte array.
    * @param b The byte value to be inserted.
    * @return The byte array.
    */
