...
/**
 * The TestMessagesUtility class provides utility methods for the messaging system defined
 * by the Test grammar.
 */
public class TestMessagesUtility {

   private static Logger log4j = Logger.getLogger(TestMessagesUtility.class);
